...
public class GameDataCacheConfig
{
    ...
    public async Task LoadDataAsync()
    {
        ...
        {
            (AppDisplayConstants.Title.ACHIEVEMENTS, async () => AllAchievements = await AchievementsService.Create().GetAchievementsWithoutLimitAsync()),
            (AppDisplayConstants.Title.ALCHEMIES, async () => AllAlchemies = await AlchemiesService.Create().GetAlchemiesWithoutLimitAsync()),
            (AppDisplayConstants.Title.ARCHITECTURES, async () => AllArchitectures = await ArchitecturesService.Create().GetArchitecturesWithoutLimitAsync()),
            (AppDisplayConstants.Title.ARTIFACTS, async () => AllArtifacts = await ArtifactsService.Create().GetArtifactsWithoutLimitAsync()),
            (AppDisplayConstants.Title.ARTWORKS, async () => AllArtworks = await ArtworksService.Create().GetArtworksWithoutLimitAsync()),
            (AppDisplayConstants.Title.AVATARS, async () => AllAvatars = await AvatarsService.Create().GetAvatarsWithoutLimitAsync()),
            (AppDisplayConstants.Title.BADGES, async () => AllBadges = await BadgesService.Create().GetBadgesWithoutLimitAsync()),
            (AppDisplayConstants.Title.BEVERAGES, async () => AllBeverages = await BeveragesService.Create().GetBeveragesWithoutLimitAsync()),
            (AppDisplayConstants.Title.BOOKS, async () => AllBooks = await BooksService.Create().GetBooksWithoutLimitAsync()),
            (AppDisplayConstants.Title.BORDERS, async () => AllBorders = await BordersService.Create().GetBordersWithoutLimitAsync()),
            (AppDisplayConstants.Title.BUILDINGS, async () => AllBuildings = await BuildingsService.Create().GetBuildingsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_ADMIRALS, async () => AllCardAdmirals = await CardAdmiralsService.Create().GetCardAdmiralsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_CAPTAINS, async () => AllCardCaptains = await CardCaptainsService.Create().GetCardCaptainsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_COLONELS, async () => AllCardColonels = await CardColonelsService.Create().GetCardColonelsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_GENERALS, async () => AllCardGenerals = await CardGeneralsService.Create().GetCardGeneralsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_HEROES, async () => AllCardHeroes = await CardHeroesService.Create().GetCardHeroesWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_LIVES, async () => AllCardLives = await CardLivesService.Create().GetCardLivesWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_MILITARIES, async () => AllCardMilitaries = await CardMilitariesService.Create().GetCardMilitariesWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_MONSTERS, async () => AllCardMonsters = await CardMonstersService.Create().GetCardMonstersWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_SOLDIERS, async () => AllCardSoldiers = await CardSoldiersService.Create().GetCardSoldiersWithoutLimitAsync()),
            (AppDisplayConstants.Title.CARD_SPELLS, async () => AllCardSpells = await CardSpellsService.Create().GetCardSpellsWithoutLimitAsync()),
            (AppDisplayConstants.Title.COLLABORATION_EQUIPMENTS, async () => AllCollaborationEquipments = await CollaborationEquipmentsService.Create().GetCollaborationEquipmentsWithoutLimitAsync()),
            (AppDisplayConstants.Title.COLLABORATIONS, async () => AllCollaborations = await CollaborationsService.Create().GetCollaborationsWithoutLimitAsync()),
            (AppDisplayConstants.Title.CORES, async () => AllCores = await CoresService.Create().GetCoresWithoutLimitAsync()),
            (AppDisplayConstants.Title.EMOJIS, async () => AllEmojis = await EmojisService.Create().GetEmojisWithoutLimitAsync()),
            (AppDisplayConstants.Title.EQUIPMENTS, async () => AllEquipments = await EquipmentsService.Create().GetEquipmentsWithoutLimitAsync()),
            (AppDisplayConstants.Title.FASHIONS, async () => AllFashions = await FashionsService.Create().GetFashionsWithoutLimitAsync()),
            (AppDisplayConstants.Title.FOODS, async () => AllFoods = await FoodsService.Create().GetFoodsWithoutLimitAsync()),
            (AppDisplayConstants.Title.FORGES, async () => AllForges = await ForgesService.Create().GetForgesWithoutLimitAsync()),
            (AppDisplayConstants.Title.FURNITURES, async () => AllFurnitures = await FurnituresService.Create().GetFurnituresWithoutLimitAsync()),
            (AppDisplayConstants.Title.ITEMS, async () => AllItems = await ItemsService.Create().GetItemsAsync()),
            (AppDisplayConstants.Title.MAGIC_FORMATION_CIRCLES, async () => AllMagicFormationCircles = await MagicFormationCirclesService.Create().GetMagicFormationCirclesWithoutLimitAsync()),
            (AppDisplayConstants.Title.MECHA_BEASTS, async () => AllMechaBeasts = await MechaBeastsService.Create().GetMechaBeastsWithoutLimitAsync()),
            (AppDisplayConstants.Title.MEDALS, async () => AllMedals = await MedalsService.Create().GetMedalsWithoutLimitAsync()),
            (AppDisplayConstants.Title.PETS, async () => AllPets = await PetsService.Create().GetPetsWithoutLimitAsync()),
            (AppDisplayConstants.Title.PLANTS, async () => AllPlants = await PlantsService.Create().GetPlantsWithoutLimitAsync()),
            (AppDisplayConstants.Title.PUPPETS, async () => AllPuppets = await PuppetsService.Create().GetPuppetsWithoutLimitAsync()),
            (AppDisplayConstants.Title.RELICS, async () => AllRelics = await RelicsService.Create().GetRelicsWithoutLimitAsync()),
            (AppDisplayConstants.Title.ROBOTS, async () => AllRobots = await RobotsService.Create().GetRobotsWithoutLimitAsync()),
            (AppDisplayConstants.Title.RUNES, async () => AllRunes = await RunesService.Create().GetRunesWithoutLimitAsync()),
            (AppDisplayConstants.Title.SKILLS, async () => AllSkills = await SkillsService.Create().GetSkillsWithoutLimitAsync()),
            (AppDisplayConstants.Title.SPIRIT_BEASTS, async () => AllSpiritBeasts = await SpiritBeastsService.Create().GetSpiritBeastsWithoutLimitAsync()),
            (AppDisplayConstants.Title.SPIRIT_CARDS, async () => AllSpiritCards = await SpiritCardsService.Create().GetSpiritCardsWithoutLimitAsync()),
            (AppDisplayConstants.Title.SYMBOLS, async () => AllSymbols = await SymbolsService.Create().GetSymbolsWithoutLimitAsync()),
            (AppDisplayConstants.Title.TALISMANS, async () => AllTalismans = await TalismansService.Create().GetTalismansWithoutLimitAsync()),
            (AppDisplayConstants.Title.TECHNOLOGIES, async () => AllTechnologies = await TechnologiesService.Create().GetTechnologiesWithoutLimitAsync()),
            (AppDisplayConstants.Title.TITLES, async () => AllTitles = await TitlesService.Create().GetTitlesWithoutLimitAsync()),
            (AppDisplayConstants.Title.VEHICLES, async () => AllVehicles = await VehiclesService.Create().GetVehiclesWithoutLimitAsync()),
            (AppDisplayConstants.Title.WEAPONS, async () => AllWeapons = await WeaponsService.Create().GetWeaponsWithoutLimitAsync()),
            (AppDisplayConstants.Title.OUTFITS, async () => AllOutfits = await OutfitsService.Create().GetOutfitsWithoutLimitAsync()),
        };
