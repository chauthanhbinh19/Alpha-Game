...
public class HomeManager : MonoBehaviour
{
    ...
    public async Task CreateHomePanelAsync()
    {
        ...
        achievementTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ACHIEVEMENT);
        ...
        alchemyTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ALCHEMY);
        ...
        architectureTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ARCHITECTURE);
        ...
        artworkTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ARTWORK);
        ...
        avatarTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.AVATAR);
        ...
        badgeTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.BADGE);
        ...
        beverageTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.BEVERAGE);
        ...
        bookTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.BOOK);
        ...
        borderTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.BORDER);
        ...
        buildingTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.BUILDING);
        ...
        cardAdmiralTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_ADMIRAL);
        ...
        cardCaptainTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_CAPTAIN);
        ...
        cardColonelTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_COLONEL);
        ...
        cardGeneralTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_GENERAL);
        ...
        cardHeroTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_HERO);
        ...
        cardLifeTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_LIFE);
        ...
        cardMilitaryTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_MILITARY);
        ...
        cardMonsterTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_MONSTER);
        ...
        cardSpellTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_SPELL);
        ...
        artifactTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ARTIFACT);
        ...
        collaborationEquipmentTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.COLLABORATION_EQUIPMENT);
        ...
        collaborationTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.COLLABORATION);
        ...
        coreTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CORE);
        ...
        equipmentTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.EQUIPMENT);
        ...
        fashionTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.FASHION);
        ...
        foodTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.FOOD);
        ...
        forgeTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.FORGE);
        ...
        furnitureTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.FURNITURE);
        ...
        itemTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ITEM);
        ...
        magicFormationCircleTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.MAGIC_FORMATION_CIRCLE);
        ...
        mechaBeastTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.MECHA_BEAST);
        ...
        medalTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.MEDAL);
        ...
        petTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.PET);
        ...
        plantTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.PLANT);
        ...
        puppetTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.PUPPET);
        ...
        relicTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.RELIC);
        ...
        robotTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.ROBOT);
        ...
        runeTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.RUNE);
        ...
        skillTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.SKILL);
        ...
        spiritBeastTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.SPIRIT_BEAST);
        ...
        spiritCardTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.SPIRIT_CARD);
        ...
        symbolTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.SYMBOL);
        ...
        talismanTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TALISMAN);
        ...
        technologyTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TECHNOLOGY);
        ...
        titleTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TITLE);
        ...
        vehicleTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.VEHICLE);
        ...
        int userWeaponCount = await UserWeaponsService.Create().GetUserWeaponsCountAsync(User.CurrentUserId, Search, Type, Rare);
        weaponTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.WEAPON);
        ...
        emojiTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.EMOJI);
