...
public class EquipmentManager : MonoBehaviour
{
    ...
    public void CreateEquipments(Transform tempEquipmentMenuPanel)
    {
        ...
        ItemsPrefab = UIManager.Instance.Get(AppConstants.Prefab.Component.ITEM_PREFAB);
        MainMenuPanelPrefab = UIManager.Instance.Get(AppConstants.Prefab.General.MAIN_MENU_PANEL_PREFAB);
        MainMenuShopPanelPrefab = UIManager.Instance.Get(AppConstants.Prefab.General.MAIN_MENU_SHOP_PANEL_PREFAB);
        MainMenuEnhancementPanelPrefab = UIManager.Instance.Get(AppConstants.Prefab.General.MAIN_MENU_ENHANCEMENT_PANEL_PREFAB);
        MainMenuCampaignPanel = UIManager.Instance.Get(AppConstants.Prefab.General.MAIN_MENU_CAMPAIGN_PANEL);
        ...
        EquipmentPrefab = UIManager.Instance.Get(AppConstants.Prefab.Equipment.EQUIPMENT_PREFAB);
        // EquipmentMenuPanel = UIManager.Instance.GetTransform("equipmentMenuPanel");
        EquipmentPanelPrefab = UIManager.Instance.Get(AppConstants.Prefab.Equipment.EQUIPMENT_PANEL_PREFAB);
    ...
    public void PopupCampaignDetail(CampaignDetail campaignDetail)
    {
        ...
        foreach (CampaignReward campaignReward in campaignDetail.CampaignRewards)
        {
            ...
            Texture itemTexture = TextureHelper.LoadTextureCached($"{ImageHelper.RemoveImageExtension(campaignReward.Items.Image)}");
        ...
        foreach (CampaignDetailCard campaignDetailCardcard in campaignDetail.CampaignDetailCards)
        {
            ...
            Texture texture = TextureHelper.LoadTextureCached($"{ImageHelper.RemoveImageExtension(campaignDetailCardcard.Cards.Image)}");
            Image.texture = texture;
        }
    }
}
