...
public class ShopManager : MonoBehaviour
{
    ...
    public async Task CreateShopButtonAsync(Transform panel)
    {
        ...
        CreateButton(1, AppDisplayConstants.Title.CARD_HEROES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_HERO_URL), tempContent);
        CreateButton(2, AppDisplayConstants.Title.BOOKS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.BOOK_URL), tempContent);
        CreateButton(3, AppDisplayConstants.Title.PETS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.PET_URL), tempContent);
        CreateButton(4, AppDisplayConstants.Title.CARD_CAPTAINS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_CAPTAIN_URL), tempContent);
        CreateButton(5, AppDisplayConstants.Title.COLLABORATION_EQUIPMENTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.COLLABORATION_EQUIPMENT_URL), tempContent);
        CreateButton(6, AppDisplayConstants.Title.CARD_MILITARIES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_MILITARY_URL), tempContent);
        CreateButton(7, AppDisplayConstants.Title.CARD_SPELLS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_SPELL_URL), tempContent);
        CreateButton(8, AppDisplayConstants.Title.COLLABORATIONS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.COLLABORATION_URL), tempContent);
        CreateButton(9, AppDisplayConstants.Title.CARD_MONSTERS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_MONSTER_URL), tempContent);
        ...
        CreateButton(11, AppDisplayConstants.Title.MEDALS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.MEDAL_URL), tempContent);
        CreateButton(12, AppDisplayConstants.Title.SKILLS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.SKILL_URL), tempContent);
        CreateButton(13, AppDisplayConstants.Title.SYMBOLS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.SYMBOL_URL), tempContent);
        CreateButton(14, AppDisplayConstants.Title.TITLES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.TITLE_URL), tempContent);
        CreateButton(15, AppDisplayConstants.Title.MAGIC_FORMATION_CIRCLES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.MAGIC_FORMATION_CIRCLE_URL), tempContent);
        CreateButton(16, AppDisplayConstants.Title.RELICS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.RELIC_URL), tempContent);
        CreateButton(17, AppDisplayConstants.Title.ARTWORKS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ARTWORK_URL), tempContent);
        CreateButton(18, AppDisplayConstants.Title.ACHIEVEMENTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ACHIEVEMENT_URL), tempContent);
        CreateButton(19, AppDisplayConstants.Title.CARD_COLONELS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_COLONEL_URL), tempContent);
        CreateButton(20, AppDisplayConstants.Title.CARD_GENERALS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_GENERAL_URL), tempContent);
        CreateButton(21, AppDisplayConstants.Title.CARD_ADMIRALS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_ADMIRAL_URL), tempContent);
        CreateButton(22, AppDisplayConstants.Title.TALISMANS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.TALISMAN_URL), tempContent);
        CreateButton(23, AppDisplayConstants.Title.PUPPETS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.PUPPET_URL), tempContent);
        CreateButton(24, AppDisplayConstants.Title.ALCHEMIES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ALCHEMY_URL), tempContent);
        CreateButton(25, AppDisplayConstants.Title.FORGES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.FORGE_URL), tempContent);
        CreateButton(26, AppDisplayConstants.Title.CARD_LIVES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_LIFE_URL), tempContent);
        CreateButton(27, AppDisplayConstants.Title.SPIRIT_BEASTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.SPIRIT_BEAST_URL), tempContent);
        CreateButton(28, AppDisplayConstants.Title.SPIRIT_CARDS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.SPIRIT_CARD_URL), tempContent);
        CreateButton(29, AppDisplayConstants.Title.ARTIFACTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ARTIFACT_URL), tempContent);
        CreateButton(30, AppDisplayConstants.Title.ARCHITECTURES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ARCHITECTURE_URL), tempContent);
        CreateButton(31, AppDisplayConstants.Title.TECHNOLOGIES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.TECHNOLOGY_URL), tempContent);
        CreateButton(32, AppDisplayConstants.Title.VEHICLES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.VEHICLE_URL), tempContent);
        CreateButton(33, AppDisplayConstants.Title.CORES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CORE_URL), tempContent);
        CreateButton(34, AppDisplayConstants.Title.WEAPONS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.WEAPON_URL), tempContent);
        CreateButton(35, AppDisplayConstants.Title.ROBOTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.ROBOT_URL), tempContent);
        CreateButton(36, AppDisplayConstants.Title.BADGES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.BADGE_URL), tempContent);
        CreateButton(37, AppDisplayConstants.Title.MECHA_BEASTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.MECHA_BEAST_URL), tempContent);
        CreateButton(38, AppDisplayConstants.Title.RUNES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.RUNE_URL), tempContent);
        CreateButton(39, AppDisplayConstants.Title.FURNITURES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.FURNITURE_URL), tempContent);
        CreateButton(40, AppDisplayConstants.Title.FOODS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.FOOD_URL), tempContent);
        CreateButton(41, AppDisplayConstants.Title.BEVERAGES, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.BEVERAGE_URL), tempContent);
        CreateButton(42, AppDisplayConstants.Title.BUILDINGS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.BUILDING_URL), tempContent);
        CreateButton(43, AppDisplayConstants.Title.PLANTS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.PLANT_URL), tempContent);
        CreateButton(44, AppDisplayConstants.Title.FASHIONS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.FASHION_URL), tempContent);
        CreateButton(45, AppDisplayConstants.Title.EMOJIS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.EMOJI_URL), tempContent);
        CreateButton(46, AppDisplayConstants.Title.CARD_SOLDIERS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.CARD_SOLDIER_URL), tempContent);
        CreateButton(47, AppDisplayConstants.Title.OUTFITS, TextureHelper.LoadTexture2DCached(ImageConstants.Gallery.OUTFIT_URL), tempContent);
