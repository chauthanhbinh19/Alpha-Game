public class UserScienceFictions : BaseEntity
{
    ...
    public UserScienceFictions()
    {

    }
    public UserScienceFictions CloneUserScienceFiction(UserScienceFictions source)
    {
        if (source == null)
            return null;

        return new UserScienceFictions
        {
            Id = source.Id,
