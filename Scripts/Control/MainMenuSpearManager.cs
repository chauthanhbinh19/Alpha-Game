...
public class MainMenuSpearManager : MonoBehaviour
{
    ...
    private GameObject SpearSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuSpearPanelPrefab = UIManager.Instance.GetGameObject("MainMenuSpearPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SpearSlotPrefab = UIManager.Instance.GetGameObject("SpearSlotPrefab");
    ...
    public void CreateMainMenuSpearManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Spear");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(SpearSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Spear");
