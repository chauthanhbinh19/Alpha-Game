...
public class MainMenuFireManager : MonoBehaviour
{
    ...
    private GameObject FireSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuFirePanelPrefab = UIManager.Instance.GetGameObject("MainMenuFirePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        FireSlotPrefab = UIManager.Instance.GetGameObject("FireSlotPrefab");
    ...
    public void CreateMainMenuFireManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Fire");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(FireSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Fire");
