...
public class MainMenuBowManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuBowPanelPrefab;
    private GameObject BowSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuBowPanelPrefab = UIManager.Instance.GetGameObject("MainMenuBowPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        BowSlotPrefab = UIManager.Instance.GetGameObject("BowSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuBowManager(object data)
    {
        currentObject = Instantiate(MainMenuBowPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Bow");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(BowSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Bow");
