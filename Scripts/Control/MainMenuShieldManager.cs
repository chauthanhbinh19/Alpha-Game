...
public class MainMenuShieldManager : MonoBehaviour
{
    ...
    private GameObject ShieldSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuShieldPanelPrefab = UIManager.Instance.GetGameObject("MainMenuShieldPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ShieldSlotPrefab = UIManager.Instance.GetGameObject("ShieldSlotPrefab");
    ...
    public void CreateMainMenuShieldManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Shield");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ShieldSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Shield");
