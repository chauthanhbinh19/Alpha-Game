...
public class MainMenuLightManager : MonoBehaviour
{
    ...
    private GameObject LightSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuLightPanelPrefab = UIManager.Instance.GetGameObject("MainMenuLightPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        LightSlotPrefab = UIManager.Instance.GetGameObject("LightSlotPrefab");
    ...
    public void CreateMainMenuLightManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Light");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(LightSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Light");
