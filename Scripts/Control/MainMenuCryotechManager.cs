...
public class MainMenuCryotechManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuCryotechPanelPrefab;
    private GameObject CryotechSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuCryotechPanelPrefab = UIManager.Instance.GetGameObject("MainMenuCryotechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        CryotechSlotPrefab = UIManager.Instance.GetGameObject("CryotechSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuCryotechManager(object data)
    {
        currentObject = Instantiate(MainMenuCryotechPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Cryotech");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(CryotechSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Cryotech");
