...
public class MainMenuPlasmaManager : MonoBehaviour
{
    ...
    private GameObject PlasmaSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuPlasmaPanelPrefab = UIManager.Instance.GetGameObject("MainMenuPlasmaPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        PlasmaSlotPrefab = UIManager.Instance.GetGameObject("PlasmaSlotPrefab");
    ...
    public void CreateMainMenuPlasmaManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Plasma");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(PlasmaSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Plasma");
