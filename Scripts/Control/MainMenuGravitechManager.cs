...
public class MainMenuGravitechManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuGravitechPanelPrefab;
    private GameObject GravitechSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuGravitechPanelPrefab = UIManager.Instance.GetGameObject("MainMenuGravitechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        GravitechSlotPrefab = UIManager.Instance.GetGameObject("GravitechSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuGravitechManager(object data)
    {
        currentObject = Instantiate(MainMenuGravitechPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Gravitech");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(GravitechSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Gravitech");
