...
public class MainMenuJorrManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuJorrPanelPrefab;
    private GameObject JorrSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuJorrPanelPrefab = UIManager.Instance.GetGameObject("MainMenuJorrPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        JorrSlotPrefab = UIManager.Instance.GetGameObject("JorrSlotPrefab");
    ...
    public void CreateMainMenuJorrManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Jorr");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(JorrSlotPrefab, SlotPanel);
