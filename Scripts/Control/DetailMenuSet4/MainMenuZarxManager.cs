...
public class MainMenuZarxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuZarxPanelPrefab;
    private GameObject ZarxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuZarxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuZarxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ZarxSlotPrefab = UIManager.Instance.GetGameObject("ZarxSlotPrefab");
    ...
    public void CreateMainMenuZarxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Zarx");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ZarxSlotPrefab, SlotPanel);
