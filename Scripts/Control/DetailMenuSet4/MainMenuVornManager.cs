...
public class MainMenuVornManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVornPanelPrefab;
    private GameObject VornSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuVornPanelPrefab = UIManager.Instance.GetGameObject("MainMenuVornPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        VornSlotPrefab = UIManager.Instance.GetGameObject("VornSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuVornManager(object data)
    {
        currentObject = Instantiate(MainMenuVornPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Vorn");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(VornSlotPrefab, SlotPanel);
