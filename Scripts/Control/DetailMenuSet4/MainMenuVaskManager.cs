...
public class MainMenuVaskManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVaskPanelPrefab;
    private GameObject VaskSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuVaskPanelPrefab = UIManager.Instance.GetGameObject("MainMenuVaskPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        VaskSlotPrefab = UIManager.Instance.GetGameObject("VaskSlotPrefab");
    ...
    public void CreateMainMenuVaskManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Vask");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(VaskSlotPrefab, SlotPanel);
