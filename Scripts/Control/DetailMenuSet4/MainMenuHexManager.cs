...
public class MainMenuHexManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHexPanelPrefab;
    private GameObject HexSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuHexPanelPrefab = UIManager.Instance.GetGameObject("MainMenuHexPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        HexSlotPrefab = UIManager.Instance.GetGameObject("HexSlotPrefab");
    ...
    public void CreateMainMenuHexManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Hex");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(HexSlotPrefab, SlotPanel);
