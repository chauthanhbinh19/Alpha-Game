...
public class MainMenuQuenManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuQuenPanelPrefab;
    private GameObject QuenSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuQuenPanelPrefab = UIManager.Instance.GetGameObject("MainMenuQuenPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        QuenSlotPrefab = UIManager.Instance.GetGameObject("QuenSlotPrefab");
    ...
    public void CreateMainMenuQuenManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Quen");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(QuenSlotPrefab, SlotPanel);
