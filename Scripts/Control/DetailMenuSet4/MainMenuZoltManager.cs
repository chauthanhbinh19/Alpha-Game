...
public class MainMenuZoltManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuZoltPanelPrefab;
    private GameObject ZoltSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuZoltPanelPrefab = UIManager.Instance.GetGameObject("MainMenuZoltPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ZoltSlotPrefab = UIManager.Instance.GetGameObject("ZoltSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuZoltManager(object data)
    {
        currentObject = Instantiate(MainMenuZoltPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Zolt");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ZoltSlotPrefab, SlotPanel);
