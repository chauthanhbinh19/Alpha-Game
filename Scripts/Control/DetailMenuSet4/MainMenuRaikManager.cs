...
public class MainMenuRaikManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuRaikPanelPrefab;
    private GameObject RaikSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuRaikPanelPrefab = UIManager.Instance.GetGameObject("MainMenuRaikPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        RaikSlotPrefab = UIManager.Instance.GetGameObject("RaikSlotPrefab");
    ...
    public void CreateMainMenuRaikManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Raik");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(RaikSlotPrefab, SlotPanel);
