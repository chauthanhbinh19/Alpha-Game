...
public class MainMenuJaxxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuJaxxPanelPrefab;
    private GameObject JaxxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuJaxxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuJaxxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        JaxxSlotPrefab = UIManager.Instance.GetGameObject("JaxxSlotPrefab");
    ...
    public void CreateMainMenuJaxxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Jaxx");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(JaxxSlotPrefab, SlotPanel);
