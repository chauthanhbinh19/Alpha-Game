...
public class MainMenuBaxxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuBaxxPanelPrefab;
    private GameObject BaxxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuBaxxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuBaxxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        BaxxSlotPrefab = UIManager.Instance.GetGameObject("BaxxSlotPrefab");
    ...
    public void CreateMainMenuBaxxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Baxx");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(BaxxSlotPrefab, SlotPanel);
