...
public class MainMenuMyrrManager : MonoBehaviour
{
    ...
    private GameObject MyrrSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuMyrrPanelPrefab = UIManager.Instance.GetGameObject("MainMenuMyrrPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        MyrrSlotPrefab = UIManager.Instance.GetGameObject("MyrrSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuMyrrManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Myrr");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(MyrrSlotPrefab, SlotPanel);
