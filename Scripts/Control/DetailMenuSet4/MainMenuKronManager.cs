...
public class MainMenuKronManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuKronPanelPrefab;
    private GameObject KronSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuKronPanelPrefab = UIManager.Instance.GetGameObject("MainMenuKronPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        KronSlotPrefab = UIManager.Instance.GetGameObject("KronSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuKronManager(object data)
    {
        currentObject = Instantiate(MainMenuKronPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Kron");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(KronSlotPrefab, SlotPanel);
