...
public class MainMenuKaelManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuKaelPanelPrefab;
    private GameObject KaelSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuKaelPanelPrefab = UIManager.Instance.GetGameObject("MainMenuKaelPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        KaelSlotPrefab = UIManager.Instance.GetGameObject("KaelSlotPrefab");
    ...
    public void CreateMainMenuKaelManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Kael");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(KaelSlotPrefab, SlotPanel);
