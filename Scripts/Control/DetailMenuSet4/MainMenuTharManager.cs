...
public class MainMenuTharManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuTharPanelPrefab;
    private GameObject TharSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuTharPanelPrefab = UIManager.Instance.GetGameObject("MainMenuTharPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        TharSlotPrefab = UIManager.Instance.GetGameObject("TharSlotPrefab");
    ...
    public void CreateMainMenuTharManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Thar");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(TharSlotPrefab, SlotPanel);
