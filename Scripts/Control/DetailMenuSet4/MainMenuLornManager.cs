...
public class MainMenuLornManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuLornPanelPrefab;
    private GameObject LornSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuLornPanelPrefab = UIManager.Instance.GetGameObject("MainMenuLornPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        LornSlotPrefab = UIManager.Instance.GetGameObject("LornSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuLornManager(object data)
    {
        currentObject = Instantiate(MainMenuLornPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Lorn");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(LornSlotPrefab, SlotPanel);
