...
public class MainMenuGorrManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuGorrPanelPrefab;
    private GameObject GorrSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuGorrPanelPrefab = UIManager.Instance.GetGameObject("MainMenuGorrPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        GorrSlotPrefab = UIManager.Instance.GetGameObject("GorrSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuGorrManager(object data)
    {
        currentObject = Instantiate(MainMenuGorrPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Gorr");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(GorrSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Gorr");
        BackgroundImage.texture = backgroundTexture;

        RawImage CardImage1 = gameObject.transform.Find("MechaGroup/CardImage1").GetComponent<RawImage>();
        Texture cardTexture1 = Resources.Load<Texture>($"UI/Card/Gorr_1");
        CardImage1.texture = cardTexture1;

        RawImage CardImage2 = gameObject.transform.Find("MechaGroup/CardImage2").GetComponent<RawImage>();
        Texture cardTexture2 = Resources.Load<Texture>($"UI/Card/Gorr_2");
        CardImage2.texture = cardTexture2;
