...
public class MainMenuDravManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDravPanelPrefab;
    private GameObject DravSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuDravPanelPrefab = UIManager.Instance.GetGameObject("MainMenuDravPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        DravSlotPrefab = UIManager.Instance.GetGameObject("DravSlotPrefab");
    ...
    public void CreateMainMenuDravManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Drav");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(DravSlotPrefab, SlotPanel);
