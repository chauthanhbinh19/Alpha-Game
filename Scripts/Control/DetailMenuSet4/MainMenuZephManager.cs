...
public class MainMenuZephManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuZephPanelPrefab;
    private GameObject ZephSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuZephPanelPrefab = UIManager.Instance.GetGameObject("MainMenuZephPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ZephSlotPrefab = UIManager.Instance.GetGameObject("ZephSlotPrefab");
    ...
    public void CreateMainMenuZephManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Zeph");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ZephSlotPrefab, SlotPanel);
