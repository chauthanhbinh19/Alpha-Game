...
public class MainMenuRyzeManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuRyzePanelPrefab;
    private GameObject RyzeSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuRyzePanelPrefab = UIManager.Instance.GetGameObject("MainMenuRyzePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        RyzeSlotPrefab = UIManager.Instance.GetGameObject("RyzeSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuRyzeManager(object data)
    {
        currentObject = Instantiate(MainMenuRyzePanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Ryze");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(RyzeSlotPrefab, SlotPanel);
