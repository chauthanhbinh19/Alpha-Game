...
public class MainMenuNyxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNyxPanelPrefab;
    private GameObject NyxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuNyxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuNyxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        NyxSlotPrefab = UIManager.Instance.GetGameObject("NyxSlotPrefab");
    ...
    public void CreateMainMenuNyxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Nyx");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(NyxSlotPrefab, SlotPanel);
