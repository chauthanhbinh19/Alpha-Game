...
public class MainMenuTornManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuTornPanelPrefab;
    private GameObject TornSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuTornPanelPrefab = UIManager.Instance.GetGameObject("MainMenuTornPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        TornSlotPrefab = UIManager.Instance.GetGameObject("TornSlotPrefab");
    ...
    public void CreateMainMenuTornManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Torn");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(TornSlotPrefab, SlotPanel);
