...
public class MainMenuArosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuArosPanelPrefab;
    private GameObject ArosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuArosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuArosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ArosSlotPrefab = UIManager.Instance.GetGameObject("ArosSlotPrefab");
    ...
    public void CreateMainMenuArosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Aros");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ArosSlotPrefab, SlotPanel);
