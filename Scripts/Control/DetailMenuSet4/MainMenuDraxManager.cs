...
public class MainMenuDraxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDraxPanelPrefab;
    private GameObject DraxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuDraxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuDraxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        DraxSlotPrefab = UIManager.Instance.GetGameObject("DraxSlotPrefab");
    ...
    public void CreateMainMenuDraxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Drax");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(DraxSlotPrefab, SlotPanel);
