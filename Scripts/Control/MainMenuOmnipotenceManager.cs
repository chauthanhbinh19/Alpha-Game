...
public class MainMenuOmnipotenceManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOmnipotencePanelPrefab;
    private GameObject OmnipotenceSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOmnipotencePanelPrefab = UIManager.Instance.GetGameObject("MainMenuOmnipotencePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OmnipotenceSlotPrefab = UIManager.Instance.GetGameObject("OmnipotenceSlotPrefab");
    ...
    public void CreateMainMenuOmnipotenceManager(object data)
    {
        ...
        // {
        //     "Omnipotence I", "Omnipotence II", "Omnipotence III", "Omnipotence IV", "Omnipotence V",
        //     "Omnipotence VI", "Omnipotence VII", "Omnipotence VIII", "Omnipotence IX", "Omnipotence X"
        // };
        Dictionary<string, int> uniqueTypes = new Dictionary<string, int>();
        Features features = new Features();
        uniqueTypes = features.GetFeaturesByType("Omnipotence");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OmnipotenceSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tree_4");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Omnipotence");
