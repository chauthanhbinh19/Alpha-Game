...
public class MainMenuIceManager : MonoBehaviour
{
    ...
    private GameObject IceSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuIcePanelPrefab = UIManager.Instance.GetGameObject("MainMenuIcePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        IceSlotPrefab = UIManager.Instance.GetGameObject("IceSlotPrefab");
    ...
    public void CreateMainMenuIceManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Ice");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(IceSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Ice");
