...
public class MainMenuSpaceManager : MonoBehaviour
{
    ...
    private GameObject SpaceSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuSpacePanelPrefab = UIManager.Instance.GetGameObject("MainMenuSpacePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SpaceSlotPrefab = UIManager.Instance.GetGameObject("SpaceSlotPrefab");
    ...
    public void CreateMainMenuSpaceManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Space");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(SpaceSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Space");
