...
public class MainMenuLifeManager : MonoBehaviour
{
    ...
    private GameObject LifeSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuLifePanelPrefab = UIManager.Instance.GetGameObject("MainMenuLifePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        LifeSlotPrefab = UIManager.Instance.GetGameObject("LifeSlotPrefab");
    ...
    public void CreateMainMenuLifeManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Life");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(LifeSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Life");
