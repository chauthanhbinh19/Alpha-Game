...
public class MainMenuPsionicsManager : MonoBehaviour
{
    ...
    private GameObject PsionicsSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuPsionicsPanelPrefab = UIManager.Instance.GetGameObject("MainMenuPsionicsPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        PsionicsSlotPrefab = UIManager.Instance.GetGameObject("PsionicsSlotPrefab");
    ...
    public void CreateMainMenuPsionicsManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Psionics");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(PsionicsSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Psionics");
