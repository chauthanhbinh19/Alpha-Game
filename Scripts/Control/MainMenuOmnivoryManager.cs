...
public class MainMenuOmnivoryManager : MonoBehaviour
{
    ...
    private GameObject OmnivorySlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOmnivoryPanelPrefab = UIManager.Instance.GetGameObject("MainMenuOmnivoryPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OmnivorySlotPrefab = UIManager.Instance.GetGameObject("OmnivorySlotPrefab");
    ...
    public void CreateMainMenuOmnivoryManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Omnivory");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OmnivorySlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Omnivory");
