...
public class MainMenuTimeManager : MonoBehaviour
{
    ...
    private GameObject TimeSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuTimePanelPrefab = UIManager.Instance.GetGameObject("MainMenuTimePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        TimeSlotPrefab = UIManager.Instance.GetGameObject("TimeSlotPrefab");
    ...
    public void CreateMainMenuTimeManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Time");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(TimeSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Time");
