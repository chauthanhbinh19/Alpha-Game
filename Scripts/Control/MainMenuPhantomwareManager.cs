...
public class MainMenuPhantomwareManager : MonoBehaviour
{
    ...
    private GameObject PhantomwareSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuPhantomwarePanelPrefab = UIManager.Instance.GetGameObject("MainMenuPhantomwarePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        PhantomwareSlotPrefab = UIManager.Instance.GetGameObject("PhantomwareSlotPrefab");
    ...
    public void CreateMainMenuPhantomwareManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Phantomware");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(PhantomwareSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Phantomware");
