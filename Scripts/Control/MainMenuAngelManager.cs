...
public class MainMenuAngelManager : MonoBehaviour
{
    ...
    private GameObject MainMenuAngelPanelPrefab;
    private GameObject AngelSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAngelPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAngelPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AngelSlotPrefab = UIManager.Instance.GetGameObject("AngelSlotPrefab");
    ...
    public void CreateMainMenuAngelManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Angel");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AngelSlotPrefab, SlotPanel);
