...
public class MainMenuSwordManager : MonoBehaviour
{
    ...
    private GameObject SwordSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuSwordPanelPrefab = UIManager.Instance.GetGameObject("MainMenuSwordPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SwordSlotPrefab = UIManager.Instance.GetGameObject("SwordSlotPrefab");
    ...
    public void CreateMainMenuSwordManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Sword");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(SwordSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Sword");
