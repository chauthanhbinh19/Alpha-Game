...
public class MainMenuGunManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuGunPanelPrefab;
    private GameObject GunSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuGunPanelPrefab = UIManager.Instance.GetGameObject("MainMenuGunPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        GunSlotPrefab = UIManager.Instance.GetGameObject("GunSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuGunManager(object data)
    {
        currentObject = Instantiate(MainMenuGunPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Gun");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(GunSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Gun");
