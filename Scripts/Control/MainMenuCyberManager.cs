...
public class MainMenuCyberManager : MonoBehaviour
{
    ...
    private GameObject CyberSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuCyberPanelPrefab = UIManager.Instance.GetGameObject("MainMenuCyberPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        CyberSlotPrefab = UIManager.Instance.GetGameObject("CyberSlotPrefab");
    ...
    public void CreateMainMenuCyberManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Cyber");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(CyberSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Cyber_Wings");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Cyber");
