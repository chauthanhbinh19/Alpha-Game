...
public class MainMenuStarforgeManager : MonoBehaviour
{
    ...
    private GameObject StarforgeSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuStarforgePanelPrefab = UIManager.Instance.GetGameObject("MainMenuStarforgePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        StarforgeSlotPrefab = UIManager.Instance.GetGameObject("StarforgeSlotPrefab");
    ...
    public void CreateMainMenuStarforgeManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Starforge");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(StarforgeSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Starforge");
