...
public class MainMenuOmnipresenceManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOmnipresencePanelPrefab;
    private GameObject OmnipresenceSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOmnipresencePanelPrefab = UIManager.Instance.GetGameObject("MainMenuOmnipresencePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OmnipresenceSlotPrefab = UIManager.Instance.GetGameObject("OmnipresenceSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuOmnipresenceManager(object data)
    {
        currentObject = Instantiate(MainMenuOmnipresencePanelPrefab, MainPanel);
        ...
        // {
        //     "Omnipresence I", "Omnipresence II", "Omnipresence III", "Omnipresence IV", "Omnipresence V",
        //     "Omnipresence VI", "Omnipresence VII", "Omnipresence VIII", "Omnipresence IX", "Omnipresence X"
        // };
        Dictionary<string, int> uniqueTypes = new Dictionary<string, int>();
        Features features = new Features();
        uniqueTypes = features.GetFeaturesByType("Omnipresence");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OmnipresenceSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tree_6");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Omnipresence");
