...
public class MainMenuDemonManager : MonoBehaviour
{
    ...
    private GameObject DemonSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuDemonPanelPrefab = UIManager.Instance.GetGameObject("MainMenuDemonPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        DemonSlotPrefab = UIManager.Instance.GetGameObject("DemonSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuDemonManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Demon");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(DemonSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Demon_Wings");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Demon");
