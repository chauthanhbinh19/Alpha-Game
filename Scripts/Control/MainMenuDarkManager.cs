...
public class MainMenuDarkManager : MonoBehaviour
{
    ...
    private GameObject DarkSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuDarkPanelPrefab = UIManager.Instance.GetGameObject("MainMenuDarkPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        DarkSlotPrefab = UIManager.Instance.GetGameObject("DarkSlotPrefab");
    ...
    public void CreateMainMenuDarkManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Dark");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(DarkSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Dark");
