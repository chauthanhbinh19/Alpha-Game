...
public class MainMenuThunderManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuThunderPanelPrefab;
    private GameObject ThunderSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuThunderPanelPrefab = UIManager.Instance.GetGameObject("MainMenuThunderPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ThunderSlotPrefab = UIManager.Instance.GetGameObject("ThunderSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuThunderManager(object data)
    {
        currentObject = Instantiate(MainMenuThunderPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Thunder");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ThunderSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Thunder");
