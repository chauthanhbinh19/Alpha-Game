...
public class MainMenuQuantumManager : MonoBehaviour
{
    ...
    private GameObject QuantumSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuQuantumPanelPrefab = UIManager.Instance.GetGameObject("MainMenuQuantumPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        QuantumSlotPrefab = UIManager.Instance.GetGameObject("QuantumSlotPrefab");
    ...
    public void CreateMainMenuQuantumManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Quantum");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(QuantumSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Quantum");
