...
public class MainMenuAethernetManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAethernetPanelPrefab;
    private GameObject AethernetSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAethernetPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAethernetPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AethernetSlotPrefab = UIManager.Instance.GetGameObject("AethernetSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuAethernetManager(object data)
    {
        currentObject = Instantiate(MainMenuAethernetPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Aethernet");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AethernetSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Aethernet");
