...
public class MainMenuNeurotechManager : MonoBehaviour
{
    ...
    private GameObject NeurotechSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuNeurotechPanelPrefab = UIManager.Instance.GetGameObject("MainMenuNeurotechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        NeurotechSlotPrefab = UIManager.Instance.GetGameObject("NeurotechSlotPrefab");
    ...
    public void CreateMainMenuNeurotechManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Neurotech");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(NeurotechSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Neurotech");
