...
public class MainMenuAntimatterManager : MonoBehaviour
{
    ...
    private GameObject AntimatterSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAntimatterPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAntimatterPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AntimatterSlotPrefab = UIManager.Instance.GetGameObject("AntimatterSlotPrefab");
    ...
    public void CreateMainMenuAntimatterManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Antimatter");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AntimatterSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Antimatter");
