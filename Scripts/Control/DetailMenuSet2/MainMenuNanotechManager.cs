...
public class MainMenuNanotechManager : MonoBehaviour
{
    ...
    private GameObject NanotechSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuNanotechPanelPrefab = UIManager.Instance.GetGameObject("MainMenuNanotechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        NanotechSlotPrefab = UIManager.Instance.GetGameObject("NanotechSlotPrefab");
    ...
    public void CreateMainMenuNanotechManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Nanotech");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(NanotechSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Nanotech");
