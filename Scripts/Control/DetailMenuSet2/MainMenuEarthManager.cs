...
public class MainMenuEarthManager : MonoBehaviour
{
    ...
    private GameObject EarthSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuEarthPanelPrefab = UIManager.Instance.GetGameObject("MainMenuEarthPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        EarthSlotPrefab = UIManager.Instance.GetGameObject("EarthSlotPrefab");
    ...
    public void CreateMainMenuEarthManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Earth");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(EarthSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Earth");
