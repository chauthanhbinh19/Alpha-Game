...
public class MainMenuHolographyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHolographyPanelPrefab;
    private GameObject HolographySlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuHolographyPanelPrefab = UIManager.Instance.GetGameObject("MainMenuHolographyPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        HolographySlotPrefab = UIManager.Instance.GetGameObject("HolographySlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuHolographyManager(object data)
    {
        currentObject = Instantiate(MainMenuHolographyPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Holography");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(HolographySlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Holography");
