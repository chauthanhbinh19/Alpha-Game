...
public class MainMenuOmnivisionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOmnivisionPanelPrefab;
    private GameObject OmnivisionSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOmnivisionPanelPrefab = UIManager.Instance.GetGameObject("MainMenuOmnivisionPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OmnivisionSlotPrefab = UIManager.Instance.GetGameObject("OmnivisionSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuOmnivisionManager(object data)
    {
        currentObject = Instantiate(MainMenuOmnivisionPanelPrefab, MainPanel);
        ...
        // {
        //     "Omnivision I", "Omnivision II", "Omnivision III", "Omnivision IV", "Omnivision V",
        //     "Omnivision VI", "Omnivision VII", "Omnivision VIII", "Omnivision IX", "Omnivision X"
        // };
        Dictionary<string, int> uniqueTypes = new Dictionary<string, int>();
        Features features = new Features();
        uniqueTypes = features.GetFeaturesByType("Omnivision");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OmnivisionSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tree_9");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Omnivision");
