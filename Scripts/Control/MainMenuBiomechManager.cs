...
public class MainMenuBiomechManager : MonoBehaviour
{
    ...
    private GameObject BiomechSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuBiomechPanelPrefab = UIManager.Instance.GetGameObject("MainMenuBiomechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        BiomechSlotPrefab = UIManager.Instance.GetGameObject("BiomechSlotPrefab");
    ...
    public void CreateMainMenuBiomechManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Biomech");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(BiomechSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Biomech");
