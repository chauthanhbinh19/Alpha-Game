...
public class MainMenuPhysiqueManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPhysiquePanelPrefab;
    private GameObject PhysiqueSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuPhysiquePanelPrefab = UIManager.Instance.GetGameObject("MainMenuPhysiquePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        PhysiqueSlotPrefab = UIManager.Instance.GetGameObject("PhysiqueSlotPrefab");
    ...
    public void CreateMainMenuPhysiqueManager(object data)
    {
        ...
        // {
        //     "Quantum Physique", "Neural Fusion Physique", "Gravity Pulse Physique", "Plasma Reactor Physique", "Nanite Swarm Physique",
        //     "Zero-Point Physique", "Hyperdrive Physique", "AI Synchronization Physique", "EMP Disruptor Physique", "Inferno Physique",
        //     "Aqua Physique", "Terra Physique", "Storm Physique", "Cryo Physique", "Solar Flare Physique",
        //     "Tornado Physique", "Lunar Physique", "Magma Physique", "Void Physique", "Phoenix Physique",
        //     "Beast Physique", "Mutation Physique", "Regeneration Physique", "Symbiote Physique", "Vampiric Physique",
        //     "Psyonic Physique", "Chimera Physique", "Shadow Parasite Physique", "Soulbound Physique",
        //     "Ethereal Physique", "Celestial Physique", "Demonic Physique", "Excalibur Physique", "Divine Judgment Physique",
        //     "Singularity Physique", "Neutron Star Physique", "Chrono Physique", "Anti-Matter Physique", "Cosmic Forge Physique"
        // };
        Dictionary<string, int> uniqueTypes = new Dictionary<string, int>();
        Features features = new Features();
        uniqueTypes = features.GetFeaturesByType("Physique");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(PhysiqueSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tree_3");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Physique");
