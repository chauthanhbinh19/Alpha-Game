...
public class MainMenuAzathothManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAzathothPanelPrefab;
    private GameObject AzathothSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAzathothPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAzathothPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AzathothSlotPrefab = UIManager.Instance.GetGameObject("AzathothSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuAzathothManager(object data)
    {
        currentObject = Instantiate(MainMenuAzathothPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Azathoth");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AzathothSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Azathoth");
