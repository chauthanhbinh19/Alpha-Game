...
public class MainMenuXyphosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuXyphosPanelPrefab;
    private GameObject XyphosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuXyphosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuXyphosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        XyphosSlotPrefab = UIManager.Instance.GetGameObject("XyphosSlotPrefab");
    ...
    public void CreateMainMenuXyphosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Xyphos");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(XyphosSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Xyphos");
