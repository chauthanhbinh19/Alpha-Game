...
public class MainMenuXylkorManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuXylkorPanelPrefab;
    private GameObject XylkorSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuXylkorPanelPrefab = UIManager.Instance.GetGameObject("MainMenuXylkorPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        XylkorSlotPrefab = UIManager.Instance.GetGameObject("XylkorSlotPrefab");
    ...
    public void CreateMainMenuXylkorManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Xylkor");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(XylkorSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Xylkor");
