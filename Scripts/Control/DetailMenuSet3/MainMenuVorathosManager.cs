...
public class MainMenuVorathosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVorathosPanelPrefab;
    private GameObject VorathosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuVorathosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuVorathosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        VorathosSlotPrefab = UIManager.Instance.GetGameObject("VorathosSlotPrefab");
    ...
    public void CreateMainMenuVorathosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Vorathos");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(VorathosSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Vorathos");
