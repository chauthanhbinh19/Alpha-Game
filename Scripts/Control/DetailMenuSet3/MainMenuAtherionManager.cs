...
public class MainMenuAtherionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAtherionPanelPrefab;
    private GameObject AtherionSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAtherionPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAtherionPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AtherionSlotPrefab = UIManager.Instance.GetGameObject("AtherionSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuAtherionManager(object data)
    {
        currentObject = Instantiate(MainMenuAtherionPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Atherion");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AtherionSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Atherion");
