...
public class MainMenuShubNiggurathManager : MonoBehaviour
{
    ...
    private GameObject ShubNiggurathSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuShubNiggurathPanelPrefab = UIManager.Instance.GetGameObject("MainMenuShubNiggurathPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ShubNiggurathSlotPrefab = UIManager.Instance.GetGameObject("ShubNiggurathSlotPrefab");
    ...
    public void CreateMainMenuShubNiggurathManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Shub-Niggurath");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ShubNiggurathSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/ShubNiggurath");
