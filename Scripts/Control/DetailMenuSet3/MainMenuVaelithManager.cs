...
public class MainMenuVaelithManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVaelithPanelPrefab;
    private GameObject VaelithSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuVaelithPanelPrefab = UIManager.Instance.GetGameObject("MainMenuVaelithPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        VaelithSlotPrefab = UIManager.Instance.GetGameObject("VaelithSlotPrefab");
    ...
    public void CreateMainMenuVaelithManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Vaelith");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(VaelithSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Vaelith");
