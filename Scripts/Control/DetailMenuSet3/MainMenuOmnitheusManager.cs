...
public class MainMenuOmnitheusManager : MonoBehaviour
{
    ...
    private GameObject OmnitheusSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOmnitheusPanelPrefab = UIManager.Instance.GetGameObject("MainMenuOmnitheusPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OmnitheusSlotPrefab = UIManager.Instance.GetGameObject("OmnitheusSlotPrefab");
    ...
    public void CreateMainMenuOmnitheusManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Omnitheus");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OmnitheusSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Omnitheus");
