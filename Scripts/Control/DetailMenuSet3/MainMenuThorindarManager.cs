...
public class MainMenuThorindarManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuThorindarPanelPrefab;
    private GameObject ThorindarSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuThorindarPanelPrefab = UIManager.Instance.GetGameObject("MainMenuThorindarPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ThorindarSlotPrefab = UIManager.Instance.GetGameObject("ThorindarSlotPrefab");
    ...
    public void CreateMainMenuThorindarManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Thorindar");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ThorindarSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Thorindar");
