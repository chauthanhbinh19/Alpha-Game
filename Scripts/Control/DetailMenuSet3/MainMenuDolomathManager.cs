...
public class MainMenuDolomathManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDolomathPanelPrefab;
    private GameObject DolomathSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuDolomathPanelPrefab = UIManager.Instance.GetGameObject("MainMenuDolomathPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        DolomathSlotPrefab = UIManager.Instance.GetGameObject("DolomathSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuDolomathManager(object data)
    {
        currentObject = Instantiate(MainMenuDolomathPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Dolomath");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(DolomathSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Dolomath");
