...
public class MainMenuArathorManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuArathorPanelPrefab;
    private GameObject ArathorSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuArathorPanelPrefab = UIManager.Instance.GetGameObject("MainMenuArathorPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ArathorSlotPrefab = UIManager.Instance.GetGameObject("ArathorSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuArathorManager(object data)
    {
        currentObject = Instantiate(MainMenuArathorPanelPrefab, MainPanel);
        ...
        uniqueTypes = features.GetFeaturesByType("Arathor");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ArathorSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Arathor");
