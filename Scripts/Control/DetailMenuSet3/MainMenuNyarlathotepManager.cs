...
public class MainMenuNyarlathotepManager : MonoBehaviour
{
    ...
    private GameObject NyarlathotepSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuNyarlathotepPanelPrefab = UIManager.Instance.GetGameObject("MainMenuNyarlathotepPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        NyarlathotepSlotPrefab = UIManager.Instance.GetGameObject("NyarlathotepSlotPrefab");
    ...
    public void CreateMainMenuNyarlathotepManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Nyarlathotep");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(NyarlathotepSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Nyarlathotep");
