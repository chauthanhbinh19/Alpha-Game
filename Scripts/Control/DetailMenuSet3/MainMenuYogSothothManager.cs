...
public class MainMenuYogSothothManager : MonoBehaviour
{
    ...
    private GameObject YogSothothSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuYogSothothPanelPrefab = UIManager.Instance.GetGameObject("MainMenuYogSothothPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        YogSothothSlotPrefab = UIManager.Instance.GetGameObject("YogSothothSlotPrefab");
    ...
    public void CreateMainMenuYogSothothManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Yog-Sothoth");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(YogSothothSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/YogSothoth");
