...
public class MainMenuTenebrisManager : MonoBehaviour
{
    ...
    private GameObject TenebrisSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuTenebrisPanelPrefab = UIManager.Instance.GetGameObject("MainMenuTenebrisPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        TenebrisSlotPrefab = UIManager.Instance.GetGameObject("TenebrisSlotPrefab");
    ...
    public void CreateMainMenuTenebrisManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Tenebris");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(TenebrisSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tenebris");
