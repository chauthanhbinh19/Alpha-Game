...
public class MainMenuPhyrixaManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPhyrixaPanelPrefab;
    private GameObject PhyrixaSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuPhyrixaPanelPrefab = UIManager.Instance.GetGameObject("MainMenuPhyrixaPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        PhyrixaSlotPrefab = UIManager.Instance.GetGameObject("PhyrixaSlotPrefab");
    ...
    public void CreateMainMenuPhyrixaManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Phyrixa");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(PhyrixaSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Phyrixa");
