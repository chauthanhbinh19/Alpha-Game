...
public class MainMenuNihorathManager : MonoBehaviour
{
    ...
    private GameObject NihorathSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuNihorathPanelPrefab = UIManager.Instance.GetGameObject("MainMenuNihorathPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        NihorathSlotPrefab = UIManager.Instance.GetGameObject("NihorathSlotPrefab");
    ...
    public void CreateMainMenuNihorathManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Nihorath");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(NihorathSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Nihorath");
