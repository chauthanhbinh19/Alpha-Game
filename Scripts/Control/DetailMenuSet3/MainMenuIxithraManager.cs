...
public class MainMenuIxithraManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuIxithraPanelPrefab;
    private GameObject IxithraSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuIxithraPanelPrefab = UIManager.Instance.GetGameObject("MainMenuIxithraPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        IxithraSlotPrefab = UIManager.Instance.GetGameObject("IxithraSlotPrefab");
    ...
    public void CreateMainMenuIxithraManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Ixithra");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(IxithraSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Ixithra");
