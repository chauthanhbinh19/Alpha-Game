...
public class MainMenuZilthrosManager : MonoBehaviour
{
    ...
    private GameObject ZilthrosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuZilthrosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuZilthrosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ZilthrosSlotPrefab = UIManager.Instance.GetGameObject("ZilthrosSlotPrefab");
    ...
    public void CreateMainMenuZilthrosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Zilthros");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ZilthrosSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Zilthros");
