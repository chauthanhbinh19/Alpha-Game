...
public class MainMenuVeltharionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVeltharionPanelPrefab;
    private GameObject VeltharionSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuVeltharionPanelPrefab = UIManager.Instance.GetGameObject("MainMenuVeltharionPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        VeltharionSlotPrefab = UIManager.Instance.GetGameObject("VeltharionSlotPrefab");
    ...
    public void CreateMainMenuVeltharionManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Veltharion");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(VeltharionSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Veltharion");
