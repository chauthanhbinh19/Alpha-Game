...
public class MainMenuAeonaxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAeonaxPanelPrefab;
    private GameObject AeonaxSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuAeonaxPanelPrefab = UIManager.Instance.GetGameObject("MainMenuAeonaxPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        AeonaxSlotPrefab = UIManager.Instance.GetGameObject("AeonaxSlotPrefab");
    ...
    public void CreateMainMenuAeonaxManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Aeonax");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(AeonaxSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Aeonax");
