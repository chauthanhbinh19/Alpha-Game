...
public class MainMenuSeraphirosManager : MonoBehaviour
{
    ...
    private GameObject SeraphirosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuSeraphirosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuSeraphirosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SeraphirosSlotPrefab = UIManager.Instance.GetGameObject("SeraphirosSlotPrefab");
    ...
    public void CreateMainMenuSeraphirosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Seraphiros");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(SeraphirosSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Seraphiros");
