...
public class MainMenuArcanosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuArcanosPanelPrefab;
    private GameObject ArcanosSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuArcanosPanelPrefab = UIManager.Instance.GetGameObject("MainMenuArcanosPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        ArcanosSlotPrefab = UIManager.Instance.GetGameObject("ArcanosSlotPrefab");
    ...
    public void CreateMainMenuArcanosManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Arcanos");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(ArcanosSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Arcanos");
