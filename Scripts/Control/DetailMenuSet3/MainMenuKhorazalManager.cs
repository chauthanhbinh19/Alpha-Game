...
public class MainMenuKhorazalManager : MonoBehaviour
{
    ...
    private GameObject KhorazalSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuKhorazalPanelPrefab = UIManager.Instance.GetGameObject("MainMenuKhorazalPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        KhorazalSlotPrefab = UIManager.Instance.GetGameObject("KhorazalSlotPrefab");
        ElementDetails2Prefab = UIManager.Instance.GetGameObject("ElementDetails2Prefab");
    }

    public void CreateMainMenuKhorazalManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Khorazal");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(KhorazalSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Khorazal");
