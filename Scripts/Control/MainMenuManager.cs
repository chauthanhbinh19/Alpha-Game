...
public class MainMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AssignButtonEvent("Button_15", mainMenuPanel, () => GetType("Bag"));
        AssignButtonEvent("Button_16", mainMenuPanel, () => GetType("Teams"));
        AssignButtonEvent("Button_17", mainMenuPanel, () => GetType("CardColonels"));
        AssignButtonEvent("Button_18", mainMenuPanel, () => GetType("CardGenerals"));
        AssignButtonEvent("Button_19", mainMenuPanel, () => GetType("CardAdmirals"));
