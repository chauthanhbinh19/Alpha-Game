...
public class MainMenuBloodlineManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuBloodlinePanelPrefab;
    private GameObject BloodlineSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuBloodlinePanelPrefab = UIManager.Instance.GetGameObject("MainMenuBloodlinePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        BloodlineSlotPrefab = UIManager.Instance.GetGameObject("BloodlineSlotPrefab");
    ...
    public void CreateMainMenuBloodlineManager(object data)
    {
        ...
        // {
        //     "Quantum Bloodline", "Neural Fusion Bloodline", "Gravity Pulse Bloodline", "Plasma Reactor Bloodline", "Nanite Swarm Bloodline",
        //     "Zero-Point Bloodline", "Hyperdrive Bloodline", "AI Synchronization Bloodline", "EMP Disruptor Bloodline", "Inferno Bloodline",
        //     "Aqua Bloodline", "Terra Bloodline", "Storm Bloodline", "Cryo Bloodline", "Solar Flare Bloodline",
        //     "Tornado Bloodline", "Lunar Bloodline", "Magma Bloodline", "Void Bloodline", "Phoenix Bloodline",
        //     "Beast Bloodline", "Mutation Bloodline", "Regeneration Bloodline", "Symbiote Bloodline", "Vampiric Bloodline",
        //     "Psyonic Bloodline", "Chimera Bloodline", "Shadow Parasite Bloodline", "Soulbound Bloodline",
        //     "Ethereal Bloodline", "Celestial Bloodline", "Demonic Bloodline", "Excalibur Bloodline", "Divine Judgment Bloodline",
        //     "Singularity Bloodline", "Neutron Star Bloodline", "Chrono Bloodline", "Anti-Matter Bloodline", "Cosmic Forge Bloodline"
        // };
        Dictionary<string, int> uniqueTypes = new Dictionary<string, int>();
        Features features = new Features();
        uniqueTypes = features.GetFeaturesByType("Bloodline");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(BloodlineSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Tree_5");
