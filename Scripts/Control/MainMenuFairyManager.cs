...
public class MainMenuFairyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuFairyPanelPrefab;
    private GameObject FairySlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuFairyPanelPrefab = UIManager.Instance.GetGameObject("MainMenuFairyPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        FairySlotPrefab = UIManager.Instance.GetGameObject("FairySlotPrefab");
    ...
    public void CreateMainMenuFairyManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Fairy");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(FairySlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Fairy_Wings");
        ...
        for (int i = 1; i <= totalSkills; i++)
        {
            ...
            Texture texture = Resources.Load<Texture>($"UI/Rank/Fairy");
