...
public class MainMenuOrbitalisManager : MonoBehaviour
{
    ...
    private GameObject OrbitalisSlotPrefab;
    ...
    void Start()
    {
        ...
        MainMenuOrbitalisPanelPrefab = UIManager.Instance.GetGameObject("MainMenuOrbitalisPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        OrbitalisSlotPrefab = UIManager.Instance.GetGameObject("OrbitalisSlotPrefab");
    ...
    public void CreateMainMenuOrbitalisManager(object data)
    {
        ...
        uniqueTypes = features.GetFeaturesByType("Orbitalis");
    ...
    public void CreateCardHeroesEquipments(CardHeroes cardHeroes)
    {
        ...
        slotObject = Instantiate(OrbitalisSlotPrefab, SlotPanel);
    ...
    public void SetUI(GameObject gameObject, string type, int level = 0)
    {
        ...
        Texture backgroundTexture = Resources.Load<Texture>("UI/Background3/Orbitalis");
