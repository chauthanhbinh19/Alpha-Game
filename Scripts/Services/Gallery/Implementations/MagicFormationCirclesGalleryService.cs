...
public class MagicFormationCirclesGalleryService : IMagicFormationCirclesGalleryService
{
    ...
    {
        List<MagicFormationCircles> list = await _magicFormationCirclesGalleryRepository.GetMagicFormationCirclesCollectionAsync(search, type, pageSize, offset, rare);
    ...
    public async Task InsertMagicFormationCircleGalleryAsync(string Id)
    {
        ...
        await _magicFormationCirclesGalleryRepository.InsertMagicFormationCircleGalleryAsync(Id, await _service.GetMagicFormationCircleByIdAsync(Id));
    }

    public async Task UpdateStatusMagicFormationCircleGalleryAsync(string Id)
    {
        await _magicFormationCirclesGalleryRepository.UpdateStatusMagicFormationCircleGalleryAsync(Id);
    }

    public async Task<MagicFormationCircles> SumPowerMagicFormationCirclesGalleryAsync()
    {
        return await _magicFormationCirclesGalleryRepository.SumPowerMagicFormationCirclesGalleryAsync();
    }

    public async Task UpdateStarMagicFormationCircleGalleryAsync(string Id, double star)
    {
        await _magicFormationCirclesGalleryRepository.UpdateStarMagicFormationCircleGalleryAsync(Id, star);
    }
    ...
    public async Task UpdateMagicFormationCircleGalleryPowerAsync(string Id)
    {
        IMagicFormationCirclesRepository _repository = new MagicFormationCirclesRepository();
        MagicFormationCirclesService _service = new MagicFormationCirclesService(_repository);
        await _magicFormationCirclesGalleryRepository.UpdateMagicFormationCircleGalleryPowerAsync(Id, await _service.GetMagicFormationCircleByIdAsync(Id));
    }
}
