...
public class ArtworksGalleryService : IArtworksGalleryService
{
    ...
    public async Task<bool> UpdateStarArtworkGalleryAsync(string userId, string Id, double star)
    {
        var updateResult = await _artworksGalleryRepository.UpdateStarArtworkGalleryAsync(userId, Id, star);
