...
public class CardCaptainsGalleryService : ICardCaptainsGalleryService
{
    ...
    public async Task InsertCardCaptainGalleryAsync(string userId, string Id)
    {
        ...
        await _cardCaptainsGalleryRepository.InsertCardCaptainGalleryAsync(userId, Id, await _service.GetCardCaptainByIdAsync(Id));
    }

    public async Task UpdateStatusCardCaptainGalleryAsync(string userId, string Id)
    {
        await _cardCaptainsGalleryRepository.UpdateStatusCardCaptainGalleryAsync(userId, Id);
    }
    ...
    public async Task UpdateStarCardCaptainGalleryAsync(string userId, string Id, double star)
    {
        await _cardCaptainsGalleryRepository.UpdateStarCardCaptainGalleryAsync(userId, Id, star);
    }
