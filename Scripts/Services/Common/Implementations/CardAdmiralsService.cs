...
public class CardAdmiralsService : ICardAdmiralsService
{
    ...
    public static ICardAdmiralsService Create() => ServiceContainer.GetService<ICardAdmiralsService>();
    ...
    public async Task<InsertOrUpdateResult<bool>> InsertCardAdmiralAsync(CardAdmirals entity)
    {
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateCardAdmiralAsync(CardAdmirals entity)
    {
    ...
    {
        return await _cardAdmiralsRepository.GetCardAdmiralsWithoutLimitAsync();
    }
}