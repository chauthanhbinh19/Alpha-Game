...
public class CollaborationEquipmentsService : ICollaborationEquipmentsService
{
    ...
    public async Task<InsertOrUpdateResult<bool>> InsertCollaborationEquipmentAsync(CollaborationEquipments entity)
    {
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateCollaborationEquipmentAsync(CollaborationEquipments entity)
    {
