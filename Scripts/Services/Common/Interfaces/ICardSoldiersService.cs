...
public interface ICardSoldiersService
{
    ...
    Task<InsertOrUpdateResult<bool>> InsertCardSoldierAsync(CardSoldiers entity);
    Task<InsertOrUpdateResult<bool>> UpdateCardSoldierAsync(CardSoldiers entity); 
