...
public class UserPetsService : IUserPetsService
{
    ...
    public List<Pets> GetAllMasterPower(string user_id, List<Pets> PetsList)
    {
        IUserPetsMasterRepository userPetsMasterRepository = new UserPetsMasterRepository();
        UserPetsMasterService userPetsMasterService = new UserPetsMasterService(userPetsMasterRepository);
        foreach (var c in PetsList)
        {
            Pets card = _userPetsRepository.GetUserPetsById(user_id, c.Id);
            Master master = userPetsMasterService.GetSumPetsMaster(user_id, c.Id);
    ...
    {
        List<Pets> list = _userPetsRepository.GetUserPets(user_id, type, pageSize, offset, rare);
    ...
    {
        return _userPetsRepository.UpdateTeamCardPets(team_id, card_id);
    }
