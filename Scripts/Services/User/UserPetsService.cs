...
public class UserPetsService : IUserPetsService
{
    ...
    public Pets GetNewLevelPower(Pets c, double coefficient)
    {
        ...
        pets.power = EvaluatePower.CalculatePower(
            ...
            pets.speed,
            pets.critical_damage_rate, pets.critical_rate, pets.critical_resistance_rate, pets.ignore_critical_rate,
            pets.penetration_rate, pets.penetration_resistance_rate, pets.evasion_rate,
            pets.damage_absorption_rate, pets.ignore_damage_absorption_rate, pets.absorbed_damage_rate,
            pets.vitality_regeneration_rate, pets.vitality_regeneration_resistance_rate,
            pets.accuracy_rate, pets.lifesteal_rate,
            pets.shield_strength, pets.tenacity, pets.resistance_rate,
            pets.combo_rate, pets.ignore_combo_rate, pets.combo_damage_rate, pets.combo_resistance_rate,
            pets.stun_rate, pets.ignore_stun_rate,
            pets.reflection_rate, pets.ignore_reflection_rate, pets.reflection_damage_rate, pets.reflection_resistance_rate,
            ...
            pets.normal_damage_rate, pets.normal_resistance_rate,
            pets.skill_damage_rate, pets.skill_resistance_rate
        );
        return pets;
    }
