...
public class UserCollaborationService : IUserCollaborationService
{
    ...
    public Collaborations GetNewLevelPower(Collaborations c, double coefficient)
    {
        ...
        Collaborations orginCard = _service.GetCollaborationsById(c.Id);
    ...
    public Collaborations GetNewBreakthroughPower(Collaborations c, double coefficient)
    {
        ICollaborationRepository _repository = new CollaborationRepository();
        CollaborationService _service = new CollaborationService(_repository);
        Collaborations orginCard = _service.GetCollaborationsById(c.Id);
    ...
    {
        List<Collaborations> list = _userCollaborationRepository.GetUserCollaboration(user_id, pageSize, offset, rare);
