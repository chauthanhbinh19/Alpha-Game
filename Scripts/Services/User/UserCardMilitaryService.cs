...
public class UserCardMilitaryService : IUserCardMilitaryService
{
    ...
    public List<CardMilitaries> GetFinalPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
        ...
        foreach (var c in CardMilitaryList)
        {
            ...
            c.PhysicalAttack = c.PhysicalAttack + powerManager.physical_attack + card.PhysicalAttack * powerManager.PercentAllPhysicalAttack / 100;
            c.PhysicalDefense = c.PhysicalDefense + powerManager.physical_defense + card.PhysicalDefense * powerManager.PercentAllPhysicalDefense / 100;
            c.MagicalAttack = c.MagicalAttack + powerManager.magical_attack + card.MagicalAttack * powerManager.PercentAllMagicalAttack / 100;
            c.MagicalDefense = c.MagicalDefense + powerManager.magical_defense + card.MagicalDefense * powerManager.PercentAllMagicalDefense / 100;
            c.ChemicalAttack = c.ChemicalAttack + powerManager.chemical_attack + card.ChemicalAttack * powerManager.PercentAllChemicalAttack / 100;
            c.ChemicalDefense = c.ChemicalDefense + powerManager.chemical_defense + card.ChemicalDefense * powerManager.PercentAllChemicalDefense / 100;
            c.AtomicAttack = c.AtomicAttack + powerManager.atomic_attack + card.AtomicAttack * powerManager.PercentAllAtomicAttack / 100;
            c.AtomicDefense = c.AtomicDefense + powerManager.atomic_defense + card.AtomicDefense * powerManager.PercentAllAtomicDefense / 100;
            c.MentalAttack = c.MentalAttack + powerManager.mental_attack + card.MentalAttack * powerManager.PercentAllMentalAttack / 100;
            c.MentalDefense = c.MentalDefense + powerManager.mental_defense + card.MentalDefense * powerManager.PercentAllMentalDefense / 100;
    ...
    public List<CardMilitaries> GetScienceFictionPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public List<CardMilitaries> GetAllEquipmentPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public List<CardMilitaries> GetAllRankPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
        ...
        foreach (var c in CardMilitaryList)
        {
            CardMilitaries card = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, c.Id);
    ...
    public List<CardMilitaries> GetAllMasterPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
        IUserCardMilitaryMasterRepository userCardMilitaryMasterRepository = new UserCardMilitaryMasterRepository();
        UserCardMilitaryMasterService userCardMilitaryMasterService = new UserCardMilitaryMasterService(userCardMilitaryMasterRepository);
        foreach (var c in CardMilitaryList)
        {
            CardMilitaries card = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, c.Id);
            Master master = userCardMilitaryMasterService.GetSumCardMilitaryMaster(user_id, c.Id);
    ...
    public List<CardMilitaries> GetAllAnimeStatsPower(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public List<CardMilitaries> GetAllSpiritBeastPower(string user_id, List<CardMilitaries> cardMilitaries)
    {
        ...
        {
            CardMilitaries card = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, c.Id);
            SpiritBeasts spiritBeast = userSpiritBeastService.GetUserCardMilitarySpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardMilitaries GetNewLevelPower(CardMilitaries c, double coefficient)
    {
        ...
        CardMilitaries orginCard = _service.GetCardMilitaryById(c.Id);
    ...
    public CardMilitaries GetNewBreakthroughPower(CardMilitaries c, double coefficient)
    {
        ICardMilitaryRepository _repository = new CardMilitaryRepository();
        CardMilitaryService _service = new CardMilitaryService(_repository);
        CardMilitaries orginCard = _service.GetCardMilitaryById(c.Id);
    ...
    {
        List<CardMilitaries> list = _userCardMilitaryRepository.GetUserCardMilitaryTeam(user_id, teamId, position);
        list = GetAllSpiritBeastPower(user_id, list);
        list = QualityEvaluator.GetQualityPower(list);
        list = GetFinalPower(user_id, list);
        list = GetAllEquipmentPower(user_id, list);
    ...
    {
        return _userCardMilitaryRepository.UpdateTeamCardMilitary(team_id, position, card_id);
    }
    ...
    {
        return _userCardMilitaryRepository.GetUserCardMilitaryTeamsCount(user_id, team_id);
    }
    ...
    {
        CardMilitaries cardMilitary = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, Id);
    ...
    {
        List<CardMilitaries> list = _userCardMilitaryRepository.GetAllUserCardMilitaryInTeam(user_id);
        list = QualityEvaluator.GetQualityPower(list);
        list = GetFinalPower(user_id, list);
        list = GetAllEquipmentPower(user_id, list);
        list = GetAllRankPower(user_id, list);
