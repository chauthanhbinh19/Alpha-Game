...
public class UserCardMilitaryService : IUserCardMilitaryService
{
    ...
    public List<CardMilitary> GetScienceFictionPower(string user_id, List<CardMilitary> CardMilitaryList)
    {
    ...
    public List<CardMilitary> GetAllMasterPower(string user_id, List<CardMilitary> CardMilitaryList)
    {
    ...
    public List<CardMilitary> GetAllSpiritBeastPower(string user_id, List<CardMilitary> cardMilitaries)
    {
        ...
        {
            CardMilitary card = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, c.id);
            SpiritBeast spiritBeast = userSpiritBeastService.GetUserCardMilitarySpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardMilitary GetNewLevelPower(CardMilitary c, double coefficient)
    {
        ...
        cardMilitary.power = EvaluatePower.CalculatePower(
            ...
            cardMilitary.speed,
            cardMilitary.critical_damage_rate, cardMilitary.critical_rate, cardMilitary.critical_resistance_rate, cardMilitary.ignore_critical_rate,
            cardMilitary.penetration_rate, cardMilitary.penetration_resistance_rate, cardMilitary.evasion_rate,
            cardMilitary.damage_absorption_rate, cardMilitary.ignore_damage_absorption_rate, cardMilitary.absorbed_damage_rate,
            cardMilitary.vitality_regeneration_rate, cardMilitary.vitality_regeneration_resistance_rate,
            ...
            cardMilitary.combo_rate, cardMilitary.ignore_combo_rate, cardMilitary.combo_damage_rate, cardMilitary.combo_resistance_rate,
            cardMilitary.stun_rate, cardMilitary.ignore_stun_rate,
            cardMilitary.reflection_rate, cardMilitary.ignore_reflection_rate, cardMilitary.reflection_damage_rate, cardMilitary.reflection_resistance_rate,
            ...
            cardMilitary.normal_damage_rate, cardMilitary.normal_resistance_rate,
            cardMilitary.skill_damage_rate, cardMilitary.skill_resistance_rate
        );
        return cardMilitary;
    }
    ...
    {
        CardMilitary cardMilitary = _userCardMilitaryRepository.GetUserCardMilitaryById(user_id, Id);
        if (cardMilitary == null) return null;

        // Bọc vào list để tái sử dụng logic
        List<CardMilitary> list = new List<CardMilitary> { cardMilitary };
