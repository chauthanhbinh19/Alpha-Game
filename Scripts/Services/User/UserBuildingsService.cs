...
{
    private readonly IUserBuildingsRepository _userBuildingRepository;

    public UserBuildingsService(IUserBuildingsRepository userBuildingRepository)
    {
    ...
    {
        return new UserBuildingsService(new UserBuildingsRepository());
    }
    ...
    {
        return await _userBuildingRepository.InsertUserBuildingAsync(Building, userId);
    }

    public async Task<bool> UpdateBuildingLevelAsync(Buildings Building, int cardLevel)
    {
        return await _userBuildingRepository.UpdateBuildingLevelAsync(Building, cardLevel);
    }

    public async Task<bool> UpdateBuildingBreakthroughAsync(Buildings Building, int star, double quantity)
    {
        return await _userBuildingRepository.UpdateBuildingBreakthroughAsync(Building, star, quantity);
    }

    public async Task<Buildings> GetUserBuildingByIdAsync(string user_id, string Id)
    {
        return await _userBuildingRepository.GetUserBuildingByIdAsync(user_id, Id);
    }

    public async Task<Buildings> SumPowerUserBuildingsAsync()
    {
        return await _userBuildingRepository.SumPowerUserBuildingsAsync();
    }
}
