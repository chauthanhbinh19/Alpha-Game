...
public class UserCardAdmiralsService : IUserCardAdmiralsService
{
    ...
    public List<CardAdmirals> GetAllSpiritBeastPower(string user_id, List<CardAdmirals> cardAdmirals)
    {
        ...
        {
            CardAdmirals card = _userCardAdmiralsRepository.GetUserCardAdmiralsById(user_id, c.id);
            SpiritBeast spiritBeast = userSpiritBeastService.GetUserCardAdmiralsSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardAdmirals GetNewLevelPower(CardAdmirals c, double coefficient)
    {
        ...
        cardAdmirals.power = EvaluatePower.CalculatePower(
            ...
            cardAdmirals.speed,
            cardAdmirals.critical_damage_rate, cardAdmirals.critical_rate, cardAdmirals.critical_resistance_rate, cardAdmirals.ignore_critical_rate,
            cardAdmirals.penetration_rate, cardAdmirals.penetration_resistance_rate, cardAdmirals.evasion_rate,
            cardAdmirals.damage_absorption_rate, cardAdmirals.ignore_damage_absorption_rate, cardAdmirals.absorbed_damage_rate,
            cardAdmirals.vitality_regeneration_rate, cardAdmirals.vitality_regeneration_resistance_rate,
            ...
            cardAdmirals.combo_rate, cardAdmirals.ignore_combo_rate, cardAdmirals.combo_damage_rate, cardAdmirals.combo_resistance_rate,
            cardAdmirals.stun_rate, cardAdmirals.ignore_stun_rate,
            cardAdmirals.reflection_rate, cardAdmirals.ignore_reflection_rate, cardAdmirals.reflection_damage_rate, cardAdmirals.reflection_resistance_rate,
            ...
            cardAdmirals.normal_damage_rate, cardAdmirals.normal_resistance_rate,
            cardAdmirals.skill_damage_rate, cardAdmirals.skill_resistance_rate
        );
        return cardAdmirals;
    }
