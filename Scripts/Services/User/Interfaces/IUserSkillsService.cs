...
public interface IUserSkillsService
{
    ...
    Task<bool> InsertUserSkillsAsync(string userId, Skills skill);
    ...
    Task<bool> UpdateUserSkillsBreakthroughAsync(string userId, Skills skill, int star, double quantity);
