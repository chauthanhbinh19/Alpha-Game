...
public interface IUserEquipmentsService
{
    ...
    Task<bool> UpdateEquipmentsLevelAsync(Equipments equipment);
    Task<bool> UpdateEquipmentsStarAsync(Equipments equipment);
    ...
    Task<bool> EquipAllEquipmentsOfTypeToCardSoldierAsync(string cardSoldierId, string type);
    Task<bool> EquipAllEquipmentsToCardSoldierAsync(string cardSoldierId);
}