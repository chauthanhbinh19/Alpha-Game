...
public class UserCardCaptainsService : IUserCardCaptainsService
{
    ...
    {
        IUserCardCaptainsMasterRepository userCardCaptainsMasterRepository = new UserCardCaptainsMasterRepository();
        UserCardCaptainsMasterService userCardAdmiralsMasterService = new UserCardCaptainsMasterService(userCardCaptainsMasterRepository);
        foreach (var c in CardCaptainsList)
        {
            CardCaptains card = _userCardCaptainsRepository.GetUserCardCaptainsById(user_id, c.Id);
            Master master = userCardAdmiralsMasterService.GetSumCardCaptainsMaster(user_id, c.Id);
    ...
    public List<CardCaptains> GetAllSpiritBeastPower(string user_id, List<CardCaptains> cardCaptains)
    {
        ...
        {
            CardCaptains card = _userCardCaptainsRepository.GetUserCardCaptainsById(user_id, c.Id);
            SpiritBeasts spiritBeast = userSpiritBeastService.GetUserCardCaptainsSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
