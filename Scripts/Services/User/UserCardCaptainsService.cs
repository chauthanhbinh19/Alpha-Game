...
public class UserCardCaptainsService : IUserCardCaptainsService
{
    ...
    public List<CardCaptains> GetAllSpiritBeastPower(string user_id, List<CardCaptains> cardCaptains)
    {
        ...
        {
            CardCaptains card = _userCardCaptainsRepository.GetUserCardCaptainsById(user_id, c.id);
            SpiritBeast spiritBeast = userSpiritBeastService.GetUserCardCaptainsSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardCaptains GetNewLevelPower(CardCaptains c, double coefficient)
    {
        ...
        cardCaptains.power = EvaluatePower.CalculatePower(
            ...
            cardCaptains.speed,
            cardCaptains.critical_damage_rate, cardCaptains.critical_rate, cardCaptains.critical_resistance_rate, cardCaptains.ignore_critical_rate,
            cardCaptains.penetration_rate, cardCaptains.penetration_resistance_rate, cardCaptains.evasion_rate,
            cardCaptains.damage_absorption_rate, cardCaptains.ignore_damage_absorption_rate, cardCaptains.absorbed_damage_rate,
            cardCaptains.vitality_regeneration_rate, cardCaptains.vitality_regeneration_resistance_rate,
            ...
            cardCaptains.combo_rate, cardCaptains.ignore_combo_rate, cardCaptains.combo_damage_rate, cardCaptains.combo_resistance_rate,
            cardCaptains.stun_rate, cardCaptains.ignore_stun_rate,
            cardCaptains.reflection_rate, cardCaptains.ignore_reflection_rate, cardCaptains.reflection_damage_rate, cardCaptains.reflection_resistance_rate,
            ...
            cardCaptains.normal_damage_rate, cardCaptains.normal_resistance_rate,
            cardCaptains.skill_damage_rate, cardCaptains.skill_resistance_rate
        );
        return cardCaptains;
    }
