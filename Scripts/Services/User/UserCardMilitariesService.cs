...
public class UserCardMilitariesService : IUserCardMilitariesService
{
    ...
    public async Task<List<CardMilitaries>> GetScienceFictionPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetResearchPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetArchivePowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetUniversePowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHIINPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetSSWNPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHITNPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHIHNPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHIENPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHICAPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHIRNPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetHIDCPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<List<CardMilitaries>> GetAllAnimeStatsPowerAsync(string user_id, List<CardMilitaries> CardMilitaryList)
    {
    ...
    public async Task<CardMilitaries> GetNewLevelPowerAsync(CardMilitaries c, double coefficient)
    {
        ...
        CardMilitaries orginCard = await _service.GetCardMilitaryByIdAsync(c.Id);
    ...
    public async Task<CardMilitaries> GetNewBreakthroughPowerAsync(CardMilitaries c, double coefficient)
    {
        ICardMilitariesRepository _repository = new CardMilitariesRepository();
        CardMilitariesService _service = new CardMilitariesService(_repository);
        CardMilitaries orginCard = await _service.GetCardMilitaryByIdAsync(c.Id);
