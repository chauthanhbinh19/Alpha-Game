...
public class UserForgesService : IUserForgesService
{
    ...
    {
        List<Forges> list = await _userForgeRepository.GetUserForgesAsync(user_id, type, pageSize, offset, rare);
    ...
    {
        return await _userForgeRepository.GetUserForgesCountAsync(user_id, type, rare);
    }
