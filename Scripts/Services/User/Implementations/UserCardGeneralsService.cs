...
public class UserCardGeneralsService : IUserCardGeneralsService
{
    ...
    public UserCardGeneralsService(
        IUserCardGeneralsRepository userCardGeneralsRepository,
    ...
    public static IUserCardGeneralsService Create() => ServiceContainer.GetService<IUserCardGeneralsService>();

    public async Task<List<CardGenerals>> GetAllEquipmentPowerAsync(string userId, List<CardGenerals> CardGeneralsList)
    {
        foreach (var c in CardGeneralsList)
        {
            Equipments equipments = await UserEquipmentsService.Create().GetAllUserEquipmentsByCardGeneralIdAsync(userId, c.Id);
    ...
    public async Task<List<CardGenerals>> GetAllRankPowerAsync(string userId, List<CardGenerals> CardGeneralsList)
    {
        foreach (var c in CardGeneralsList)
        {
            UserRanks rank = await UserCardGeneralsRankService.Create().GetSumUserCardGeneralsRankAsync(userId, c.Id);
    ...
    public async Task<List<CardGenerals>> GetAllMasterPowerAsync(string userId, List<CardGenerals> CardGeneralsList)
    {
        foreach (var c in CardGeneralsList)
        {
            UserMasters master = await UserCardGeneralsMasterService.Create().GetSumUserCardGeneralsMasterAsync(userId, c.Id);
    ...
    {
        List<CardGenerals> result = await _userCardGeneralsRepository.GetUserCardGeneralsAsync(userId, search, type, pageSize, offset, rare);
        ...
        var equipments = await _userEquipmentsService.GetUserCardHeroesEquipmentsAsync(userId, cardGeneralIds, "All");
    ...
    public async Task<List<CardGenerals>> GetUserCardGeneralsTeamAsync(string userId, string teamId, string position, UserStatsContextDTO sharedContext = null)
    {
        List<CardGenerals> result = await _userCardGeneralsRepository.GetUserCardGeneralsTeamAsync(userId, teamId, position);
    ...
    public async Task<List<CardGenerals>> GetUserCardGeneralsTeamWithoutPositionAsync(string userId, string teamId, UserStatsContextDTO sharedContext = null)
    {
        List<CardGenerals> result = await _userCardGeneralsRepository.GetUserCardGeneralsTeamWithoutPositionAsync(userId, teamId);
    ...
    {
        return await _userCardGeneralsRepository.GetUserCardGeneralsInTeamSimpleAsync(userId, teamId);
    }
    ...
    public async Task<InsertOrUpdateResult<bool>> InsertOrUpdateUserCardGeneralAsync(string userId, CardGenerals cardGeneral)
    {
        var checkCardGeneralResult = await _cardGeneralsService.IsCardGeneralDeletedOrInactiveAsync(cardGeneral.Id);
        if (checkCardGeneralResult)
        {
        ...
        var insertOrUpdateResult = await _userCardGeneralsRepository.InsertOrUpdateUserCardGeneralAsync(userId, cardGeneral);
    ...
    {
        var repositoryResult = await _userCardGeneralsRepository.InsertOrUpdateUserCardGeneralsBatchAsync(userId, cardGenerales);
        ...
        {
            await _cardGeneralsGalleryService.InsertBatchCardGeneralsGalleryAsync(userId, newlyInsertedCards);
        }
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateUserCardGeneralLevelAsync(string userId, CardGenerals cardGeneral)
    {
        ...
        var updateResult = await _userCardGeneralsRepository.UpdateUserCardGeneralLevelAsync(userId, cardGeneral);
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateUserCardGeneralStarAsync(string userId, CardGenerals cardGeneral)
    {
        ...
        var updateResult = await _userCardGeneralsRepository.UpdateUserCardGeneralStarAsync(userId, cardGeneral);
    ...
    {
        CardGenerals cardGeneral = await _userCardGeneralsRepository.GetUserCardGeneralByIdAsync(userId, Id);
        if (cardGeneral == null) return null;

        // Bọc vào result để tái sử dụng logic
        List<CardGenerals> result = new List<CardGenerals> { cardGeneral };
    ...
    {
        var totalStats = await _userCardGeneralsRepository.GetTeamTotalStatsAsync(userId);
        var baseStats = await _userCardGeneralsRepository.GetTeamTotalStatsWithoutQualityAsync(userId);
