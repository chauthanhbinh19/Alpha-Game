...
public class UserCardSoldiersService : IUserCardSoldiersService
{
    ...
    public async Task<List<CardSoldiers>> GetUserCardSoldiersAsync(string userId, string search, string type, int pageSize, int offset, string rare, UserStatsContextDTO sharedContext = null)
    {
        ...
        var equipments = await _userEquipmentsService.GetUserCardHeroesEquipmentsAsync(userId, cardSoldierIds, "All");
    ...
    public async Task<List<CardSoldiers>> GetUserCardSoldiersInTeamAsync(string userId, UserStatsContextDTO sharedContext = null)
    {
        List<CardSoldiers> result = await _userCardSoldiersRepository.GetUserCardSoldiersInTeamAsync(userId);
    ...
    {
        return await _userCardSoldiersRepository.GetUserCardSoldiersInTeamSimpleAsync(userId, teamId);
    }
    ...
    {
        var checkCardSoldierResult = await _cardSoldiersService.IsCardSoldierDeletedOrInactiveAsync(cardSoldier.Id);
        if (checkCardSoldierResult)
        {
