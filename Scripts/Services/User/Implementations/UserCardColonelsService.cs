...
public class UserCardColonelsService : IUserCardColonelsService
{
    ...
    public async Task<List<CardColonels>> GetUserCardColonelsInTeamSimpleAsync(string userId)
    {
        return await _userCardColonelsRepository.GetUserCardColonelsInTeamSimpleAsync(userId);
    }
