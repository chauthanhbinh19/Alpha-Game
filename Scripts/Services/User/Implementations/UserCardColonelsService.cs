...
public class UserCardColonelsService : IUserCardColonelsService
{
    ...
    public static IUserCardColonelsService Create() => ServiceContainer.GetService<IUserCardColonelsService>();
    ...
    public async Task<List<CardColonels>> GetAllEquipmentPowerAsync(string userId, List<CardColonels> CardColonelsList)
    {
        ...
        {
            Equipments equipments = await UserEquipmentsService.Create().GetAllUserEquipmentsByCardColonelIdAsync(userId, c.Id);
    ...
    public async Task<List<CardColonels>> GetAllRankPowerAsync(string userId, List<CardColonels> CardColonelsList)
    {
        foreach (var c in CardColonelsList)
        {
            UserRanks rank = await UserCardColonelsRankService.Create().GetSumUserCardColonelsRankAsync(userId, c.Id);
    ...
    public async Task<List<CardColonels>> GetAllMasterPowerAsync(string userId, List<CardColonels> CardColonelsList)
    {
        foreach (var c in CardColonelsList)
        {
            UserMasters master = await UserCardColonelsMasterService.Create().GetSumUserCardColonelsMasterAsync(userId, c.Id);
    ...
    {
        List<CardColonels> result = await _userCardColonelsRepository.GetUserCardColonelsAsync(userId, search, type, pageSize, offset, rare);

        List<string> cardColonelIds = result.Select(hero => hero.Id).ToList();

        // var skillsTask = _userSkillsRepository.GetUserCardColonelsSkillsAsync(userId, cardColonelIds);
        ...
        var equipments = await _userEquipmentsService.GetUserCardHeroesEquipmentsAsync(userId, cardColonelIds, "All");
    ...
    {
        List<CardColonels> result = await _userCardColonelsRepository.GetUserCardColonelsTeamAsync(userId, teamId, position);
    ...
    {
        List<CardColonels> result = await _userCardColonelsRepository.GetUserCardColonelsTeamWithoutPositionAsync(userId, teamId);
    ...
    public async Task<List<CardColonels>> GetUserCardColonelsInTeamAsync(string userId, UserStatsContextDTO sharedContext = null)
    {
        List<CardColonels> result = await _userCardColonelsRepository.GetUserCardColonelsInTeamAsync(userId);
    ...
    public async Task<List<CardColonels>> GetUserCardColonelsInTeamSimpleAsync(string userId, string teamId)
    {
        return await _userCardColonelsRepository.GetUserCardColonelsInTeamSimpleAsync(userId, teamId);
    }
    ...
    public async Task<int> GetUserCardColonelsTeamsPositionCountAsync(string userId, string teamId, string position)
    {
        return await _userCardColonelsRepository.GetUserCardColonelsTeamsPositionCountAsync(userId, teamId, position);
    }

    public async Task<int> GetUserCardColonelsTeamsCountAsync(string userId, string teamId)
    {
        return await _userCardColonelsRepository.GetUserCardColonelsTeamsCountAsync(userId, teamId);
    }
    ...
    public async Task<InsertOrUpdateResult<bool>> InsertOrUpdateUserCardColonelAsync(string userId, CardColonels cardColonel)
    {
        ...
        await _cardColonelsGalleryService.InsertCardColonelGalleryAsync(userId, cardColonel.Id);

        return InsertOrUpdateResult<bool>.Inserted(true);
    }

    public async Task<InsertOrUpdateResult<bool>> InsertOrUpdateUserCardColonelsBatchAsync(string userId, List<CardColonels> cardColoneles)
    {
        var repositoryResult = await _userCardColonelsRepository.InsertOrUpdateUserCardColonelsBatchAsync(userId, cardColoneles);
        ...
        {
            await _cardColonelsGalleryService.InsertBatchCardColonelsGalleryAsync(userId, newlyInsertedCards);
        }
    ...
    public async Task<CardColonels> GetUserCardColonelByIdAsync(string userId, string Id, UserStatsContextDTO sharedContext = null)
    {
        ...
        List<CardColonels> result = new List<CardColonels> { cardColonel };
    ...
    {
        var totalStats = await _userCardColonelsRepository.GetTeamTotalStatsAsync(userId);
        var baseStats = await _userCardColonelsRepository.GetTeamTotalStatsWithoutQualityAsync(userId);
