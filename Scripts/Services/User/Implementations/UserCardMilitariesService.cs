...
public class UserCardMilitariesService : IUserCardMilitariesService
{
    ...
    public async Task<List<CardMilitaries>> GetAllRankPowerAsync(string userId, List<CardMilitaries> CardMilitaryList)
    {
        foreach (var c in CardMilitaryList)
        {
            UserRanks rank = await UserCardMilitariesRankService.Create().GetSumUserCardMilitariesRankAsync(userId, c.Id);
    ...
    public async Task<List<CardMilitaries>> GetAllMasterPowerAsync(string userId, List<CardMilitaries> CardMilitaryList)
    {
        foreach (var c in CardMilitaryList)
        {
            UserMasters master = await UserCardMilitariesMasterService.Create().GetSumUserCardMilitariesMasterAsync(userId, c.Id);
    ...
    {
        List<CardMilitaries> result = await _userCardMilitariesRepository.GetUserCardMilitariesAsync(userId, search, type, pageSize, offset, rare);

        List<string> cardMilitaryIds = result.Select(hero => hero.Id).ToList();
        ...
        var equipments = await _userEquipmentsService.GetUserCardHeroesEquipmentsAsync(userId, cardMilitaryIds, "All");
    ...
    {
        List<CardMilitaries> result = await _userCardMilitariesRepository.GetUserCardMilitariesTeamAsync(userId, teamId, position);
    ...
    {
        List<CardMilitaries> result = await _userCardMilitariesRepository.GetUserCardMilitariesTeamWithoutPositionAsync(userId, teamId);
    ...
    public async Task<List<CardMilitaries>> GetUserCardMilitariesInTeamAsync(string userId, UserStatsContextDTO sharedContext = null)
    {
        List<CardMilitaries> result = await _userCardMilitariesRepository.GetUserCardMilitariesInTeamAsync(userId);
    ...
    public async Task<CardMilitaries> GetUserCardMilitaryByIdAsync(string userId, string Id, UserStatsContextDTO sharedContext = null)
    {
        ...
        List<CardMilitaries> result = new List<CardMilitaries> { cardMilitary };
