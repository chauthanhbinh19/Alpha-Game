...
public class UserCardCaptainsService : IUserCardCaptainsService
{
    ...
    public async Task<List<CardCaptains>> GetAllEquipmentPowerAsync(string userId, List<CardCaptains> CardCaptainsList)
    {
        ...
        {
            Equipments equipments = await UserEquipmentsService.Create().GetAllUserEquipmentsByCardCaptainIdAsync(userId, c.Id);
    ...
    {
        return await _userCardCaptainsRepository.GetUserCardCaptainsTeamsPositionCountAsync(userId, teamId, position);
    }

    public async Task<int> GetUserCardCaptainsTeamsCountAsync(string userId, string teamId)
    {
        return await _userCardCaptainsRepository.GetUserCardCaptainsTeamsCountAsync(userId, teamId);
    }
