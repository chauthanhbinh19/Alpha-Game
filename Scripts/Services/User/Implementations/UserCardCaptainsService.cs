...
public class UserCardCaptainsService : IUserCardCaptainsService
{
    ...
    public static IUserCardCaptainsService Create() => ServiceContainer.GetService<IUserCardCaptainsService>();
    ...
    public async Task<List<CardCaptains>> GetAllRankPowerAsync(string userId, List<CardCaptains> CardCaptainsList)
    {
        foreach (var c in CardCaptainsList)
        {
            UserRanks rank = await UserCardCaptainsRankService.Create().GetSumUserCardCaptainsRankAsync(userId, c.Id);
    ...
    public async Task<List<CardCaptains>> GetAllMasterPowerAsync(string userId, List<CardCaptains> CardCaptainsList)
    {
        foreach (var c in CardCaptainsList)
        {
            UserMasters master = await UserCardCaptainsMasterService.Create().GetSumUserCardCaptainsMasterAsync(userId, c.Id);
    ...
    {
        List<CardCaptains> result = await _userCardCaptainsRepository.GetUserCardCaptainsAsync(userId, search, type, pageSize, offset, rare);

        List<string> cardCaptainIds = result.Select(hero => hero.Id).ToList();

        // var skillsTask = _userSkillsRepository.GetUserCardCaptainsSkillsAsync(userId, cardCaptainIds);
    ...
    {
        List<CardCaptains> result = await _userCardCaptainsRepository.GetUserCardCaptainsTeamAsync(userId, teamId, position);
    ...
    {
        List<CardCaptains> result = await _userCardCaptainsRepository.GetUserCardCaptainsTeamWithoutPositionAsync(userId, teamId);
    ...
    public async Task<List<CardCaptains>> GetUserCardCaptainsInTeamAsync(string userId, UserStatsContextDTO sharedContext = null)
    {
        List<CardCaptains> result = await _userCardCaptainsRepository.GetUserCardCaptainsInTeamAsync(userId);
    ...
    {
        var repositoryResult = await _userCardCaptainsRepository.InsertOrUpdateUserCardCaptainsBatchAsync(userId, cardCaptaines);
        ...
        {
            await _cardCaptainsGalleryService.InsertBatchCardCaptainsGalleryAsync(userId, newlyInsertedCards);
        }
    ...
    public async Task<CardCaptains> GetUserCardCaptainByIdAsync(string userId, string Id, UserStatsContextDTO sharedContext = null)
    {
        ...
        List<CardCaptains> result = new List<CardCaptains> { cardCaptain };
