...
public class UserSpiritCardsService : IUserSpiritCardsService
{
    ...
    {
        return await _userSpiritCardsRepository.GetUserCardHeroSpiritCardAsync(userId, cardHero);
    }

    public async Task<SpiritCards> GetUserCardCaptainSpiritCardAsync(string userId, CardCaptains cardCaptain)
    {
        return await _userSpiritCardsRepository.GetUserCardCaptainSpiritCardAsync(userId, cardCaptain);
    }

    public async Task<SpiritCards> GetUserCardColonelSpiritCardAsync(string userId, CardColonels cardColonel)
    {
        return await _userSpiritCardsRepository.GetUserCardColonelSpiritCardAsync(userId, cardColonel);
    }

    public async Task<SpiritCards> GetUserCardGeneralSpiritCardAsync(string userId, CardGenerals cardGeneral)
    {
        return await _userSpiritCardsRepository.GetUserCardGeneralSpiritCardAsync(userId, cardGeneral);
    }

    public async Task<SpiritCards> GetUserCardAdmiralSpiritCardAsync(string userId, CardAdmirals cardAdmiral)
    {
        return await _userSpiritCardsRepository.GetUserCardAdmiralSpiritCardAsync(userId, cardAdmiral);
    }
    ...
    {
        return await _userSpiritCardsRepository.GetUserCardMonsterSpiritCardAsync(userId, cardMonster);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardHeroSpiritCardAsync(userId, cardHero, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardCaptainSpiritCardAsync(userId, cardCaptain, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardColonelSpiritCardAsync(userId, cardColonel, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardGeneralSpiritCardAsync(userId, cardGeneral, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardAdmiralSpiritCardAsync(userId, cardAdmiral, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardMilitarySpiritCardAsync(userId, cardMilitary, spiritCard);
    }
    ...
    {
        return await _userSpiritCardsRepository.DeleteUserCardMonsterSpiritCardAsync(userId, cardMonster, spiritCard);
    }
    
    public async Task<bool> DeleteUserCardSpellSpiritCardAsync(string userId, CardSpells cardSpell, SpiritCards spiritCard)
    {
        return await _userSpiritCardsRepository.DeleteUserCardSpellSpiritCardAsync(userId, cardSpell, spiritCard);
    }
