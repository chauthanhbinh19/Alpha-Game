...
public class UserCardMonstersService : IUserCardMonstersService
{
    ...
    public async Task<List<CardMonsters>> GetUserCardMonstersInTeamSimpleAsync(string userId)
    {
        return await _userCardMonstersRepository.GetUserCardMonstersInTeamSimpleAsync(userId);
    }
