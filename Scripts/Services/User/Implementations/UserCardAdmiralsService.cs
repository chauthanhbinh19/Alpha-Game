...
public class UserCardAdmiralsService : IUserCardAdmiralsService
{
    ...
    {
        List<CardAdmirals> result = await _userCardAdmiralsRepository.GetUserCardAdmiralsAsync(userId, search, type, pageSize, offset, rare);

        List<string> cardAdmiralIds = result.Select(hero => hero.Id).ToList();
        ...
        var equipments = await _userEquipmentsService.GetUserCardHeroesEquipmentsAsync(userId, cardAdmiralIds, "All");
    ...
    {
        List<CardAdmirals> result = await _userCardAdmiralsRepository.GetUserCardAdmiralsTeamAsync(userId, teamId, position);
    ...
    {
        List<CardAdmirals> result = await _userCardAdmiralsRepository.GetUserCardAdmiralsTeamWithoutPositionAsync(userId, teamId);
    ...
    public async Task<List<CardAdmirals>> GetUserCardAdmiralsInTeamAsync(string userId, UserStatsContextDTO sharedContext = null)
    {
        List<CardAdmirals> result = await _userCardAdmiralsRepository.GetUserCardAdmiralsInTeamAsync(userId);
    ...
    {
        return await _userCardAdmiralsRepository.GetUserCardAdmiralsInTeamSimpleAsync(userId, teamId);
    }
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateTeamUserCardAdmiralAsync(string userId, string teamId, string position, string cardId)
    {
        await _userCardAdmiralsRepository.UpdateTeamUserCardAdmiralAsync(userId, teamId, position, cardId);
    ...
    {
        var checkCardAdmiralResult = await _cardAdmiralsService.IsCardAdmiralDeletedOrInactiveAsync(cardAdmiral.Id);
        if (checkCardAdmiralResult)
        {
    ...
    public async Task<CardAdmirals> GetUserCardAdmiralByIdAsync(string userId, string Id, UserStatsContextDTO sharedContext = null)
    {
        ...
        List<CardAdmirals> result = new List<CardAdmirals> { cardAdmiral };
