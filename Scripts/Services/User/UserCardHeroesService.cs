...
public class UserCardHeroesService : IUserCardHeroesService
{
    ...
    public CardHeroes GetNewLevelPower(CardHeroes c, double coefficient)
    {
        ...
        cardHeroes.power = EvaluatePower.CalculatePower(
            ...
            cardHeroes.speed,
            cardHeroes.critical_damage_rate, cardHeroes.critical_rate, cardHeroes.critical_resistance_rate, cardHeroes.ignore_critical_rate,
            cardHeroes.penetration_rate, cardHeroes.penetration_resistance_rate, cardHeroes.evasion_rate,
            cardHeroes.damage_absorption_rate, cardHeroes.ignore_damage_absorption_rate, cardHeroes.absorbed_damage_rate,
            cardHeroes.vitality_regeneration_rate, cardHeroes.vitality_regeneration_resistance_rate,
            ...
            cardHeroes.combo_rate, cardHeroes.ignore_combo_rate, cardHeroes.combo_damage_rate, cardHeroes.combo_resistance_rate,
            cardHeroes.stun_rate, cardHeroes.ignore_stun_rate,
            cardHeroes.reflection_rate, cardHeroes.ignore_reflection_rate, cardHeroes.reflection_damage_rate, cardHeroes.reflection_resistance_rate,
            ...
            cardHeroes.normal_damage_rate, cardHeroes.normal_resistance_rate,
            cardHeroes.skill_damage_rate, cardHeroes.skill_resistance_rate
        );
        return cardHeroes;
    }
