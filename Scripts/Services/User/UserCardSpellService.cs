...
public class UserCardSpellService : IUserCardSpellService
{
    ...
    public List<CardSpells> GetFinalPower(string user_id, List<CardSpells> CardSpellList)
    {
        ...
        {
            CardSpells card = _userCardSpellRepository.GetUserCardSpellById(user_id, c.Id);
    ...
    public List<CardSpells> GetScienceFictionPower(string user_id, List<CardSpells> CardSpellList)
    {
    ...
    public List<CardSpells> GetAllEquipmentPower(string user_id, List<CardSpells> CardSpellList)
    {
    ...
    public List<CardSpells> GetAllRankPower(string user_id, List<CardSpells> CardSpellList)
    {
    ...
    public List<CardSpells> GetAllMasterPower(string user_id, List<CardSpells> CardSpellList)
    {
    ...
    public List<CardSpells> GetAllAnimeStatsPower(string user_id, List<CardSpells> CardSpellList)
    {
    ...
    public List<CardSpells> GetAllSpiritBeastPower(string user_id, List<CardSpells> cardSpells)
    {
        ...
        {
            CardSpells card = _userCardSpellRepository.GetUserCardSpellById(user_id, c.Id);
            SpiritBeasts spiritBeast = userSpiritBeastService.GetUserCardSpellSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardSpells GetNewLevelPower(CardSpells c, double coefficient)
    {
        ICardSpellRepository _repository = new CardSpellRepository();
        CardSpellService _service = new CardSpellService(_repository);
        CardSpells orginCard = _service.GetCardSpellById(c.Id);
    ...
    public CardSpells GetNewBreakthroughPower(CardSpells c, double coefficient)
    {
        ICardSpellRepository _repository = new CardSpellRepository();
        CardSpellService _service = new CardSpellService(_repository);
        CardSpells orginCard = _service.GetCardSpellById(c.Id);
    ...
    {
        List<CardSpells> list = _userCardSpellRepository.GetUserCardSpellTeam(user_id, teamId, position);
        list = GetAllSpiritBeastPower(user_id, list);
        list = QualityEvaluator.GetQualityPower(list);
        list = GetFinalPower(user_id, list);
        list = GetAllEquipmentPower(user_id, list);
    ...
    {
        CardSpells cardSpell = _userCardSpellRepository.GetUserCardSpellById(user_id, Id);
    ...
    {
        List<CardSpells> list = _userCardSpellRepository.GetAllUserCardSpellInTeam(user_id);
        list = QualityEvaluator.GetQualityPower(list);
        list = GetFinalPower(user_id, list);
        list = GetAllEquipmentPower(user_id, list);
        list = GetAllRankPower(user_id, list);
