...
{
    List<CardMilitary> GetFinalPower(string user_id, List<CardMilitary> CardMilitaryList);
    List<CardMilitary> GetAllEquipmentPower(string user_id, List<CardMilitary> CardMilitaryList);
    List<CardMilitary> GetAllRankPower(string user_id, List<CardMilitary> CardMilitaryList);
    List<CardMilitary> GetAllAnimeStatsPower(string user_id, List<CardMilitary> CardMilitaryList);
    CardMilitary GetNewLevelPower(CardMilitary c, double coefficient);
    CardMilitary GetNewBreakthroughPower(CardMilitary c, double coefficient);
