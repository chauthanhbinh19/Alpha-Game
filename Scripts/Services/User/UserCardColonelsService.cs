...
public class UserCardColonelsService : IUseCardColonelsService
{
    ...
    public List<CardColonels> GetAllSpiritBeastPower(string user_id, List<CardColonels> cardColonels)
    {
        ...
        {
            CardColonels card = _userCardColonelsRepository.GetUserCardColonelsById(user_id, c.id);
            SpiritBeast spiritBeast = userSpiritBeastService.GetUserCardColonelsSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardColonels GetNewLevelPower(CardColonels c, double coefficient)
    {
        ...
        cardColonels.power = EvaluatePower.CalculatePower(
            ...
            cardColonels.speed,
            cardColonels.critical_damage_rate, cardColonels.critical_rate, cardColonels.critical_resistance_rate, cardColonels.ignore_critical_rate,
            cardColonels.penetration_rate, cardColonels.penetration_resistance_rate, cardColonels.evasion_rate,
            cardColonels.damage_absorption_rate, cardColonels.ignore_damage_absorption_rate, cardColonels.absorbed_damage_rate,
            cardColonels.vitality_regeneration_rate, cardColonels.vitality_regeneration_resistance_rate,
            ...
            cardColonels.combo_rate, cardColonels.ignore_combo_rate, cardColonels.combo_damage_rate, cardColonels.combo_resistance_rate,
            cardColonels.stun_rate, cardColonels.ignore_stun_rate,
            cardColonels.reflection_rate, cardColonels.ignore_reflection_rate, cardColonels.reflection_damage_rate, cardColonels.reflection_resistance_rate,
            ...
            cardColonels.normal_damage_rate, cardColonels.normal_resistance_rate,
            cardColonels.skill_damage_rate, cardColonels.skill_resistance_rate
        );
        return cardColonels;
    }
    ...
    {
        return _userCardColonelsRepository.InsertFactCardColonels(cardColonels);
    }

    public bool UpdateFactCardColonels(CardColonels cardColonels)
    {
        return _userCardColonelsRepository.UpdateFactCardColonels(cardColonels);
    }

    public bool UpdateTeamFactCardColonels(string team_id, string position, string card_id)
    {
        return _userCardColonelsRepository.UpdateTeamFactCardColonels(team_id, position, card_id);
    }
