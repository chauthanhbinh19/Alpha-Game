...
public class UserCardMonstersService : IUserCardMonstersService
{
    ...
    public async Task<List<CardMonsters>> GetResearchPowerAsync(string user_id, List<CardMonsters> CardMonstersList)
    {
    ...
    public async Task<List<CardMonsters>> GetArchivePowerAsync(string user_id, List<CardMonsters> CardMonstersList)
    {
    ...
    public async Task<List<CardMonsters>> GetUniversePowerAsync(string user_id, List<CardMonsters> CardMonstersList)
    {
    ...
    public async Task<List<CardMonsters>> GetHIINPowerAsync(string user_id, List<CardMonsters> CardMonstersList)
    {
    ...
    public async Task<List<CardMonsters>> GetHIDCPowerAsync(string user_id, List<CardMonsters> CardMonstersList)
    {
