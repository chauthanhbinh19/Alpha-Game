...
public class UserCardMonstersService : IUserCardMonstersService
{
    ...
    public List<CardMonsters> GetAllSpiritBeastPower(string user_id, List<CardMonsters> cardMonsters)
    {
        ...
        {
            CardMonsters card = _userCardMonstersRepository.GetUserCardMonstersById(user_id, c.id);
            SpiritBeast spiritBeast = userSpiritBeastService.GetUserCardMonstersSpiritBeast(user_id, c);
            if (spiritBeast != null)
            {
    ...
    public CardMonsters GetNewLevelPower(CardMonsters c, double coefficient)
    {
        ...
        cardMonsters.power = EvaluatePower.CalculatePower(
            ...
            cardMonsters.speed,
            cardMonsters.critical_damage_rate, cardMonsters.critical_rate, cardMonsters.critical_resistance_rate, cardMonsters.ignore_critical_rate,
            cardMonsters.penetration_rate, cardMonsters.penetration_resistance_rate, cardMonsters.evasion_rate,
            cardMonsters.damage_absorption_rate, cardMonsters.ignore_damage_absorption_rate, cardMonsters.absorbed_damage_rate,
            cardMonsters.vitality_regeneration_rate, cardMonsters.vitality_regeneration_resistance_rate,
            ...
            cardMonsters.combo_rate, cardMonsters.ignore_combo_rate, cardMonsters.combo_damage_rate, cardMonsters.combo_resistance_rate,
            cardMonsters.stun_rate, cardMonsters.ignore_stun_rate,
            cardMonsters.reflection_rate, cardMonsters.ignore_reflection_rate, cardMonsters.reflection_damage_rate, cardMonsters.reflection_resistance_rate,
            ...
            cardMonsters.normal_damage_rate, cardMonsters.normal_resistance_rate,
            cardMonsters.skill_damage_rate, cardMonsters.skill_resistance_rate
        );
        return cardMonsters;
    }
