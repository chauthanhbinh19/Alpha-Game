...
{
    public static ModuleIntegrationManager Instance { get; private set; }
    ...
    public async Task CreateModuleIntegrationManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_INTEGRATION, stat))
                .Values
                .FirstOrDefault();
