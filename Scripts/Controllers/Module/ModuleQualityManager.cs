...
public class ModuleQualityManager : MonoBehaviour
{
    public static ModuleQualityManager Instance { get; private set; }
    ...
    public async Task CreateModuleQualityManagerAsync()
    {
