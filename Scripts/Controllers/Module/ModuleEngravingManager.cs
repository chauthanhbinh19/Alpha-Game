...
public class ModuleEngravingManager : MonoBehaviour
{
    public static ModuleEngravingManager Instance { get; private set; }
    ...
    public async Task CreateModuleEngravingManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_ENGRAVING, stat))
                .Values
                .FirstOrDefault();
