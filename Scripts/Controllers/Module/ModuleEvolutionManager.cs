...
public class ModuleEvolutionManager : MonoBehaviour
{
    public static ModuleEvolutionManager Instance { get; private set; }
    ...
    public async Task CreateModuleEvolutionManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_EVOLUTION, stat))
                .Values
                .FirstOrDefault();
