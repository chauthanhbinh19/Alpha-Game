...
public class ModuleElementManager : MonoBehaviour
{
    public static ModuleElementManager Instance { get; private set; }
    ...
    public async Task CreateModuleElementManagerAsync()
    {
