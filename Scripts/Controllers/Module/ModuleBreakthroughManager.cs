...
public class ModuleBreakthroughManager : MonoBehaviour
{
    public static ModuleBreakthroughManager Instance { get; private set; }
    ...
    public async Task CreateModuleBreakthroughManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_BREAKTHROUGH, stat))
                .Values
                .FirstOrDefault();
