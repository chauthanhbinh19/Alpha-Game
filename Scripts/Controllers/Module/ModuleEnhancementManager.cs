...
public class ModuleEnhancementManager : MonoBehaviour
{
    public static ModuleEnhancementManager Instance { get; private set; }
    ...
    public async Task CreateModuleEnhancementManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_ENHANCEMENT, stat))
                .Values
                .FirstOrDefault();
