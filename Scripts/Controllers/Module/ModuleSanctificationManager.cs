...
public class ModuleSanctificationManager : MonoBehaviour
{
    public static ModuleSanctificationManager Instance { get; private set; }
    ...
    public async Task CreateModuleSanctificationManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_SANCTIFICATION, stat))
                .Values
                .FirstOrDefault();
