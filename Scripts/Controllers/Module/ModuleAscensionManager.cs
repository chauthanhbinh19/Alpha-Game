...
public class ModuleAscensionManager : MonoBehaviour
{
    public static ModuleAscensionManager Instance { get; private set; }
    ...
    public async Task CreateModuleAscensionManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_ASCENSION, stat))
                .Values
                .FirstOrDefault();
