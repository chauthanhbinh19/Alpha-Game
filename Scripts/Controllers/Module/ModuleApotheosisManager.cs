...
public class ModuleApotheosisManager : MonoBehaviour
{
    public static ModuleApotheosisManager Instance { get; private set; }
    ...
    public async Task CreateModuleApotheosisManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_APOTHEOSIS, stat))
                .Values
                .FirstOrDefault();
