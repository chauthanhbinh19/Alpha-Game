...
public class ModuleSynchronizationManager : MonoBehaviour
{
    public static ModuleSynchronizationManager Instance { get; private set; }
    ...
    public async Task CreateModuleSynchronizationManagerAsync(IStats stat)
    {
        FeatureModuleDTO = (await FeaturesService.Create().GetModuleFeaturesByTypeAsync(AppConstants.Module.MODULE_SYNCHRONIZATION, stat))
                .Values
                .FirstOrDefault();
