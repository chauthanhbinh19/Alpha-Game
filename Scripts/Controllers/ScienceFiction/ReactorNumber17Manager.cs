...
public class ReactorNumber17Manager : MonoBehaviour
{
    ...
    public static ReactorNumber17Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public async Task CreateReactorPanelAsync()
    {
        ...
        ReactorNumberText.text = "17";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_17);
        ...
        ScienceFiction scienceFiction = await ScienceFictionService.Create().GetScienceFictionAsync(AppConstants.ScienceFiction.REACTOR_NUMBER_17);
