...
public class ReactorNumber11Manager : MonoBehaviour
{
    ...
    private int maxLevel;    public static ReactorNumber11Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public void CreateReactorPanel()
    {
        ...
        ReactorNumberText.text = "11";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_11);
        ...
        ScienceFiction scienceFiction = ScienceFictionService.Create().GetScienceFiction(AppConstants.ScienceFiction.REACTOR_NUMBER_11);
