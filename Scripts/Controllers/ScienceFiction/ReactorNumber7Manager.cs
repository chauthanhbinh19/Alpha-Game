...
public class ReactorNumber7Manager : MonoBehaviour
{
    ...
    public void CreateReactorPanel()
    {
        ...
        ScienceFiction scienceFiction = ScienceFictionService.Create().GetScienceFiction(AppConstants.ScienceFiction.REACTOR_NUMBER_7);
        ...
        UpLevelButton.onClick.AddListener(() =>
        {
            ...
            if (hasAllMaterials)
            {
                ...
                ScienceFictionService.Create().InsertOrUpdateScienceFiction(User.CurrentUserId, newScienceFiction, AppConstants.ScienceFiction.REACTOR_NUMBER_7);
