...
public class ReactorNumber7Manager : MonoBehaviour
{
    ...
    public static ReactorNumber7Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public async Task CreateReactorPanelAsync()
    {
        ...
        ReactorNumberText.text = "07";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_7);
        ...
        ScienceFiction scienceFiction = await ScienceFictionService.Create().GetScienceFictionAsync(AppConstants.ScienceFiction.REACTOR_NUMBER_7);
        ...
        UpLevelButton.onClick.AddListener(async () =>
        {
            ...
            if (hasAllMaterials)
            {
                ...
                await ScienceFictionService.Create().InsertOrUpdateScienceFictionAsync(User.CurrentUserId, newScienceFiction, AppConstants.ScienceFiction.REACTOR_NUMBER_7);
