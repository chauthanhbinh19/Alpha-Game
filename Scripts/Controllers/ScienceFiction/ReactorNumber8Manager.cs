...
public class ReactorNumber8Manager : MonoBehaviour
{
    ...
    public static ReactorNumber8Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public async Task CreateReactorPanelAsync()
    {
        ...
        ReactorNumberText.text = "08";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_8);
        ...
        var feature = (await FeaturesService.Create()
            ...
            .GetValueOrDefault(AppConstants.ScienceFiction.REACTOR_NUMBER_8);
