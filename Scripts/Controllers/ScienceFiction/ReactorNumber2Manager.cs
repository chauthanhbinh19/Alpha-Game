...
public class ReactorNumber2Manager : MonoBehaviour
{
    ...
    public void CreateReactorPanel()
    {
        ...
        ScienceFiction scienceFiction = ScienceFictionService.Create().GetScienceFiction(AppConstants.ScienceFiction.REACTOR_NUMBER_2);
        ...
        UpLevelButton.onClick.AddListener(() =>
        {
            ...
            if (hasAllMaterials)
            {
                ...
                ScienceFictionService.Create().InsertOrUpdateScienceFiction(User.CurrentUserId, newScienceFiction, AppConstants.ScienceFiction.REACTOR_NUMBER_2);
