...
public class ScienceFictionXIManager : MonoBehaviour
{
    public static ScienceFictionXIManager Instance { get; private set; }
    ...
    public async Task CreateScienceFictionXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetScienceFictionFeaturesByTypeAsync(AppConstants.ScienceFiction.SCIENCE_FICTION_XI);
