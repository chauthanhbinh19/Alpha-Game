...
public class ReactorNumber6Manager : MonoBehaviour
{
    ...
    public static ReactorNumber6Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public async Task CreateReactorPanelAsync()
    {
        ...
        ReactorNumberText.text = "06";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_6);
        ...
        ScienceFiction scienceFiction = await ScienceFictionService.Create().GetScienceFictionAsync(AppConstants.ScienceFiction.REACTOR_NUMBER_6);
        ...
        UpLevelButton.onClick.AddListener(async () =>
        {
            ...
            if (hasAllMaterials)
            {
                ...
                await ScienceFictionService.Create().InsertOrUpdateScienceFictionAsync(User.CurrentUserId, newScienceFiction, AppConstants.ScienceFiction.REACTOR_NUMBER_6);
