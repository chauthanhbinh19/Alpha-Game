...
public class ReactorNumber3Manager : MonoBehaviour
{
    ...
    public void CreateReactorPanel()
    {
        ...
        ScienceFiction scienceFiction = ScienceFictionService.Create().GetScienceFiction(AppConstants.ScienceFiction.REACTOR_NUMBER_3);
        ...
        UpLevelButton.onClick.AddListener(async () =>
        {
            ...
            if (hasAllMaterials)
            {
                ...
                ScienceFictionService.Create().InsertOrUpdateScienceFiction(User.CurrentUserId, newScienceFiction, AppConstants.ScienceFiction.REACTOR_NUMBER_3);
