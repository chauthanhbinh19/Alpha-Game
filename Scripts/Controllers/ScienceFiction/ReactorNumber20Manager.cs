...
public class ReactorNumber20Manager : MonoBehaviour
{
    ...
    public static ReactorNumber20Manager Instance { get; private set; }
    private void Awake()
    {
    ...
    public async Task CreateReactorPanelAsync()
    {
        ...
        ReactorNumberText.text = "20";
        titleText.text = LocalizationManager.Get(AppDisplayConstants.ScienceFiction.REACTOR_NUMBER_20);
        ...
        ScienceFiction scienceFiction = await ScienceFictionService.Create().GetScienceFictionAsync(AppConstants.ScienceFiction.REACTOR_NUMBER_20);
