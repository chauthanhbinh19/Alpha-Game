...
public class UpgradeEvolutionManager : MonoBehaviour
{
    public static UpgradeEvolutionManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeEvolutionManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_EVOLUTION, stat))
                .Values
                .FirstOrDefault();
