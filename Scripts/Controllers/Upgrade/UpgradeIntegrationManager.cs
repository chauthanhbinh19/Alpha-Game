...
public class UpgradeIntegrationManager : MonoBehaviour
{
    public static UpgradeIntegrationManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeIntegrationManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_INTEGRATION, stat))
                .Values
                .FirstOrDefault();
