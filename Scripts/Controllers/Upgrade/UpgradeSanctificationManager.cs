...
public class UpgradeSanctificationManager : MonoBehaviour
{
    public static UpgradeSanctificationManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeSanctificationManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_SANCTIFICATION, stat))
                .Values
                .FirstOrDefault();
