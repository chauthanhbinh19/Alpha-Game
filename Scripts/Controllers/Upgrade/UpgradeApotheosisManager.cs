...
public class UpgradeApotheosisManager : MonoBehaviour
{
    public static UpgradeApotheosisManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeApotheosisManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_APOTHEOSIS, stat))
                .Values
                .FirstOrDefault();
