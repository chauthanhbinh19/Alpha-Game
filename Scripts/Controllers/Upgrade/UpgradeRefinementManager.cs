...
public class UpgradeRefinementManager : MonoBehaviour
{
    public static UpgradeRefinementManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeRefinementManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_REFINEMENT, stat))
                .Values
                .FirstOrDefault();
