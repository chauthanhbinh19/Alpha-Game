...
public class UpgradeEnhancementManager : MonoBehaviour
{
    public static UpgradeEnhancementManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeEnhancementManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_ENHANCEMENT, stat))
                .Values
                .FirstOrDefault();
