...
public class UpgradeSynchronizationManager : MonoBehaviour
{
    public static UpgradeSynchronizationManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeSynchronizationManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_SYNCHRONIZATION, stat))
                .Values
                .FirstOrDefault();
