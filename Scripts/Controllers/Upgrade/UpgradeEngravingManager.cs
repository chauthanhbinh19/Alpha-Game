...
public class UpgradeEngravingManager : MonoBehaviour
{
    public static UpgradeEngravingManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeEngravingManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_ENGRAVING, stat))
                .Values
                .FirstOrDefault();
