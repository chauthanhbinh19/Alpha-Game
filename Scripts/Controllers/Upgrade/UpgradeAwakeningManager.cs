...
public class UpgradeAwakeningManager : MonoBehaviour
{
    public static UpgradeAwakeningManager Instance { get; private set; }
    ...
    public async Task CreateUpgradeAwakeningManagerAsync(IStats stat)
    {
        FeatureUpgradeDTO = (await FeaturesService.Create().GetUpgradeFeaturesByTypeAsync(AppConstants.Upgrade.UPGRADE_AWAKENING, stat))
                .Values
                .FirstOrDefault();
