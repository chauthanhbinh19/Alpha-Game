...
public class HICAXIIIManager : MonoBehaviour
{
    public static HICAXIIIManager Instance { get; private set; }
    ...
    public async Task CreateHICAXIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHICAFeaturesByTypeAsync(AppConstants.HICA.HICA_XIII);
    ...
    public async Task CreateMainHICAPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HICA.HICA_XIII}");
