...
public class HICAIIManager : MonoBehaviour
{
    public static HICAIIManager Instance { get; private set; }
    ...
    public async Task CreateHICAIIManagerAsync()
    {
    ...
    public async Task CreateMainHICAPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HICA.HICA_II}");
        rankImage.texture = rankTexture;
        RawImage background = transform.Find("Background").GetComponent<RawImage>();
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.HICA.HICA_II_BACKGROUND_URL);
