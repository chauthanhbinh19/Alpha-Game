...
public class HICAXIIManager : MonoBehaviour
{
    public static HICAXIIManager Instance { get; private set; }
    ...
    public async Task CreateHICAXIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHICAFeaturesByTypeAsync(AppConstants.HICA.HICA_XII);
    ...
    public async Task CreateMainHICAPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HICA.HICA_XII}");
