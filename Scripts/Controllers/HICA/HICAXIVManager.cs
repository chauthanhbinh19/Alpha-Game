...
public class HICAXIVManager : MonoBehaviour
{
    public static HICAXIVManager Instance { get; private set; }
    ...
    public async Task CreateHICAXIVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHICAFeaturesByTypeAsync(AppConstants.HICA.HICA_XIV);
    ...
    public async Task CreateMainHICAPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HICA.HICA_XIV}");
