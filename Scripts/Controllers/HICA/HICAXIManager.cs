...
public class HICAXIManager : MonoBehaviour
{
    public static HICAXIManager Instance { get; private set; }
    ...
    public async Task CreateHICAXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHICAFeaturesByTypeAsync(AppConstants.HICA.HICA_XI);
    ...
    public async Task CreateMainHICAPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HICA.HICA_XI}");
