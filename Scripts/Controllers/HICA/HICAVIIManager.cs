...
public class HICAVIIManager : MonoBehaviour
{
    public static HICAVIIManager Instance { get; private set; }
    ...
    public async Task CreateHICAVIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHICAFeaturesByTypeAsync(AppConstants.HICA.HICA_VII);
