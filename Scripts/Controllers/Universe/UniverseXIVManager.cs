...
public class UniverseXIVManager : MonoBehaviour
{
    public static UniverseXIVManager Instance { get; private set; }
    ...
    public async Task CreateUniverseXIVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetUniverseFeaturesByTypeAsync(AppConstants.Universe.UNIVERSE_XIV);
