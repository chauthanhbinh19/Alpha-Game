...
public class UniverseXIIIManager : MonoBehaviour
{
    public static UniverseXIIIManager Instance { get; private set; }
    ...
    public async Task CreateUniverseXIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetUniverseFeaturesByTypeAsync(AppConstants.Universe.UNIVERSE_XIII);
