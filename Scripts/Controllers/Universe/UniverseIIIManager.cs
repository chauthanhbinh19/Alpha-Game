...
public class UniverseIIIManager : MonoBehaviour
{
    public static UniverseIIIManager Instance { get; private set; }
    ...
    public async Task CreateUniverseIIIManagerAsync()
    {
    ...
    public async Task CreateMainUniversePanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.Universe.UNIVERSE_III}");
