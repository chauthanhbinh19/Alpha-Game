...
public class UniverseXManager : MonoBehaviour
{
    public static UniverseXManager Instance { get; private set; }
    ...
    public async Task CreateUniverseXManagerAsync()
    {
    ...
    public async Task CreateMainUniversePanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Universe.UNIVERSE_X_BACKGROUND_URL);
