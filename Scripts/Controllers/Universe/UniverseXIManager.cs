...
public class UniverseXIManager : MonoBehaviour
{
    public static UniverseXIManager Instance { get; private set; }
    ...
    public async Task CreateUniverseXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetUniverseFeaturesByTypeAsync(AppConstants.Universe.UNIVERSE_XI);
