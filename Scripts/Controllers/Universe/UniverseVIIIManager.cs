...
public class UniverseVIIIManager : MonoBehaviour
{
    public static UniverseVIIIManager Instance { get; private set; }
    ...
    public async Task CreateUniverseVIIIManagerAsync()
    {
