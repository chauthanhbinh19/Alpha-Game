...
public class MainMenuCognitumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuCognitumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuCognitumPanelPrefab = UIManager.Instance.Get("MainMenuCognitumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("CognitumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuCognitumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuCognitumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.COGNITUM);
        parentType = AppConstants.MainMenuSet7.COGNITUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.COGNITUM);
