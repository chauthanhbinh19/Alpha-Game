...
public class MainMenuParadoxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuParadoxPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuParadoxPanelPrefab = UIManager.Instance.Get("MainMenuParadoxPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ParadoxSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuParadoxManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuParadoxPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.PARADOX);
        parentType = AppConstants.MainMenuSet7.PARADOX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.PARADOX);
