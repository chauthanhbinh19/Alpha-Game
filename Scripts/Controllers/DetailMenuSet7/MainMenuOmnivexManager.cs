...
public class MainMenuOmnivexManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOmnivexPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuOmnivexPanelPrefab = UIManager.Instance.Get("MainMenuOmnivexPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OmnivexSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOmnivexManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuOmnivexPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.OMNIVEX);
        parentType = AppConstants.MainMenuSet7.OMNIVEX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.OMNIVEX);
