...
public class MainMenuMorvaneManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuMorvanePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuMorvanePanelPrefab = UIManager.Instance.Get("MainMenuMorvanePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("MorvaneSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuMorvaneManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuMorvanePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.MORVANE);
        parentType = AppConstants.MainMenuSet7.MORVANE;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.MORVANE);
