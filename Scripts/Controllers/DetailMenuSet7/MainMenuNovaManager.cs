...
public class MainMenuNovaManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNovaPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuNovaPanelPrefab = UIManager.Instance.Get("MainMenuNovaPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("NovaSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuNovaManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNovaPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.NOVA);
        parentType = AppConstants.MainMenuSet7.NOVA;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.NOVA);
