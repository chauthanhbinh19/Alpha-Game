...
public class MainMenuLuminaryManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuLuminaryPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuLuminaryPanelPrefab = UIManager.Instance.Get("MainMenuLuminaryPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("LuminarySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuLuminaryManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuLuminaryPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.LUMINARY);
        parentType = AppConstants.MainMenuSet7.LUMINARY;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.LUMINARY);
