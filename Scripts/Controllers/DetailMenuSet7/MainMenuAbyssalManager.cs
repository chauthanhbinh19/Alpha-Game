...
public class MainMenuAbyssalManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAbyssalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAbyssalPanelPrefab = UIManager.Instance.Get("MainMenuAbyssalPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AbyssalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAbyssalManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAbyssalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.ABYSSAL);
        parentType = AppConstants.MainMenuSet7.ABYSSAL;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.ABYSSAL);
