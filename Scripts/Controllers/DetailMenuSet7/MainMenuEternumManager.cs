...
public class MainMenuEternumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuEternumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuEternumPanelPrefab = UIManager.Instance.Get("MainMenuEternumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("EternumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuEternumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuEternumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.ETERNUM);
        parentType = AppConstants.MainMenuSet7.ETERNUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.ETERNUM);
