...
public class MainMenuFerrumaxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuFerrumaxPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuFerrumaxPanelPrefab = UIManager.Instance.Get("MainMenuFerrumaxPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("FerrumaxSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuFerrumaxManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuFerrumaxPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.FERRUMAX);
        parentType = AppConstants.MainMenuSet7.FERRUMAX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.FERRUMAX);
