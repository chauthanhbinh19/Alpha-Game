...
public class MainMenuCosmosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuCosmosPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuCosmosPanelPrefab = UIManager.Instance.Get("MainMenuCosmosPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("CosmosSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuCosmosManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuCosmosPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.COSMOS);
        parentType = AppConstants.MainMenuSet7.COSMOS;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.COSMOS);
