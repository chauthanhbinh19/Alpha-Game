...
{
    public static MainMenuNeoterraManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuNeoterraManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet7.NEOTERRA, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet7.NEOTERRA);
