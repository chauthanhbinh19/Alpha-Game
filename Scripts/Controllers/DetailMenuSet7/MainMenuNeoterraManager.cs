...
public class MainMenuNeoterraManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNeoterraPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuNeoterraPanelPrefab = UIManager.Instance.Get("MainMenuNeoterraPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("NeoterraSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuNeoterraManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNeoterraPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.NEOTERRA);
        parentType = AppConstants.MainMenuSet7.NEOTERRA;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.NEOTERRA);
