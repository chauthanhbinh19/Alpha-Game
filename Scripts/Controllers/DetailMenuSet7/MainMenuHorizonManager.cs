...
public class MainMenuHorizonManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHorizonPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuHorizonPanelPrefab = UIManager.Instance.Get("MainMenuHorizonPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("HorizonSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuHorizonManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuHorizonPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.HORIZON);
        parentType = AppConstants.MainMenuSet7.HORIZON;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.HORIZON);
