...
public class MainMenuNexariumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNexariumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuNexariumPanelPrefab = UIManager.Instance.Get("MainMenuNexariumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("NexariumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuNexariumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNexariumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.NEXARIUM);
        parentType = AppConstants.MainMenuSet7.NEXARIUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.NEXARIUM);
