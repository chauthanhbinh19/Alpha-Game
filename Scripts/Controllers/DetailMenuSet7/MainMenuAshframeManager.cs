...
public class MainMenuAshframeManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAshframePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAshframePanelPrefab = UIManager.Instance.Get("MainMenuAshframePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AshframeSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAshframeManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAshframePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.ASHFRAME);
        parentType = AppConstants.MainMenuSet7.ASHFRAME;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.ASHFRAME);
