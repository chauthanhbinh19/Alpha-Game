...
public class MainMenuAxiomataManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAxiomataPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAxiomataPanelPrefab = UIManager.Instance.Get("MainMenuAxiomataPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AxiomataSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAxiomataManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAxiomataPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.AXIOMATA);
        parentType = AppConstants.MainMenuSet7.AXIOMATA;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.AXIOMATA);
