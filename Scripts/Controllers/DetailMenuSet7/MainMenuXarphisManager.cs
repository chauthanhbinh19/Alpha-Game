...
public class MainMenuXarphisManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuXarphisPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuXarphisPanelPrefab = UIManager.Instance.Get("MainMenuXarphisPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("XarphisSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuXarphisManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuXarphisPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.XARPHIS);
        parentType = AppConstants.MainMenuSet7.XARPHIS;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.XARPHIS);
