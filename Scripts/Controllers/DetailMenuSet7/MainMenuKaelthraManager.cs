...
public class MainMenuKaelthraManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuKaelthraPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuKaelthraPanelPrefab = UIManager.Instance.Get("MainMenuKaelthraPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("KaelthraSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuKaelthraManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuKaelthraPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.KAELTHRA);
        parentType = AppConstants.MainMenuSet7.KAELTHRA;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.KAELTHRA);
