...
{
    public static MainMenuKaelthraManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuKaelthraManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet7.KAELTHRA, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet7.KAELTHRA);
