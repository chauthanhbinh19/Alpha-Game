...
public class MainMenuArcaneManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuArcanePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuArcanePanelPrefab = UIManager.Instance.Get("MainMenuArcanePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ArcaneSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuArcaneManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuArcanePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.ARCANE);
        parentType = AppConstants.MainMenuSet7.ARCANE;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.ARCANE);
