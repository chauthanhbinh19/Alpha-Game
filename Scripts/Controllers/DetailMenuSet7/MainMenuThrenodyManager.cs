...
public class MainMenuThrenodyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuThrenodyPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuThrenodyPanelPrefab = UIManager.Instance.Get("MainMenuThrenodyPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ThrenodySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuThrenodyManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuThrenodyPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.THRENODY);
        parentType = AppConstants.MainMenuSet7.THRENODY;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.THRENODY);
