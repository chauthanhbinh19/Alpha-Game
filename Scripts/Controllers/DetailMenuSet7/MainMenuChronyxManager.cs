...
public class MainMenuChronyxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuChronyxPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuChronyxPanelPrefab = UIManager.Instance.Get("MainMenuChronyxPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ChronyxSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuChronyxManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuChronyxPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.CHRONYX);
        parentType = AppConstants.MainMenuSet7.CHRONYX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.CHRONYX);
