...
public class MainMenuVelkrynManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuVelkrynPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuVelkrynPanelPrefab = UIManager.Instance.Get("MainMenuVelkrynPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("VelkrynSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuVelkrynManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuVelkrynPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.VELKRYN);
        parentType = AppConstants.MainMenuSet7.VELKRYN;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.VELKRYN);
