...
{
    public static MainMenuAstrionManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuAstrionManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet7.ASTRION, stat);
