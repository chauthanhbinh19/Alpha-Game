...
public class MainMenuAstrionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAstrionPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAstrionPanelPrefab = UIManager.Instance.Get("MainMenuAstrionPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AstrionSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAstrionManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAstrionPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet7.ASTRION);
        parentType = AppConstants.MainMenuSet7.ASTRION;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet7.ASTRION);
