...
public class HISNVIManager : MonoBehaviour
{
    public static HISNVIManager Instance { get; private set; }
    ...
    public async Task CreateHISNVIManagerAsync()
    {
    ...
    public async Task CreateMainHISNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HISN.HISN_VI}");
