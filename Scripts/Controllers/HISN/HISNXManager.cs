...
public class HISNXManager : MonoBehaviour
{
    public static HISNXManager Instance { get; private set; }
    ...
    public async Task CreateHISNXManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHISNFeaturesByTypeAsync(AppConstants.HISN.HISN_X);
    ...
    public async Task CreateMainHISNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HISN.HISN_X}");
