...
public class HISNIManager : MonoBehaviour
{
    public static HISNIManager Instance { get; private set; }
    ...
    public async Task CreateHISNIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHISNFeaturesByTypeAsync(AppConstants.HISN.HISN_I);
    ...
    public async Task CreateMainHISNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HISN.HISN_I}");
