...
public class HISNVIIManager : MonoBehaviour
{
    public static HISNVIIManager Instance { get; private set; }
    ...
    public async Task CreateHISNVIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHISNFeaturesByTypeAsync(AppConstants.HISN.HISN_VII);
    ...
    public async Task CreateMainHISNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HISN.HISN_VII}");
