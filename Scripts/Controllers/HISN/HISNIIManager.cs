...
public class HISNIIManager : MonoBehaviour
{
    public static HISNIIManager Instance { get; private set; }
    ...
    public async Task CreateHISNIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHISNFeaturesByTypeAsync(AppConstants.HISN.HISN_II);
    ...
    public async Task CreateMainHISNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HISN.HISN_II}");
