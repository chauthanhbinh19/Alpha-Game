...
public class GalleryManager : MonoBehaviour
{
    ...
    public void GetButtonType()
    {
            ...
            for (int i = 0; i < uniqueTypes.Count; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    else if (mainType.Equals("CardMilitary"))
                    {
                        ...
                        List<CardMilitary> militaryList = CardMilitaryService.Create().GetCardMilitary(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("CardSpell"))
                    {
                        ...
                        List<CardSpell> spellList = CardSpellService.Create().GetCardSpell(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("Relics"))
                    {
                        ...
                        List<Relics> relicsList = RelicsService.Create().GetRelics(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("CardMonsters"))
                    {
                        ...
                        List<CardMonsters> monstersList = CardMonstersService.Create().GetCardMonsters(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("CardColonels"))
                    {
                        ...
                        List<CardColonels> colonels = CardColonelsService.Create().GetCardColonels(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("CardGenerals"))
                    {
                        ...
                        List<CardGenerals> relicsList = CardGeneralsService.Create().GetCardGenerals(subtype, pageSize, offset);
                    ...
                    else if (mainType.Equals("CardAdmirals"))
                    {
                        ...
                        List<CardAdmirals> relicsList = CardAdmiralsService.Create().GetCardAdmirals(subtype, pageSize, offset);
        ...
        else
        {
            ...
            {
                List<Titles> titlesList = TitlesService.Create().GetTitles(pageSize, offset);
    ...
    void OnButtonClick(GameObject clickedButton, string type)
    {
        ...
        else if (mainType.Equals("CardMilitary"))
        {
            ...
            List<CardMilitary> militaryList = CardMilitaryService.Create().GetCardMilitary(type, pageSize, offset);
            createCardMilitary(militaryList);
        ...
        else if (mainType.Equals("CardSpell"))
        {
            ...
            List<CardSpell> spellList = CardSpellService.Create().GetCardSpell(type, pageSize, offset);
            createCardSpell(spellList);
        ...
        else if (mainType.Equals("Relics"))
        {
            ...
            List<Relics> relicsList = RelicsService.Create().GetRelics(type, pageSize, offset);
            createRelics(relicsList);
        ...
        else if (mainType.Equals("CardMonsters"))
        {
            ...
            List<CardMonsters> monsters = CardMonstersService.Create().GetCardMonsters(type, pageSize, offset);
            createCardMonsters(monsters);
    ...
    public void ChangeNextPage()
    {
        if (currentPage < totalPage)
        {
            ...
            else if (mainType.Equals("CardCaptains"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<CardCaptains> army = CardCaptainsService.Create().GetCardCaptains(subType, pageSize, offset);
            ...
            else if (mainType.Equals("Collaborations"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<Collaboration> collaboration = CollaborationService.Create().GetCollaboration(pageSize, offset);
            ...
            else if (mainType.Equals("Pets"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<Pets> petsList = PetsService.Create().GetPets(subType, pageSize, offset);
                createPets(petsList);
            }
            else if (mainType.Equals("Skills"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<Skills> skillsList = SkillsService.Create().GetSkills(subType, pageSize, offset);
            ...
            else if (mainType.Equals("Symbols"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<Symbols> symbolsList = SymbolsService.Create().GetSymbols(subType, pageSize, offset);
            ...
            else if (mainType.Equals("CardColonels"))
            {
                ...
                currentPage = currentPage + 1;
                offset = offset + pageSize;
                List<CardColonels> relicsList = CardColonelsService.Create().GetCardColonels(subType, pageSize, offset);
