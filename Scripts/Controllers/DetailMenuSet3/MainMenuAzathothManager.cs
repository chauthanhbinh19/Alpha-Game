...
public class MainMenuAzathothManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAzathothManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_114_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.AZATHOTH);
