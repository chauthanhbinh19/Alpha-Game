...
public class MainMenuAzathothManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuAzathothPanelPrefab = UIManager.Instance.GetGameObjectMainMenu3("MainMenuAzathothPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu3("AzathothSlotPrefab");
    ...
    public void CreateMainMenuAzathothManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.Azathoth);
        parentType = AppConstants.MainMenuSet3.AZATHOTH;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet3.AZATHOTH);
