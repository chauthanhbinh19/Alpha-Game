...
public class MainMenuAzathothManager : MonoBehaviour
{
    ...
    public void CreateMainMenuAzathothManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Azathoth.ToLower());
        parentType = AppConstants.Azathoth;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Azathoth);
