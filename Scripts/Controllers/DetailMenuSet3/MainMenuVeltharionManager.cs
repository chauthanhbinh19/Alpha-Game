...
public class MainMenuVeltharionManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuVeltharionManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.VELTHARION);
        parentType = AppConstants.MainMenuSet3.VELTHARION;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_127_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.VELTHARION);
