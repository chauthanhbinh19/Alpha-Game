...
public class MainMenuXyphosManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuXyphosManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.XYPHOS);
        parentType = AppConstants.MainMenuSet3.XYPHOS;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_130_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.XYPHOS);
