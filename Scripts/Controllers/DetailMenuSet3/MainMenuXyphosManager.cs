...
public class MainMenuXyphosManager : MonoBehaviour
{
    ...
    public void CreateMainMenuXyphosManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Xyphos.ToLower());
        parentType = AppConstants.Xyphos;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Xyphos);
