...
public class MainMenuIxithraManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuIxithraManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.IXITHRA);
        parentType = AppConstants.MainMenuSet3.IXITHRA;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_116_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.IXITHRA);
