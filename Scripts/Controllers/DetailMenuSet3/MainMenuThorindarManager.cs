...
public class MainMenuThorindarManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuThorindarManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.THORINDAR);
        parentType = AppConstants.MainMenuSet3.THORINDAR;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_125_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.THORINDAR);
