...
public class MainMenuVorathosManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuVorathosManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.VORATHOS);
        parentType = AppConstants.MainMenuSet3.VORATHOS;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_128_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.VORATHOS);
