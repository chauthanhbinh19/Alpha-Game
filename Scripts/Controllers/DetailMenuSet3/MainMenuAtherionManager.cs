...
{
    public static MainMenuAtherionManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuAtherionManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.ATHERION, stat);
