...
public class MainMenuAtherionManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuAtherionPanelPrefab = UIManager.Instance.GetGameObjectMainMenu3("MainMenuAtherionPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu3("AtherionSlotPrefab");
    ...
    public void CreateMainMenuAtherionManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.Atherion);
        parentType = AppConstants.MainMenuSet3.ATHERION;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet3.ATHERION);
