...
{
    public static MainMenuOmnitheusManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuOmnitheusManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.OMNITHEUS, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet3.OMNITHEUS);
