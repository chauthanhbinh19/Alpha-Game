...
public class MainMenuAeonaxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAeonaxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.AEONAX);
        parentType = AppConstants.MainMenuSet3.AEONAX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.AEONAX);
