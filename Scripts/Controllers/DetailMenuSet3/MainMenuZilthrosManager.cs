...
public class MainMenuZilthrosManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuZilthrosPanelPrefab;
    ...
    public async Task CreateMainMenuZilthrosManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.ZILTHROS);
        parentType = AppConstants.MainMenuSet3.ZILTHROS;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_132_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.ZILTHROS);
