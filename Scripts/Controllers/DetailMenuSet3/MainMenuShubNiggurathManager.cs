...
public class MainMenuShubNiggurathManager : MonoBehaviour
{
    ...
    public void CreateMainMenuShubNiggurathManager(object data)
    {
        ...
        parentType = AppConstants.MainMenuSet3.ShubNiggurath;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet3.ShubNiggurath.ToLower());
