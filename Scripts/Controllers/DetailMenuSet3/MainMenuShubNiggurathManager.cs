...
{
    public static MainMenuShubNiggurathManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuShubNiggurathManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.SHUB_NIGGURATH, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet3.SHUB_NIGGURATH);
