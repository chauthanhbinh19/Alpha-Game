...
public class MainMenuShubNiggurathManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuShubNiggurathPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuShubNiggurathPanelPrefab = UIManager.Instance.Get("MainMenuShubNiggurathPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ShubNiggurathSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuShubNiggurathManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.SHUB_NIGGURATH);
        parentType = AppConstants.MainMenuSet3.SHUB_NIGGURATH;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_123_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.SHUB_NIGGURATH.ToLower());
