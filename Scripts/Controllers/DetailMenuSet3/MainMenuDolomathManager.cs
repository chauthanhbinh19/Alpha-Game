...
public class MainMenuDolomathManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuDolomathPanelPrefab = UIManager.Instance.GetGameObjectMainMenu3("MainMenuDolomathPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu3("DolomathSlotPrefab");
    ...
    public void CreateMainMenuDolomathManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.DOLOMATH);
        parentType = AppConstants.MainMenuSet3.DOLOMATH;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet3.DOLOMATH);
