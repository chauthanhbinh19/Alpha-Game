...
public class MainMenuVaelithManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuVaelithManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.VAELITH);
        parentType = AppConstants.MainMenuSet3.VAELITH;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_126_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.VAELITH);
