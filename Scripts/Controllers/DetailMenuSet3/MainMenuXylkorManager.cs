...
public class MainMenuXylkorManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuXylkorManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.XYLKOR);
        parentType = AppConstants.MainMenuSet3.XYLKOR;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_129_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.XYLKOR);
