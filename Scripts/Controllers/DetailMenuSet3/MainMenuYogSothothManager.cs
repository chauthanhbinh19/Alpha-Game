...
{
    public static MainMenuYogSothothManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuYogSothothManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.YOG_SOTHOTH, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet3.YOG_SOTHOTH);
