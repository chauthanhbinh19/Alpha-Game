...
public class MainMenuYogSothothManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuYogSothothPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuYogSothothPanelPrefab = UIManager.Instance.Get("MainMenuYogSothothPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("YogSothothSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuYogSothothManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.YOG_SOTHOTH);
        parentType = AppConstants.MainMenuSet3.YOG_SOTHOTH;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_131_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.YOG_SOTHOTH.ToLower());
