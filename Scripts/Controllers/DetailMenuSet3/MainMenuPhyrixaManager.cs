...
public class MainMenuPhyrixaManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuPhyrixaManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.PHYRIXA);
        parentType = AppConstants.MainMenuSet3.PHYRIXA;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_121_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.PHYRIXA);
