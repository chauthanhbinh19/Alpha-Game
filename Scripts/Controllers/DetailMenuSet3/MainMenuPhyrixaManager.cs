...
{
    public static MainMenuPhyrixaManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuPhyrixaManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.PHYRIXA, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet3.PHYRIXA);
