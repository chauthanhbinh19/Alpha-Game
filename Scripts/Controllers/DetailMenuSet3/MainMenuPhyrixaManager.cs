...
public class MainMenuPhyrixaManager : MonoBehaviour
{
    ...
    public void CreateMainMenuPhyrixaManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Phyrixa.ToLower());
        parentType = AppConstants.Phyrixa;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Phyrixa);
