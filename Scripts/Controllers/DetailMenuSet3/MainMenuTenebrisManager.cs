...
{
    public static MainMenuTenebrisManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuTenebrisManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet3.TENEBRIS, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet3.TENEBRIS);
