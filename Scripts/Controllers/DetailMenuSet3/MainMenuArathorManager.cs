...
public class MainMenuArathorManager : MonoBehaviour
{
    ...
    public void CreateMainMenuArathorManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Arathor.ToLower());
        parentType = AppConstants.Arathor;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Arathor);
