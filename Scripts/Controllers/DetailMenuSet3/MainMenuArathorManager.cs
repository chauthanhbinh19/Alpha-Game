...
public class MainMenuArathorManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuArathorPanelPrefab = UIManager.Instance.GetGameObjectMainMenu3("MainMenuArathorPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu3("ArathorSlotPrefab");
    ...
    public void CreateMainMenuArathorManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.Arathor);
        parentType = AppConstants.MainMenuSet3.Arathor;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet3.Arathor);
