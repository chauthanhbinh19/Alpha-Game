...
public class MainMenuArcanosManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuArcanosManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet3.ARCANOS);
        parentType = AppConstants.MainMenuSet3.ARCANOS;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_112_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet3.ARCANOS);
