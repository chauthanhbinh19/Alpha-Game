...
public class MainMenuArcanosManager : MonoBehaviour
{
    ...
    public void CreateMainMenuArcanosManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Arcanos.ToLower());
        parentType = AppConstants.Arcanos;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Arcanos);
