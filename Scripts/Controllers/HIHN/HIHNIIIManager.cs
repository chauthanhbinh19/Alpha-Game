...
public class HIHNIIIManager : MonoBehaviour
{
    ...
    public async Task CreateHIHNIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.HIHN.HIHN_III);
    ...
    public async Task CreateMainHIHNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIHN.HIHN_III}");
