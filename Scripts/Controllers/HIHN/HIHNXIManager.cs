...
public class HIHNXIManager : MonoBehaviour
{
    public static HIHNXIManager Instance { get; private set; }
    ...
    public async Task CreateHIHNXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIHNFeaturesByTypeAsync(AppConstants.HIHN.HIHN_XI);
    ...
    public async Task CreateMainHIHNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIHN.HIHN_XI}");
