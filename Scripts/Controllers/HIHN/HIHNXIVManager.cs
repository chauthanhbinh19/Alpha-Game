...
public class HIHNXIVManager : MonoBehaviour
{
    public static HIHNXIVManager Instance { get; private set; }
    ...
    public async Task CreateHIHNXIVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIHNFeaturesByTypeAsync(AppConstants.HIHN.HIHN_XIV);
    ...
    public async Task CreateMainHIHNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIHN.HIHN_XIV}");
