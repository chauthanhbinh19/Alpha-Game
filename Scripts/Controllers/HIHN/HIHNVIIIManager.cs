...
public class HIHNVIIIManager : MonoBehaviour
{
    public static HIHNVIIIManager Instance { get; private set; }
    ...
    public async Task CreateHIHNVIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIHNFeaturesByTypeAsync(AppConstants.HIHN.HIHN_VIII);
    ...
    public async Task CreateMainHIHNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HIHN.HIHN_VIII}");
