...
public class HITNVIIManager : MonoBehaviour
{
    ...
    private GameObject PopupHITNQuantityPanelPrefab;
    ...
    private List<KeyValuePair<string, FeatureHITNDTO>> FeatureList;
        ...
        for (int i = start; i < end; i++)
        {
            ...
            if (btn != null)
            {
                ...
                btn.onClick.AddListener(async () =>
                {
                    ...
                    AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                    await CreateMainHITNPanelAsync(currentFeatureId, currentSubtype);
                });
            }
        }
    }
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.HITN.HITN_VII_BACKGROUND_URL);
        ...
        void CreatePopupUpgradePanelAsync()
        {
            GameObject gameObject =
                Instantiate(PopupHITNQuantityPanelPrefab, MainPanel);
