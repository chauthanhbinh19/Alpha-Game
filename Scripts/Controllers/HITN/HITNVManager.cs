...
public class HITNVManager : MonoBehaviour
{
    public static HITNVManager Instance { get; private set; }
    ...
    public async Task CreateHITNVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHITNFeaturesByTypeAsync(AppConstants.HITN.HITN_V);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HITN.HITN_V}");
