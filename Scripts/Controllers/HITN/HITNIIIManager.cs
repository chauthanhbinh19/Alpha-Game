...
public class HITNIIIManager : MonoBehaviour
{
    ...
    public async Task CreateHITNIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.HITN.HITN_III);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HITN.HITN_III}");
