...
public class HITNXIVManager : MonoBehaviour
{
    public static HITNXIVManager Instance { get; private set; }
    ...
    public async Task CreateHITNXIVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHITNFeaturesByTypeAsync(AppConstants.HITN.HITN_XIV);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HITN.HITN_XIV}");
