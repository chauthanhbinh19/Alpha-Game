...
public class HITNVIIIManager : MonoBehaviour
{
    public static HITNVIIIManager Instance { get; private set; }
    ...
    public async Task CreateHITNVIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHITNFeaturesByTypeAsync(AppConstants.HITN.HITN_VIII);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.HITN.HITN_VIII}");
