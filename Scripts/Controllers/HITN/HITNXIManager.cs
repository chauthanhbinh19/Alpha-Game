...
public class HITNXIManager : MonoBehaviour
{
    public static HITNXIManager Instance { get; private set; }
    ...
    public async Task CreateHITNXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHITNFeaturesByTypeAsync(AppConstants.HITN.HITN_XI);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HITN.HITN_XI}");
