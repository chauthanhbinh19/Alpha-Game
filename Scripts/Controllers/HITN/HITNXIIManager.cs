...
public class HITNXIIManager : MonoBehaviour
{
    public static HITNXIIManager Instance { get; private set; }
    ...
    public async Task CreateHITNXIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHITNFeaturesByTypeAsync(AppConstants.HITN.HITN_XII);
    ...
    public async Task CreateMainHITNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HITN.HITN_XII}");
