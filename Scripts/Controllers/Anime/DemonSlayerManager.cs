...
public class DemonSlayerManager : MonoBehaviour
{
    public static DemonSlayerManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.DEMON_SLAYER);
