...
public class FairyTailManager : MonoBehaviour
{
    public static FairyTailManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.FAIRY_TAIL);
