...
public class HunterXHunterManager : MonoBehaviour
{
    public static HunterXHunterManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.HUNTER_X_HUNTER);
