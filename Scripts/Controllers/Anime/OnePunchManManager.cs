...
public class OnePunchManManager : MonoBehaviour
{
    public static OnePunchManManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.ONE_PUNCH_MAN);
