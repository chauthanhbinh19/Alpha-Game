...
public class JujutsuKaisenManager : MonoBehaviour
{
    public static JujutsuKaisenManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.JUJUTSU_KAISEN);
