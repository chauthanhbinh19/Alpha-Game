...
public class BlackCloverManager : MonoBehaviour
{
    public static BlackCloverManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.BLACK_CLOVER);
