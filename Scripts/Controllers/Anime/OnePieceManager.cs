...
public class OnePieceManager : MonoBehaviour
{
    public static OnePieceManager Instance { get; private set; }
    ...
    public async Task CreateAnimeManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetAnimeFeaturesByTypeAsync(AppConstants.Anime.ONE_PIECE);
