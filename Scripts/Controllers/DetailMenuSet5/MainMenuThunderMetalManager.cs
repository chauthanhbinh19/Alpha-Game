...
public class MainMenuThunderMetalManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuThunderMetalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuThunderMetalPanelPrefab = UIManager.Instance.Get("MainMenuThunderMetalPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ThunderMetalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuThunderMetalManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuThunderMetalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.THUNDER_METAL);
        parentType = AppConstants.MainMenuSet5.THUNDER_METAL;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_175_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.THUNDER_METAL);
