...
public class MainMenuFreedomBluesManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuFreedomBluesPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuFreedomBluesPanelPrefab = UIManager.Instance.Get("MainMenuFreedomBluesPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("FreedomBluesSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuFreedomBluesManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuFreedomBluesPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.FREEDOM_BLUES);
        parentType = AppConstants.MainMenuSet5.FREEDOM_BLUES;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_162_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.FREEDOM_BLUES);
