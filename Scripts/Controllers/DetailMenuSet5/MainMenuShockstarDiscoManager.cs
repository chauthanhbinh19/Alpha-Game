...
public class MainMenuShockstarDiscoManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuShockstarDiscoPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuShockstarDiscoPanelPrefab = UIManager.Instance.Get("MainMenuShockstarDiscoPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ShockstarDiscoSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuShockstarDiscoManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuShockstarDiscoPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.SHOCKSTAR_DISCO);
        parentType = AppConstants.MainMenuSet5.SHOCKSTAR_DISCO;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_172_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.SHOCKSTAR_DISCO);
