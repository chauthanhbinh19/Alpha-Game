...
{
    public static MainMenuShockstarDiscoManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuShockstarDiscoManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.SHOCKSTAR_DISCO, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.SHOCKSTAR_DISCO);
