...
public class MainMenuDawnSBloomManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDawnSBloomPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuDawnSBloomPanelPrefab = UIManager.Instance.Get("MainMenuDawnSBloomPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("DawnSBloomSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuDawnSBloomManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuDawnSBloomPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.DAWN_S_BLOOM);
        parentType = AppConstants.MainMenuSet5.DAWN_S_BLOOM;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_160_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.DAWN_S_BLOOM);
