...
{
    public static MainMenuDawnSBloomManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuDawnSBloomManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.DAWN_S_BLOOM, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.DAWN_S_BLOOM);
