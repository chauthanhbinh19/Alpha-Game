...
public class MainMenuMoonlightLullabyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuMoonlightLullabyPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuMoonlightLullabyPanelPrefab = UIManager.Instance.Get("MainMenuMoonlightLullabyPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("MoonlightLullabySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuMoonlightLullabyManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuMoonlightLullabyPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.MOONLIGHT_LULLABY);
        parentType = AppConstants.MainMenuSet5.MOONLIGHT_LULLABY;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_166_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.MOONLIGHT_LULLABY);
