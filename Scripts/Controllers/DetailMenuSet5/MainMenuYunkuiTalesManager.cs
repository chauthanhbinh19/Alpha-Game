...
public class MainMenuYunkuiTalesManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuYunkuiTalesPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuYunkuiTalesPanelPrefab = UIManager.Instance.Get("MainMenuYunkuiTalesPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("YunkuiTalesSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuYunkuiTalesManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuYunkuiTalesPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.YUNKUI_TALES);
        parentType = AppConstants.MainMenuSet5.YUNKUI_TALES;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_177_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.YUNKUI_TALES);
