...
{
    public static MainMenuYunkuiTalesManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuYunkuiTalesManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.YUNKUI_TALES, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.YUNKUI_TALES);
