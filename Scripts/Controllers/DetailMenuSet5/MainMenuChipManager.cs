...
public class MainMenuChipManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuChipPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuChipPanelPrefab = UIManager.Instance.Get("MainMenuChipPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ChipSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuChipManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuChipPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.CHIP);
        parentType = AppConstants.MainMenuSet5.CHIP;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.CHIP);
