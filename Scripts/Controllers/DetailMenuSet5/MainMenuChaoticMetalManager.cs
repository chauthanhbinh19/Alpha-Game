...
public class MainMenuChaoticMetalManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuChaoticMetalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuChaoticMetalPanelPrefab = UIManager.Instance.Get("MainMenuChaoticMetalPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ChaoticMetalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuChaoticMetalManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuChaoticMetalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.CHAOTIC_METAL);
        parentType = AppConstants.MainMenuSet5.CHAOTIC_METAL;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_159_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.CHAOTIC_METAL);
