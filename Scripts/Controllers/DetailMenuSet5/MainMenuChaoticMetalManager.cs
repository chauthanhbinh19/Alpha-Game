...
{
    public static MainMenuChaoticMetalManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuChaoticMetalManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.CHAOTIC_METAL, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.CHAOTIC_METAL);
