...
public class MainMenuShadowHarmonyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuShadowHarmonyPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuShadowHarmonyPanelPrefab = UIManager.Instance.Get("MainMenuShadowHarmonyPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ShadowHarmonySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuShadowHarmonyManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuShadowHarmonyPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.SHADOW_HARMONY);
        parentType = AppConstants.MainMenuSet5.SHADOW_HARMONY;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_171_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.SHADOW_HARMONY);
