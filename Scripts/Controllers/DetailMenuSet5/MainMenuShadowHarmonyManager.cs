...
{
    public static MainMenuShadowHarmonyManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuShadowHarmonyManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.SHADOW_HARMONY, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.SHADOW_HARMONY);
