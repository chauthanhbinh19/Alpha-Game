...
public class MainMenuPolarMetalManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPolarMetalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuPolarMetalPanelPrefab = UIManager.Instance.Get("MainMenuPolarMetalPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("PolarMetalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuPolarMetalManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuPolarMetalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.POLAR_METAL);
        parentType = AppConstants.MainMenuSet5.POLAR_METAL;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_168_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.POLAR_METAL);
