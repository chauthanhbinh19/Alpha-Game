...
public class MainMenuHormonePunkManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHormonePunkPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuHormonePunkPanelPrefab = UIManager.Instance.Get("MainMenuHormonePunkPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("HormonePunkSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuHormonePunkManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuHormonePunkPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.HORMONE_PUNK);
        parentType = AppConstants.MainMenuSet5.HORMONE_PUNK;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_163_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.HORMONE_PUNK);
