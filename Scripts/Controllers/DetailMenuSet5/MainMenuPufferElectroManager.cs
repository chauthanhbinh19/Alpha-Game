...
public class MainMenuPufferElectroManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPufferElectroPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuPufferElectroPanelPrefab = UIManager.Instance.Get("MainMenuPufferElectroPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("PufferElectroSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuPufferElectroManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuPufferElectroPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.PUFFER_ELECTRO);
        parentType = AppConstants.MainMenuSet5.PUFFER_ELECTRO;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_170_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.PUFFER_ELECTRO);
