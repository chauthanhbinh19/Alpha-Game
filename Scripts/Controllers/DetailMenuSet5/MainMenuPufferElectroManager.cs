...
{
    public static MainMenuPufferElectroManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuPufferElectroManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.PUFFER_ELECTRO, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.PUFFER_ELECTRO);
