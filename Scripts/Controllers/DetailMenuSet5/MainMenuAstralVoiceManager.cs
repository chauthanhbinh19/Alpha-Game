...
{
    public static MainMenuAstralVoiceManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuAstralVoiceManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.ASTRAL_VOICE, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.ASTRAL_VOICE);
