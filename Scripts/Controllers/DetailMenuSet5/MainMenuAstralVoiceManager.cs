...
public class MainMenuAstralVoiceManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAstralVoicePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAstralVoicePanelPrefab = UIManager.Instance.Get("MainMenuAstralVoicePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AstralVoiceSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAstralVoiceManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAstralVoicePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.ASTRAL_VOICE);
        parentType = AppConstants.MainMenuSet5.ASTRAL_VOICE;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_156_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.ASTRAL_VOICE);
