...
{
    public static MainMenuKingOfTheSummitManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuKingOfTheSummitManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.KING_OF_THE_SUMMIT, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.KING_OF_THE_SUMMIT);
