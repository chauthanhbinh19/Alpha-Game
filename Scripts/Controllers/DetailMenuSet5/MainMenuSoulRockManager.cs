...
public class MainMenuSoulRockManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuSoulRockPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuSoulRockPanelPrefab = UIManager.Instance.Get("MainMenuSoulRockPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("SoulRockSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuSoulRockManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuSoulRockPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.SOUL_ROCK);
        parentType = AppConstants.MainMenuSet5.SOUL_ROCK;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_173_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.SOUL_ROCK);
