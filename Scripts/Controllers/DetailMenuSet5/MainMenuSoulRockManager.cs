...
{
    public static MainMenuSoulRockManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuSoulRockManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.SOUL_ROCK, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.SOUL_ROCK);
