...
public class MainMenuWoodpeckerElectroManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuWoodpeckerElectroPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuWoodpeckerElectroPanelPrefab = UIManager.Instance.Get("MainMenuWoodpeckerElectroPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("WoodpeckerElectroSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuWoodpeckerElectroManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuWoodpeckerElectroPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.WOODPECKER_ELECTRO);
        parentType = AppConstants.MainMenuSet5.WOODPECKER_ELECTRO;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_176_URL);
        ...
        scrollViewBackground.texture = Resources.Load<Texture>(ImageConstants.Background.SCROLLVIEW_BACKGROUND_5_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.WOODPECKER_ELECTRO);
