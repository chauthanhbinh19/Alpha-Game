...
public class MainMenuBranchBladeSongManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuBranchBladeSongPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuBranchBladeSongPanelPrefab = UIManager.Instance.Get("MainMenuBranchBladeSongPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("BranchBladeSongSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuBranchBladeSongManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuBranchBladeSongPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.BRANCH_BLADE_SONG);
        parentType = AppConstants.MainMenuSet5.BRANCH_BLADE_SONG;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_157_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.BRANCH_BLADE_SONG);
