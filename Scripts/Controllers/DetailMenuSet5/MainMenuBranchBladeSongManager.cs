...
{
    public static MainMenuBranchBladeSongManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuBranchBladeSongManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.BRANCH_BLADE_SONG, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.BRANCH_BLADE_SONG);
