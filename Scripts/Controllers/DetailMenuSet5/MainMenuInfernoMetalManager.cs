...
public class MainMenuInfernoMetalManager : MonoBehaviour
{
    ...
    private GameObject MainMenuInfernoMetalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuInfernoMetalPanelPrefab = UIManager.Instance.Get("MainMenuInfernoMetalPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("InfernoMetalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuInfernoMetalManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuInfernoMetalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.INFERNO_METAL);
        parentType = AppConstants.MainMenuSet5.INFERNO_METAL;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_164_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.INFERNO_METAL);
