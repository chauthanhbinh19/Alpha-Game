...
public class MainMenuProtoPunkManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuProtoPunkPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuProtoPunkPanelPrefab = UIManager.Instance.Get("MainMenuProtoPunkPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ProtoPunkSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuProtoPunkManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuProtoPunkPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.PROTO_PUNK);
        parentType = AppConstants.MainMenuSet5.PROTO_PUNK;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_169_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.PROTO_PUNK);
