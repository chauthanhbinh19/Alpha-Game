...
public class MainMenuChaosJazzManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuChaosJazzPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuChaosJazzPanelPrefab = UIManager.Instance.Get("MainMenuChaosJazzPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ChaosJazzSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuChaosJazzManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuChaosJazzPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.CHAOS_JAZZ);
        parentType = AppConstants.MainMenuSet5.CHAOS_JAZZ;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_158_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.CHAOS_JAZZ);
