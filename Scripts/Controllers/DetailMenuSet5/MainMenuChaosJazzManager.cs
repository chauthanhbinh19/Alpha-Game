...
{
    public static MainMenuChaosJazzManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuChaosJazzManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.CHAOS_JAZZ, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.CHAOS_JAZZ);
