...
public class MainMenuSwingJazzManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuSwingJazzPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuSwingJazzPanelPrefab = UIManager.Instance.Get("MainMenuSwingJazzPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("SwingJazzSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuSwingJazzManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuSwingJazzPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.SWING_JAZZ);
        parentType = AppConstants.MainMenuSet5.SWING_JAZZ;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_174_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.SWING_JAZZ);
