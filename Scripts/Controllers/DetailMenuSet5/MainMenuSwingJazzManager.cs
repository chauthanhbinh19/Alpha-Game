...
{
    public static MainMenuSwingJazzManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuSwingJazzManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet5.SWING_JAZZ, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet5.SWING_JAZZ);
