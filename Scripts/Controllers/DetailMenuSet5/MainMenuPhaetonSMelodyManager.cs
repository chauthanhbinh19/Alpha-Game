...
public class MainMenuPhaetonSMelodyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPhaetonSMelodyPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuPhaetonSMelodyPanelPrefab = UIManager.Instance.Get("MainMenuPhaetonSMelodyPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("PhaetonSMelodySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuPhaetonSMelodyManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuPhaetonSMelodyPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet5.PHAETON_S_MELODY);
        parentType = AppConstants.MainMenuSet5.PHAETON_S_MELODY;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_167_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet5.PHAETON_S_MELODY);
