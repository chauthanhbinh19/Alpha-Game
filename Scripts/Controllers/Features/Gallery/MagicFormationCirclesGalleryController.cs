...
public class MagicFormationCirclesGalleryController : MonoBehaviour
{
    ...
    public void CreateMagicFormationCirclesGallery(List<MagicFormationCircles> magicFormationCircles, Transform contentPanel)
    {
        foreach (var magicFormationCircle in magicFormationCircles)
        {
            try
            {
                ...
                backgroundImage.texture = Resources.Load<Texture>(ImageConstants.Background.MAGIC_FORMATION_CIRCLE_BUTTON_BACKGROUND_URL);
