...
public class CardSoldiersController : MonoBehaviour
{
    public static CardSoldiersController Instance { get; private set; }
    ...
    public async Task CreateCardSoldiersTradeAsync(List<CardSoldiers> cardAdmirals, string subType, Transform currentContent, Transform currencyPanel, Transform popupPanel)
    {
        // Xóa bớt animation cũ nếu có để tránh lỗi chồng đè
