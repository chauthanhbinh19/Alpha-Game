...
public class CardsController : MonoBehaviour
{
    ...
    public void CreateCardsGallery(List<Cards> cards, Transform DictionaryContentPanel)
    {
    ...
    public void CreateCardsTrade(List<Cards> cards, string subType, Transform currentContent,
    ...
    public void GetQuantity(double originPrice, object obj, string subType, Transform popupPanel, Transform currencyPanel)
    {
        ...
        maxButton.onClick.AddListener(() =>
        {
            ...
            {
                userCurrency = UserCurrencyService.Create().GetUserCurrencyById(Cards.Currency.Id);
            }
