...
public class CollaborationEquipmentsController : MonoBehaviour
{
    ...
    public async Task CreateCollaborationEquipmentsTradeAsync(List<CollaborationEquipments> collaborationEquipments, string subType, Transform currentContent, Transform currencyPanel, Transform popupPanel)
    {
        // Xóa bớt animation cũ nếu có để tránh lỗi chồng đè
        ...
        foreach (var collaborationEquipment in collaborationEquipments)
        {
            ...
            fileNameWithoutExtension = ImageHelper.RemoveImageExtension(collaborationEquipment.Currency.Image);
            ...
            currencyText.text = NumberFormatterHelper.FormatNumber(collaborationEquipment.Currency.Quantity, false);
            ...
            {
                AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                GetQuantity(collaborationEquipment.Currency.Quantity, collaborationEquipment, subType, popupPanel, currencyPanel);
            });
        }
    ...
    public void GetQuantity(double originPrice, object obj, string subType, Transform popupPanel, Transform currencyPanel)
    {
        ...
        maxButton.onClick.AddListener(async () =>
        {
            ...
            {
                userCurrency = await UserCurrenciesService.Create().GetUserCurrencyByIdAsync(User.CurrentUserId, collaborationEquipment.Currency.Id);
            }
