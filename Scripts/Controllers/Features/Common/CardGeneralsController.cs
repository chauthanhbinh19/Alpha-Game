...
public class CardGeneralsController : MonoBehaviour
{
    ...
    Transform currencyPanel, Transform popupPanel)
    {
        foreach (var cardGeneral in cardGenerals)
        {
            ...
            string fileNameWithoutExtension = cardGeneral.image.Replace(".png", "");
            ...
            // Gán sự kiện click
            ButtonEvent.Instance.AddClickListener(eventTrigger, () => FindObjectOfType<PopupDetailsManager>().PopupDetails(cardGeneral, MainPanel));
            // Thêm sự kiện Scroll để chuyển tiếp sự kiện cuộn
            EventTrigger.Entry scrollEntry = new EventTrigger.Entry { eventID = EventTriggerType.Scroll };
            scrollEntry.callback.AddListener((eventData) =>
            {
            ...
            fileNameWithoutExtension = cardGeneral.currency.image.Replace(".png", "");
