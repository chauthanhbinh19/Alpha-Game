...
public class CardGeneralsController : MonoBehaviour
{
    ...
    public void CreateCardGeneralsGallery(List<CardGenerals> cardGenerals, Transform contentPanel)
    {
        ...
        foreach (var cardGeneral in cardGenerals)
        {
            ...
            rareBackground.color = ColorHelper.HexToColor(QualityEvaluator.CheckRareColor(cardGeneral.Rare));
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluator.CheckRareColor(cardGeneral.Rare));
