...
public class BadgesController : MonoBehaviour
{
    ...
    public void CreateBadgesGallery(List<Badges> BadgesList, Transform DictionaryContentPanel)
    {
        foreach (var Badge in BadgesList)
        {
            GameObject BadgeObject = Instantiate(equipmentsPrefab, DictionaryContentPanel);
    ...
    Transform currencyPanel, Transform popupPanel)
    {
        foreach (var Badge in BadgesList)
        {
            ...
            Outline middleOutline = BadgeObject.transform.Find("MiddleImage").GetComponent<Outline>();
            bottomOutline.effectColor = ColorHelper.ToColor(ColorConstants.GREEN_COLOR);
