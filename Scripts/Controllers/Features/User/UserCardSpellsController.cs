...
public class UserCardSpellsController : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        CardSpellButtonPrefab = UIManager.Instance.Get(AppConstants.Prefab.Component.CARD_SPELL_BUTTON_PREFAB);
    ...
    public void CreateUserCardSpells(List<CardSpells> cardSpells, Transform contentPanel)
    {
        ...
        foreach (var cardSpell in cardSpells)
        {
            ...
            rareBackground.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardSpell.Rarity));
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardSpell.Rarity));
            rareText.text = cardSpell.Rarity;
        }
    ...
    public void ShowCardSpellDetails(CardSpells cardSpell, int buttonType = 1)
    {
        ...
        ButtonLoader.Instance.CreateSetButtonGroup(cardSpell, setButtonGroupPanel);
    ...
    public void RefreshDetailsUI(CardSpells cardSpell, GameObject currentObject)
    {
        ...
        TextureHelper.SetupStars(starGridLayout, cardSpell.Star);
        ...
        mainClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardSpell.Class.MainImage));
        subClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardSpell.Class.SubImage));
        ...
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, cardSpell.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, cardSpell.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, cardSpell.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, cardSpell.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, cardSpell.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, cardSpell.AtomicDefense);
    ...
    public void BindButton(CardSpells cardSpell, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StatsManager.Instance.CreateStatsManager(cardSpell);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StarController.Instance.CreateStarPanel(cardSpell, MAX_LEVEL, level => Math.Max(level, 1) * 2d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            ModuleManager.Instance.CreateModule(cardSpell);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            UpgradeManager.Instance.CreateUpgrade(cardSpell);
        });
    }
