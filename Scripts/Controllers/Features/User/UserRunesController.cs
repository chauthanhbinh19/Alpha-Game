...
public class UserRunesController : MonoBehaviour
{
    ...
    public void CreateUserRunes(List<Runes> runes, Transform contentPanel)
    {
        foreach (var rune in runes)
        {
            ...
            backgroundImage.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.RUNE_BUTTON_BACKGROUND_URL);
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is Runes rune)
        {
            ...
            RawImage runeImage = runeObject.transform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI runeQuantity = runeObject.transform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
