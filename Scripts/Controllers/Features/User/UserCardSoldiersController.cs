...
public class UserCardSoldiersController : MonoBehaviour
{
    ...
    public void CreateUserCardSoldiers(List<CardSoldiers> cardSoldiers, Transform contentPanel)
    {
        ...
        foreach (var cardSoldier in cardSoldiers)
        {
            ...
            cardText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_ADMIRAL);
            ...
            if(cardSoldier.Team.TeamNumber != 0)
            {
                ...
                teamTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TEAM) + " " + cardSoldier.Team.TeamNumber.ToString();
            }
            else
            {
            ...
            {
                ShowCardSoldierDetails(cardSoldier);
            });
    ...
    public void ShowCardSoldierDetails(CardSoldiers cardSoldier, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_SOLDIER);
    ...
    public void RefreshDetailsUI(CardSoldiers cardSoldier, GameObject currentObject)
    {
        ...
        TextureHelper.SetupStars(starGridLayout, cardSoldier.Star);
        ...
        mainClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardSoldier.Class.MainImage));
        subClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardSoldier.Class.SubImage));
        ...
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, cardSoldier.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, cardSoldier.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, cardSoldier.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, cardSoldier.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, cardSoldier.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, cardSoldier.AtomicDefense);
    ...
    public void BindButton(CardSoldiers cardSoldier, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StatsManager.Instance.CreateStatsManager(cardSoldier);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            MasterManager.Instance.CreateMaster(cardSoldier);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            RankManager.Instance.CreateRank(cardSoldier);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            await MainMenuEquipmentManager.Instance.CreateMainMenuEquipmentManagerAsync(cardSoldier);
        });
    }
