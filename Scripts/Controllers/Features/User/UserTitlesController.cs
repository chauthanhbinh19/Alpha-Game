...
public class UserTitlesController : MonoBehaviour
{
    ...
    public async Task GetLevelAsync(object obj, GameObject currentObject)
    {
        ...
        {
            PropertyInfo[] properties = title.GetType().GetProperties();
            UIManager.Instance.CreatePropertyLevelUI(properties, title, INCREASE_PER_LEVEL, currentObject);
            ...
            up1LevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    newTitle = await UnitLevelHelper.GetNewLevelPowerAsync(title, INCREASE_PER_LEVEL);
            ...
            upMaxLevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    Titles newTitle = await UnitLevelHelper.GetNewLevelPowerAsync(title, levelsGained * INCREASE_PER_LEVEL);
        ...
        if (obj is Titles title)
        {
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                if (hasEnoughTitle || hasEnoughItem)
                {
                    ...
                    newTitle = await UnitBreakthroughHelper.GetNewBreakthroughPowerAsync(title, INCREASE_PER_UPGRADE);
