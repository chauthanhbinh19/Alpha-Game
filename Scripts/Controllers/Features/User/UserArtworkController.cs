...
public class UserArtworkController : MonoBehaviour
{
    ...
    public void CreateUserArtwork(List<Artwork> alchemies, Transform DictionaryContentPanel)
    {
        foreach (var Artwork in alchemies)
        {
            ...
            // Gán sự kiện click
            ButtonEvent.Instance.AddClickListener(eventTrigger, () => FindObjectOfType<MainMenuDetailsManager>().PopupDetails(Artwork, MainPanel));
    ...
    public void GetLevel(object obj, GameObject currentObject)
    {
        ...
        if (obj is Artwork Artwork)
        {
            ...
            items = userItemsService.GetItemForLevel("Artwork");
            ...
            upMaxLevelButton.onClick.AddListener(() =>
            {
                ...
                if (canLevel)
                {
                    ...
                    double currentPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    Artwork newCard = UserArtworkService.Create().GetNewLevelPower(Artwork, levelsGained * increasePerLevel);
    ...
    public void GetUpgrade(object obj, GameObject currentObject)
    {
        ...
        if (obj is Artwork Artwork)
        {
            ...
            Items item = new Items();
            List<Items> items = new List<Items>();
            items = userItemsService.GetItemForBreakthourgh("Artwork");
