...
public class UserArchitecturesController : MonoBehaviour
{
    ...
    public async Task GetLevelAsync(object obj, GameObject currentObject)
    {
        ...
        {
            PropertyInfo[] properties = architecture.GetType().GetProperties();
            UIManager.Instance.CreatePropertyLevelUI(properties, architecture, INCREASE_PER_LEVEL, currentObject);
            ...
            up1LevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    newArchitecture = await UnitLevelHelper.GetNewLevelPowerAsync(architecture, INCREASE_PER_LEVEL);
            ...
            upMaxLevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    Architectures newArchitecture = await UnitLevelHelper.GetNewLevelPowerAsync(architecture, levelsGained * INCREASE_PER_LEVEL);
        ...
        if (obj is Architectures architecture)
        {
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                if (hasEnoughArchitecture || hasEnoughItem)
                {
                    ...
                    newArchitecture = await UnitBreakthroughHelper.GetNewBreakthroughPowerAsync(architecture, INCREASE_PER_UPGRADE);
