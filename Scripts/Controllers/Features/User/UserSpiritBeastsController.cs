...
public class UserSpiritBeastsController : MonoBehaviour
{
    ...
    public void CreateUserSpiritBeasts(List<SpiritBeasts> spiritBeasts, Transform contentPanel)
    {
        ...
        Texture bgTexture = TextureHelper.LoadTextureCached(ImageConstants.Background.SPIRIT_BEAST_BUTTON_BACKGROUND_URL);
        ...
        foreach (var spiritBeast in spiritBeasts)
        {
            ...
            string fileNameWithoutExtension = ImageHelper.RemoveImageExtension(spiritBeast.Image);
    ...
    public void ShowSpiritBeastDetails(SpiritBeasts spiritBeast, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.SPIRIT_BEAST);
    ...
    public void RefreshDetailsUI(SpiritBeasts spiritBeast, GameObject currentObject)
    {
        ...
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, spiritBeast.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, spiritBeast.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, spiritBeast.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, spiritBeast.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, spiritBeast.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, spiritBeast.AtomicDefense);
