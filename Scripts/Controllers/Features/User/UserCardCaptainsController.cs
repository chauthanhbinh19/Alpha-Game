...
public class UserCardCaptainsController : MonoBehaviour
{
    ...
    public void CreateUserCardCaptains(List<CardCaptains> cardCaptains, Transform contentPanel)
    {
        ...
        foreach (var cardCaptain in cardCaptains)
        {
            ...
            if (cardCaptain.Team.TeamNumber != 0)
            {
                ...
                teamTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TEAM) + " " + cardCaptain.Team.TeamNumber.ToString();
            }
            else
            {
    ...
    public void ShowCardCaptainDetails(CardCaptains cardCaptain, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_CAPTAIN);
    ...
    public void BindButton(CardCaptains cardCaptain, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            MasterManager.Instance.CreateMaster(cardCaptain);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            RankManager.Instance.CreateRank(cardCaptain);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            await MainMenuEquipmentManager.Instance.CreateMainMenuEquipmentManagerAsync(cardCaptain);
        });
    }
