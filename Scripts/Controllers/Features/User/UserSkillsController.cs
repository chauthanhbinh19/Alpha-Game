...
public class UserSkillsController : MonoBehaviour
{
    ...
    public void ShowSkillDetails(Skills skill, GameObject currentObject, int buttonType = 1)
    {
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is Skills skill)
        {
            ...
            RawImage skillImage = skillTransform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI skillQuantity = skillTransform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
