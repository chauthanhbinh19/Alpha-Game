...
public class UserFashionsController : MonoBehaviour
{
    ...
    public void CreateUserFashions(List<Fashions> fashions, Transform contentPanel)
    {
        ...
        foreach (var fashion in fashions)
        {
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(fashion.Rarity));
            rareText.text = fashion.Rarity;
    ...
    public void ShowFashionDetails(Fashions fashion, int buttonType = 1)
    {
        ...
        closeButton.onClick.AddListener(async () =>
        {
            ...
            await MainMenuManager.Instance.GetTypeAsync(AppConstants.MainType.FASHION);
        });
    ...
    public void BindButton(Fashions fashion, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StarController.Instance.CreateStarPanel(fashion, MAX_LEVEL, level => Math.Max(level, 1) * 2d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            ModuleManager.Instance.CreateModule(fashion);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            UpgradeManager.Instance.CreateUpgrade(fashion);
        });
    }
