...
public class UserAlchemiesController : MonoBehaviour
{
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is Alchemies alchemy)
        {
            ...
            RawImage alchemyImage = alchemyObject.transform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI alchemyQuantity = alchemyObject.transform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
