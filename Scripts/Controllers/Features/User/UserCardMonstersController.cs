...
public class UserCardMonstersController : MonoBehaviour
{
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardMonsters cardMonster)
        {
            ...
            Transform cardMonsterTransform = cardMonsterObject.transform;

            RawImage cardMonsterImage = cardMonsterTransform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI cardMonsterQuantity = cardMonsterTransform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
