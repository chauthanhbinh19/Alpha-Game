...
public class UserCardMonstersController : MonoBehaviour
{
    ...
    public void CreateUserCardMonsters(List<CardMonsters> cardMonsters, Transform contentPanel)
    {
        ...
        {
            GameObject cardMonsterObject = Instantiate(CardMonsterButtonPrefab, contentPanel);
            ...
            rareBackground.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardMonster.Rarity));
            ...
            if(cardMonster.Team.TeamNumber != 0)
            {
                ...
                teamTitleText.text = LocalizationManager.Get(AppDisplayConstants.MainType.TEAM) + " " + cardMonster.Team.TeamNumber.ToString();
            }
            else
            {
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardMonster.Rarity));
            rareText.text = cardMonster.Rarity;
        }
    ...
    public void CreateUserCardMonstersForSummon(List<CardMonsters> cardMonsters, Transform PositionPanel)
    {
        foreach (var cardMonster in cardMonsters)
        {
            GameObject cardMonsterObject = Instantiate(PositionPrefab, PositionPanel);
            Transform transform = cardMonsterObject.transform;
    ...
    public void ShowCardMonsterDetails(CardMonsters cardMonster, int buttonType = 1)
    {
        ...
        ButtonLoader.Instance.CreateSetButtonGroup(cardMonster, setButtonGroupPanel);
    ...
    public void CreateDetailsUI(CardMonsters cardMonster, GameObject currentObject)
    {
        RefreshDetailsUI(cardMonster, currentObject);

        BindButton(cardMonster, currentObject);
    }
    public void RefreshDetailsUI(CardMonsters cardMonster, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        TextureHelper.SetupStars(starGridLayout, cardMonster.Star);
        ...
        mainClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardMonster.Class.MainImage));
        subClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardMonster.Class.SubImage));
        mainClassText.text = cardMonster.Class.MainType;
        subClassText.text = cardMonster.Class.SubType;

        SetupStat(transform, "Health", AppConstants.StatFields.HEALTH, AppDisplayConstants.StatFieldsShort.HEALTH, cardMonster.Health);
        SetupStat(transform, "PhysicalAttack", AppConstants.StatFields.PHYSICAL_ATTACK, AppDisplayConstants.StatFieldsShort.PHYSICAL_ATTACK, cardMonster.PhysicalAttack);
        SetupStat(transform, "PhysicalDefense", AppConstants.StatFields.PHYSICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.PHYSICAL_DEFENSE, cardMonster.PhysicalDefense);
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, cardMonster.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, cardMonster.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, cardMonster.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, cardMonster.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, cardMonster.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, cardMonster.AtomicDefense);
        SetupStat(transform, "MentalAttack", AppConstants.StatFields.MENTAL_ATTACK, AppDisplayConstants.StatFieldsShort.MENTAL_ATTACK, cardMonster.MentalAttack);
        SetupStat(transform, "MentalDefense", AppConstants.StatFields.MENTAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MENTAL_DEFENSE, cardMonster.MentalDefense);
        SetupStat(transform, "Speed", AppConstants.StatFields.SPEED, AppDisplayConstants.StatFieldsShort.SPEED, cardMonster.Speed);
    }
    public void BindButton(CardMonsters cardMonster, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StatsManager.Instance.CreateStatsManager(cardMonster);
        });
        ...
        upgradeLevelButton.onClick.AddListener(async () =>
        {
            ...
            LevelController.Instance.CreateLevelPanel(cardMonster, itemExperienceDTO, MAX_LEVEL, level => Math.Max(level, 1) * 500d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StarController.Instance.CreateStarPanel(cardMonster, MAX_LEVEL, level => Math.Max(level, 1) * 2d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            ModuleManager.Instance.CreateModule(cardMonster);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            UpgradeManager.Instance.CreateUpgrade(cardMonster);
        });
    }
    public void RefreshCurrentDetailsUI(CardMonsters cardMonster)
    {
    ...
    public async Task GetSkillsAsync(object obj, GameObject currentObject)
    {
        ...
        {
            var skills = await UserSkillsService.Create().GetUserCardMonstersSkillsAsync(User.CurrentUserId, cardMonster.Id);
            ...
            {
                AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                await CreateSkillPanelAsync(cardMonster.Id);
            });
        }
    }
    public async Task CreateSkillPanelAsync(string cardId)
    {
        ...
        var skills = await UserSkillsService.Create().GetUserCardMonstersSkillsAsync(User.CurrentUserId, cardId);
    ...
    public async Task CreateSkillPopupAsync(int position, string cardId, string type, string skillType, Skills oldSkill = null)
    {
        ...
        foreach (var skill in skills)
        {
            ...
            equipButton.onClick.AddListener(async () =>
            {
                ...
                if (oldSkill != null)
                {
                    await UserSkillsService.Create().DeleteUserCardMonsterSkillsAsync(User.CurrentUserId, cardId, oldSkill.Id, position);
                    await UserSkillsService.Create().InsertUserCardMonsterSkillsAsync(User.CurrentUserId, cardId, skill.Id, position);
                }
                else
                {
                    await UserSkillsService.Create().InsertUserCardMonsterSkillsAsync(User.CurrentUserId, cardId, skill.Id, position);
    ...
    public void CreatePopupSkillDetail(int position, string cardId, string type, string skillType, Skills skill)
    {
        ...
        removeButton.onClick.AddListener(async () =>
        {
            ...
            Destroy(popupSkillDetailObject);
            Destroy(skillPanelObject);
            await UserSkillsService.Create().DeleteUserCardMonsterSkillsAsync(User.CurrentUserId, cardId, skill.Id, position);
            await CreateSkillPanelAsync(cardId);
        });
    ...
    public async Task GetSpiritBeastAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardMonsters cardMonster)
        {
            var userCardSpiritBeast = await UserSpiritBeastsService.Create().GetUserCardMonsterSpiritBeastAsync(User.CurrentUserId, cardMonster);
            ...
            {
                AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                await UserSpiritBeastsService.Create().DeleteUserCardMonsterSpiritBeastAsync(User.CurrentUserId, cardMonster, userCardSpiritBeast);
                string fileNameWithoutExtension = "UI/Background4/Background_V4_352";
                Texture texture = TextureHelper.LoadTextureCached($"{fileNameWithoutExtension}");
                spiritBeastImage.texture = texture;

                var card = await UserCardMonstersService.Create().GetUserCardMonsterByIdAsync(User.CurrentUserId, cardMonster.Id);
                ShowCardMonsterDetails(card, 5);
            });
        }
    }
    public async Task CreatePopupEquipmentsAsync(object data, GameObject currentObject, string statusToggle = "NOT EQUIP")
    {
        ...
        spiritBeasts = await UserSpiritBeastsService.Create().GetAllUserCardMonstersSpiritBeastAsync(User.CurrentUserId, PAGE_SIZE, offset, statusToggle);
    ...
    public void CreatePopupEquipmentsUI(object data, List<SpiritBeasts> spiritBeasts, Transform content, GameObject currentObject)
    {
        foreach (var spiritBeast in spiritBeasts)
        {
            ...
            equipButton.onClick.AddListener(async () =>
            {
                AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                Destroy(popupSpiritBeastObject);
                if (data is CardMonsters cardMonster)
                {
                    await UserSpiritBeastsService.Create().InsertOrUpdateUserCardMonsterSpiritBeastAsync(User.CurrentUserId, cardMonster, spiritBeast);
    ...
    public async Task ChangeNextPageAsync(object data, Text PageText, Transform content, GameObject currentObject)
    {
        if (currentPage < totalPage)
        {
            ...
            List<SpiritBeasts> spiritBeasts = await UserSpiritBeastsService.Create().GetAllUserCardMonstersSpiritBeastAsync(User.CurrentUserId, PAGE_SIZE, offset, statusToggle);
