...
public class UserCardMilitaryController : MonoBehaviour
{
    ...
    public void CreateUserCardMilitary(List<CardMilitary> militaryList, Transform DictionaryContentPanel)
    {
    ...
    public void CreateUserCardMilitaryForSummon(List<CardMilitary> militaries, Transform PositionPanel)
    {
    ...
    public void ShowCardMilitaryDetails(CardMilitary cardMilitary, GameObject currentObject, int buttonType = 1)
    {
        ...
        {
            GetMasterOfBeast(cardMilitary, currentObject);
        ...
        {
            GetMasterOfDragon(cardMilitary, currentObject);
        ...
        {
            GetMasterOfMagic(cardMilitary, currentObject);
        ...
        {
            GetMasterOfMusic(cardMilitary, currentObject);
        ...
        {
            GetMasterOfScience(cardMilitary, currentObject);
        ...
        {
            GetMasterOfSpirit(cardMilitary, currentObject);
        ...
        {
            GetMasterOfWeapon(cardMilitary, currentObject);
        ...
        {
            GetMasterOfChemical(cardMilitary, currentObject);
        ...
        {
            GetMasterOfPhysical(cardMilitary, currentObject);
        ...
        {
            GetMasterOfAtomic(cardMilitary, currentObject);
        ...
        {
            GetMasterOfMental(cardMilitary, currentObject);
    ...
    public void CreateDetailsUI(CardMilitary cardMilitary, GameObject currentObject)
    {
