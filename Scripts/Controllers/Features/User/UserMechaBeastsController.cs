...
public class UserMechaBeastsController : MonoBehaviour
{
    ...
    public void CreateUserMechaBeasts(List<MechaBeasts> mechaBeasts, Transform contentPanel)
    {
        foreach (var mechaBeast in mechaBeasts)
        {
            ...
            backgroundImage.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.MECHA_BEAST_BUTTON_BACKGROUND_URL);
    ...
    public void ShowMechaBeastDetails(MechaBeasts MechaBeasts, GameObject currentObject, int buttonType = 1)
    {
        ...
        {
            GetDetails(MechaBeasts, currentObject);
        ...
        switch (buttonType)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                GetSkills(MechaBeasts, currentObject);
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is MechaBeasts title)
        {
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                bool hasEnoughMechaBeasts = title.Quantity >= requiredQuantity;
                ...
                if (hasEnoughMechaBeasts || hasEnoughItems)
                {
