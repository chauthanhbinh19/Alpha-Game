...
public class UserCardGeneralsController : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        CardGeneralButtonPrefab = UIManager.Instance.Get(AppConstants.Prefab.Component.CARD_GENERAL_BUTTON_PREFAB);
    ...
    public void CreateUserCardGenerals(List<CardGenerals> cardGenerals, Transform contentPanel)
    {
        ...
        foreach (var cardGeneral in cardGenerals)
        {
            ...
            cardText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_GENERAL);
            ...
            rareBackground.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardGeneral.Rarity));
            ...
            if(cardGeneral.Team.TeamNumber != 0)
            {
                ...
                teamTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TEAM) + " " + cardGeneral.Team.TeamNumber.ToString();
            }
            else
            {
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(cardGeneral.Rarity));
            rareText.text = cardGeneral.Rarity;
        }
    ...
    public void ShowCardGeneralDetails(CardGenerals cardGeneral, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_GENERAL);
        Texture texture = TextureHelper.LoadTextureCached(ImageConstants.Background.CARD_GENERAL_BACKGROUND_URL);
        cardBackground.texture = texture;
        closeButton.onClick.AddListener(async () =>
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            Destroy(currentObject);
            await MainMenuManager.Instance.GetTypeAsync(AppConstants.MainType.CARD_GENERAL);
        });
    ...
    {
        RefreshDetailsUI(cardGeneral, currentObject);

        BindButton(cardGeneral, currentObject);
    }
    public void RefreshDetailsUI(CardGenerals cardGeneral, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        TextureHelper.SetupStars(starGridLayout, cardGeneral.Star);
        ...
        mainClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardGeneral.Class.MainImage));
        subClassImage.texture = TextureHelper.LoadTexture2DCached(ImageHelper.RemoveImageExtension(cardGeneral.Class.SubImage));
        mainClassText.text = cardGeneral.Class.MainType;
        subClassText.text = cardGeneral.Class.SubType;

        SetupStat(transform, "Health", AppConstants.StatFields.HEALTH, AppDisplayConstants.StatFieldsShort.HEALTH, cardGeneral.Health);
        SetupStat(transform, "PhysicalAttack", AppConstants.StatFields.PHYSICAL_ATTACK, AppDisplayConstants.StatFieldsShort.PHYSICAL_ATTACK, cardGeneral.PhysicalAttack);
        SetupStat(transform, "PhysicalDefense", AppConstants.StatFields.PHYSICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.PHYSICAL_DEFENSE, cardGeneral.PhysicalDefense);
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, cardGeneral.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, cardGeneral.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, cardGeneral.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, cardGeneral.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, cardGeneral.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, cardGeneral.AtomicDefense);
        SetupStat(transform, "MentalAttack", AppConstants.StatFields.MENTAL_ATTACK, AppDisplayConstants.StatFieldsShort.MENTAL_ATTACK, cardGeneral.MentalAttack);
        SetupStat(transform, "MentalDefense", AppConstants.StatFields.MENTAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MENTAL_DEFENSE, cardGeneral.MentalDefense);
        SetupStat(transform, "Speed", AppConstants.StatFields.SPEED, AppDisplayConstants.StatFieldsShort.SPEED, cardGeneral.Speed);
    }
    public void BindButton(CardGenerals cardGeneral, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StatsManager.Instance.CreateStatsManager(cardGeneral);
        });
        ...
        upgradeLevelButton.onClick.AddListener(async () =>
        {
            ...
            LevelController.Instance.CreateLevelPanel(cardGeneral, itemExperienceDTO, MAX_LEVEL, level => Math.Max(level, 1) * 500d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StarController.Instance.CreateStarPanel(cardGeneral, MAX_LEVEL, level => Math.Max(level, 1) * 2d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            ModuleManager.Instance.CreateModule(cardGeneral);
        });
