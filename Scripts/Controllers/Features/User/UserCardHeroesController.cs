...
public class UserCardHeroesController : MonoBehaviour
{
    ...
    public void CreateUserCardHeroes(List<CardHeroes> cards, Transform contentPanel)
    {
    ...
    public void GetLevel(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardHeroes cardHeroes)
        {
            ...
            items = userItemsService.GetItemForLevel(AppConstants.MainType.CARD_HERO);
    ...
    public void GetUpgrade(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardHeroes cardHeroes)
        {
            ...
            List<Items> items = new List<Items>();
            items = UserItemsService.Create().GetItemForBreakthourgh(AppConstants.MainType.CARD_HERO);
