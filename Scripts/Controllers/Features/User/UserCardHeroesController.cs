...
public class UserCardHeroesController : MonoBehaviour
{
    ...
    public void ShowCardHeroesDetails(CardHeroes cardHeroes, GameObject currentObject, int buttonType = 1)
    {
        ...
        {
            GetMasterOfBeast(cardHeroes, currentObject);
        ...
        {
            GetMasterOfDragon(cardHeroes, currentObject);
        ...
        {
            GetMasterOfMagic(cardHeroes, currentObject);
        ...
        {
            GetMasterOfMusic(cardHeroes, currentObject);
        ...
        {
            GetMasterOfScience(cardHeroes, currentObject);
        ...
        {
            GetMasterOfSpirit(cardHeroes, currentObject);
        ...
        {
            GetMasterOfWeapon(cardHeroes, currentObject);
        ...
        {
            GetMasterOfChemical(cardHeroes, currentObject);
        ...
        {
            GetMasterOfPhysical(cardHeroes, currentObject);
        ...
        {
            GetMasterOfAtomic(cardHeroes, currentObject);
        ...
        {
            GetMasterOfMental(cardHeroes, currentObject);
    ...
    public void CreateDetailsUI(CardHeroes cardHeroes, GameObject currentObject)
    {
        ...
        power.text = NumberFormatter.FormatNumber(cardHeroes.all_power, false);
    ...
    public void CreatePopupSkillDetail(int position, string cardId, string type, string skillType, Skills skill)
    {
        ...
        closeButton.onClick.AddListener(() => { Destroy(popupSkillDetailObject); });
    ...
    public void GetSpiritBeast(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardHeroes cardHeroes)
        {
            ...
            removeButton.onClick.AddListener(() =>
            {
                UserSpiritBeastService.Create().DeleteUserCardHeroesSpiritBeast(User.CurrentUserId, cardHeroes, userCardSpiritBeast);
    ...
    public void CreatePopupEquipmentsUI(object data, List<SpiritBeast> spiritBeasts, Transform content, GameObject currentObject)
    {
        foreach (var spiritBeast in spiritBeasts)
        {
            ...
            EquipButton.onClick.AddListener(() =>
            {
                ...
                {
                    double currentPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    UserSpiritBeastService.Create().InsertOrUpdateUserCardHeroesSpiritBeast(User.CurrentUserId, cardHeroes, spiritBeast);
