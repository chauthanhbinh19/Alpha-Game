...
public class UserRobotsController : MonoBehaviour
{
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is Robots robot)
        {
            ...
            RawImage robotImage = robotTransform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI robotQuantity = robotTransform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
