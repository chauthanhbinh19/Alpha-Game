...
public class UserFoodsController : MonoBehaviour
{
    public static UserFoodsController Instance { get; private set; }
    ...
    public void Initialize()
    {
        ...
        FoodButtonPrefab = UIManager.Instance.Get(AppConstants.Prefab.Component.FOOD_BUTTON_PREFAB);
        MainMenuDetailPanel2Prefab = UIManager.Instance.Get(AppConstants.Prefab.General.MAIN_MENU_DETAIL_PANEL_2_PREFAB);
    }
    public void CreateUserFoods(List<Foods> foods, Transform contentPanel)
    {
        ...
        foreach (var food in foods)
        {
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(food.Rarity));
            rareText.text = food.Rarity;
        }
    ...
    public void ShowFoodDetails(Foods food, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.FOOD);
    ...
    public void RefreshDetailsUI(Foods food, GameObject currentObject)
    {
        ...
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, food.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, food.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, food.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, food.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, food.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, food.AtomicDefense);
    ...
    public void BindButton(Foods food, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StarController.Instance.CreateStarPanel(food, MAX_LEVEL, level => Math.Max(level, 1) * 2d);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            ModuleManager.Instance.CreateModule(food);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            UpgradeManager.Instance.CreateUpgrade(food);
        });
    }
