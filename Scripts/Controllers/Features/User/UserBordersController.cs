...
public class UserBordersController : MonoBehaviour
{
    public static UserBordersController Instance { get; private set; }
    ...
    public void CreateUserBorders(List<Borders> borders, Transform contentPanel)
    {
        ...
        foreach (var border in borders)
        {
            ...
            Transform transform = borderObject.transform;
            ...
            rareText.color = ColorHelper.HexToColor(QualityEvaluatorHelper.CheckRareColor(border.Rarity));
            rareText.text = border.Rarity;
        }
    ...
    public void ShowBorderDetails(Borders border, int buttonType = 1)
    {
        ...
        closeButton.onClick.AddListener(async () =>
        {
            ...
            await MainMenuManager.Instance.GetTypeAsync(AppConstants.MainType.BORDER);
        });
        TempCurrentObject = currentObject;
        CreateDetailsUI(border, currentObject);
    }
    public void CreateDetailsUI(Borders border, GameObject currentObject)
    {
        RefreshDetailsUI(border, currentObject);

        BindButton(border, currentObject);
    }
    public void RefreshDetailsUI(Borders border, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        levelText.text = border.Level.ToString();
        ...
        TextureHelper.SetupStars(starGridLayout, border.Star);
        ...
        SetupStat(transform, "Health", AppConstants.StatFields.HEALTH, AppDisplayConstants.StatFieldsShort.HEALTH, border.Health);
        SetupStat(transform, "PhysicalAttack", AppConstants.StatFields.PHYSICAL_ATTACK, AppDisplayConstants.StatFieldsShort.PHYSICAL_ATTACK, border.PhysicalAttack);
        SetupStat(transform, "PhysicalDefense", AppConstants.StatFields.PHYSICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.PHYSICAL_DEFENSE, border.PhysicalDefense);
        SetupStat(transform, "MagicalAttack", AppConstants.StatFields.MAGICAL_ATTACK, AppDisplayConstants.StatFieldsShort.MAGICAL_ATTACK, border.MagicalAttack);
        SetupStat(transform, "MagicalDefense", AppConstants.StatFields.MAGICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MAGICAL_DEFENSE, border.MagicalDefense);
        SetupStat(transform, "ChemicalAttack", AppConstants.StatFields.CHEMICAL_ATTACK, AppDisplayConstants.StatFieldsShort.CHEMICAL_ATTACK, border.ChemicalAttack);
        SetupStat(transform, "ChemicalDefense", AppConstants.StatFields.CHEMICAL_DEFENSE, AppDisplayConstants.StatFieldsShort.CHEMICAL_DEFENSE, border.ChemicalDefense);
        SetupStat(transform, "AtomicAttack", AppConstants.StatFields.ATOMIC_ATTACK, AppDisplayConstants.StatFieldsShort.ATOMIC_ATTACK, border.AtomicAttack);
        SetupStat(transform, "AtomicDefense", AppConstants.StatFields.ATOMIC_DEFENSE, AppDisplayConstants.StatFieldsShort.ATOMIC_DEFENSE, border.AtomicDefense);
        SetupStat(transform, "MentalAttack", AppConstants.StatFields.MENTAL_ATTACK, AppDisplayConstants.StatFieldsShort.MENTAL_ATTACK, border.MentalAttack);
        SetupStat(transform, "MentalDefense", AppConstants.StatFields.MENTAL_DEFENSE, AppDisplayConstants.StatFieldsShort.MENTAL_DEFENSE, border.MentalDefense);
        SetupStat(transform, "Speed", AppConstants.StatFields.SPEED, AppDisplayConstants.StatFieldsShort.SPEED, border.Speed);
    }
    public void BindButton(Borders border, GameObject currentObject)
    {
        Transform transform = currentObject.transform;
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            StatsManager.Instance.CreateStatsManager(border);
        });
