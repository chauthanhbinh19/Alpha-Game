...
public class UserCardColonelsController : MonoBehaviour
{
    ...
    public void CreateUserCardColonels(List<CardColonels> cardColonels, Transform contentPanel)
    {
        ...
        foreach (var cardColonel in cardColonels)
        {
            ...
            cardText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_COLONEL);
            ...
            if(cardColonel.Team.TeamNumber != 0)
            {
                ...
                teamTitleText.text = LocalizationManager.Get(AppDisplayConstants.Title.TEAM) + " " + cardColonel.Team.TeamNumber.ToString();
            }
            else
            {
    ...
    public void ShowCardColonelDetails(CardColonels cardColonel, int buttonType = 1)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Title.CARD_COLONEL);
    ...
    public void BindButton(CardColonels cardColonel, GameObject currentObject)
    {
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            RankManager.Instance.CreateRank(cardColonel);
        });
        ...
        {
            AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
            await MainMenuEquipmentManager.Instance.CreateMainMenuEquipmentManagerAsync(cardColonel);
        });
    }
