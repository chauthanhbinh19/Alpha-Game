...
public class UserPuppetController : MonoBehaviour
{
    public static UserPuppetController Instance { get; private set; }
    ...
    public void CreateUserPuppet(List<Puppet> puppets, Transform DictionaryContentPanel)
    {
        foreach (var puppet in puppets)
        {
            ...
            // Gán sự kiện click
            ButtonEvent.Instance.AddClickListener(eventTrigger, () => FindObjectOfType<MainMenuDetailsManager>().PopupDetails(puppet, MainPanel));
    ...
    public void GetLevel(object obj, GameObject currentObject)
    {
        ...
        if (obj is Puppet puppet)
        {
            ...
            items = userItemsService.GetItemForLevel("Puppet");
    ...
    public void GetUpgrade(object obj, GameObject currentObject)
    {
        ...
        if (obj is Puppet puppet)
        {
            ...
            Items item = new Items();
            List<Items> items = new List<Items>();
            items = userItemsService.GetItemForBreakthourgh("Puppet");
