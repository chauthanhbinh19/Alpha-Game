...
public class UserBadgesController : MonoBehaviour
{
    ...
    public async Task GetLevelAsync(object obj, GameObject currentObject)
    {
        ...
        {
            PropertyInfo[] properties = badge.GetType().GetProperties();
            UIManager.Instance.CreatePropertyLevelUI(properties, badge, INCREASE_PER_LEVEL, currentObject);
            ...
            up1LevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    newBadge = await UnitLevelHelper.GetNewLevelPowerAsync(badge, INCREASE_PER_LEVEL);
            ...
            upMaxLevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    Badges newBadge = await UnitLevelHelper.GetNewLevelPowerAsync(badge, levelsGained * INCREASE_PER_LEVEL);
        ...
        if (obj is Badges badge)
        {
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                if (hasEnoughBadge || hasEnoughItem)
                {
                    ...
                    newBadge = await UnitBreakthroughHelper.GetNewBreakthroughPowerAsync(badge, INCREASE_PER_UPGRADE);
