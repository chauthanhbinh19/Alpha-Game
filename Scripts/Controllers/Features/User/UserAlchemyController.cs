...
public class UserAlchemyController : MonoBehaviour
{
    public static UserAlchemyController Instance { get; private set; }
    ...
    public void CreateUserAlchemy(List<Alchemy> alchemies, Transform DictionaryContentPanel)
    {
        foreach (var alchemy in alchemies)
        {
            ...
            // Gán sự kiện click
            ButtonEvent.Instance.AddClickListener(eventTrigger, () => FindObjectOfType<MainMenuDetailsManager>().PopupDetails(alchemy, MainPanel));
    ...
    public void ShowAlchemyDetails(Alchemy alchemy, GameObject currentObject)
    {
        ...
        {
            GetLevel(alchemy, currentObject);
            ButtonLoader.Instance.OnButtonClicked("Button_2", RightButtonContent);
        });
        ButtonEvent.Instance.AssignButtonEvent("Button_4", RightButtonContent, () =>
        {
            GetUpgrade(alchemy, currentObject);
    ...
    public void GetLevel(object obj, GameObject currentObject)
    {
        ...
        if (obj is Alchemy alchemy)
        {
            ...
            items = userItemsService.GetItemForLevel("Alchemy");
    ...
    public void GetUpgrade(object obj, GameObject currentObject)
    {
        ...
        if (obj is Alchemy alchemy)
        {
            ...
            Items item = new Items();
            List<Items> items = new List<Items>();
            items = userItemsService.GetItemForBreakthourgh("Alchemy");
