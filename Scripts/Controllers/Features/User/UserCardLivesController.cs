...
public class UserCardLivesController : MonoBehaviour
{
    ...
    public void CreateUserCardLives(List<CardLives> cardLives, Transform contentPanel)
    {
        ...
        foreach (var cardLife in cardLives)
        {
            ...
            button.onClick.AddListener(() =>
            {
                ...
                MainMenuDetailsManager.Instance.PopupDetails(cardLife, MainPanel);
            });
        }
    ...
    public void ShowCardLifeDetails(CardLives cardLife, GameObject currentObject, int buttonType = 1)
    {
        ...
        {
            _ = GetLevelAsync(cardLife, currentObject);
            ButtonLoader.Instance.OnButtonClicked("Button_2", RightButtonContent);
        });
        ButtonEvent.Instance.AssignButtonEvent("Button_4", RightButtonContent, () =>
        {
            _ = GetUpgradeAsync(cardLife, currentObject);
    ...
    public async Task GetLevelAsync(object obj, GameObject currentObject)
    {
        ...
        {
            PropertyInfo[] properties = cardLife.GetType().GetProperties();
            UIManager.Instance.CreatePropertyLevelUI(properties, cardLife, INCREASE_PER_LEVEL, currentObject);
            ...
            up1LevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    newCardLife = await UnitLevelHelper.GetNewLevelPowerAsync(cardLife, INCREASE_PER_LEVEL);
            ...
            upMaxLevelButton.onClick.AddListener(async () =>
            {
                ...
                if (canLevel)
                {
                    ...
                    CardLives newCardLife = await UnitLevelHelper.GetNewLevelPowerAsync(cardLife, levelsGained * INCREASE_PER_LEVEL);
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is CardLives cardLife)
        {
            ...
            TextMeshProUGUI cardLifeQuantity = cardLifeTransform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                if (hasEnoughCardLife || hasEnoughItem)
                {
                    ...
                    newCardLife = await UnitBreakthroughHelper.GetNewBreakthroughPowerAsync(cardLife, INCREASE_PER_UPGRADE);
                    await UserCardLivesService.Create().UpdateCardLifeBreakthroughAsync(newCardLife, cardLife.Star + 1, cardLife.Quantity);
                    double newPower = await teamsService.GetTeamsPowerAsync(User.CurrentUserId);
                    double currentPower = User.CurrentUserPower;
                    User.CurrentUserPower = newPower;
                    FindObjectOfType<PowerController>().ShowPower(currentPower, newPower - currentPower, 1);

                    await CardLivesGalleryService.Create().UpdateStarCardLifeGalleryAsync(cardLife.Id, cardLife.Star + 1);
