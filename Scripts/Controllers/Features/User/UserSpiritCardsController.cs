...
public class UserSpiritCardsController : MonoBehaviour
{
    ...
    public void CreateUserSpiritCards(List<SpiritCards> spiritCards, Transform contentPanel)
    {
        foreach (var spiritCard in spiritCards)
        {
            ...
            backgroundImage.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.SPIRIT_CARD_BUTTON_BACKGROUND_URL);
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is SpiritCards spiritBeast)
        {
            ...
            RawImage spiritCardImage = spiritCardObject.transform.Find("MaterialImage").GetComponent<RawImage>();
            ...
            TextMeshProUGUI spiritCardQuantity = spiritCardObject.transform.Find("QuantityText").GetComponent<TextMeshProUGUI>();
