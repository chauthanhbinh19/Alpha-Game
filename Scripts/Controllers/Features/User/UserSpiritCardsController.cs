    ...
    public async Task GetLevelAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is SpiritCards title)
        {
            ...
            up1LevelButton.onClick.AddListener(async () =>
            {
                ...
                currentCard = await UserSpiritCardsService.Create().GetUserSpiritCardByIdAsync(User.CurrentUserId, title.Id);
            ...
            {
                AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                SpiritCards currentCard = await UserSpiritCardsService.Create().GetUserSpiritCardByIdAsync(User.CurrentUserId, title.Id);
                double totalExperiment = currentCard.Experiment;
                int currentLevel = currentCard.Level;
    ...
    public async Task GetUpgradeAsync(object obj, GameObject currentObject)
    {
        ...
        if (obj is SpiritCards spiritBeast)
        {
            ...
            breakthroughButton.onClick.AddListener(async () =>
            {
                ...
                if (hasEnoughSpiritCard || hasEnoughItems)
                {
