...
public class UserForgeController : MonoBehaviour
{
    public static UserForgeController Instance { get; private set; }
    ...
    public void CreateUserForge(List<Forge> forges, Transform DictionaryContentPanel)
    {
        foreach (var forge in forges)
        {
            ...
            // Gán sự kiện click
            ButtonEvent.Instance.AddClickListener(eventTrigger, () => FindObjectOfType<MainMenuDetailsManager>().PopupDetails(forge, MainPanel));
    ...
    public void GetLevel(object obj, GameObject currentObject)
    {
        ...
        if (obj is Forge forge)
        {
            ...
            items = userItemsService.GetItemForLevel("Forge");
    ...
    public void GetUpgrade(object obj, GameObject currentObject)
    {
        ...
        if (obj is Forge forge)
        {
            ...
            Items item = new Items();
            List<Items> items = new List<Items>();
            items = userItemsService.GetItemForBreakthourgh("Forge");
