...
public class DimensionalManager : MonoBehaviour
{
    ...
    public async Task CreateDimensionalManagerAsync()
    {
    ...
    public async Task CreateMainResearchPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.Research.DIMENSIONAL}");
