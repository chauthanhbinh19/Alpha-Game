...
{
    public static SurveillanceManager Instance { get; private set; }
    ...
    public async Task CreateSurveillanceManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.SURVEILLANCE);
