...
public class BiotechManager : MonoBehaviour
{
    public static BiotechManager Instance { get; private set; }
    ...
    public async Task CreateBiotechManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.BIOTECH);
    ...
    public async Task CreateMainResearchPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.Research.BIOTECH}");
