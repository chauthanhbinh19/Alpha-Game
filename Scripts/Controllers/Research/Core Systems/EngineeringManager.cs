...
public class EngineeringManager : MonoBehaviour
{
    public static EngineeringManager Instance { get; private set; }
    ...
    public async Task CreateEngineeringManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.ENGINEERING);
    ...
    public async Task CreateMainResearchPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.Research.ENGINEERING}");
