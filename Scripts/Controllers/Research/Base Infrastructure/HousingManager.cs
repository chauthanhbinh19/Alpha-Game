...
public class HousingManager : MonoBehaviour
{
    ...
    private TextMeshProUGUI pageText;    private void Awake()
    {
    ...
    public async Task CreateHousingManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.HOUSING);
