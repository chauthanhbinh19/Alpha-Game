...
public class InfrastructureManager : MonoBehaviour
{
    ...
    public async Task CreateInfrastructureManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.INFRASTRUCTURE);
    ...
    public async Task CreateMainResearchPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = TextureHelper.LoadTexture2DCached($"UI/Rank_Research/{AppConstants.Research.INFRASTRUCTURE}");
