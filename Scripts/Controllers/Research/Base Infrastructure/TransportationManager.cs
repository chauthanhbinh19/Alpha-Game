...
{
    public static TransportationManager Instance { get; private set; }
    ...
    public async Task CreateTransportationManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetResearchFeaturesByTypeAsync(AppConstants.Research.TRANSPORTATION);
