...
public class SSWNXIManager : MonoBehaviour
{
    public static SSWNXIManager Instance { get; private set; }
    ...
    public async Task CreateSSWNXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetSSWNFeaturesByTypeAsync(AppConstants.SSWN.SSWN_XI);
    ...
    public async Task CreateMainSSWNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.SSWN.SSWN_XI}");
