...
public class SSWNXIIManager : MonoBehaviour
{
    public static SSWNXIIManager Instance { get; private set; }
    ...
    public async Task CreateSSWNXIIManagerAsync()
    {
    ...
    public async Task CreateMainSSWNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.SSWN.SSWN_XII}");
