...
public class MainMenuBloodlineManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuBloodlineManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.BLOODLINE);
        parentType = AppConstants.MainMenuSet1.BLOODLINE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_59_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.BLOODLINE);
