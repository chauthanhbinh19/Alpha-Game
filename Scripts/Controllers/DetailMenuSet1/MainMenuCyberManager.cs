...
public class MainMenuCyberManager : MonoBehaviour
{
    ...
    public void CreateMainMenuCyberManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Cyber.ToLower());
        parentType = AppConstants.Cyber;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Cyber);
