...
public class MainMenuBowManager : MonoBehaviour
{
    ...
    public void CreateMainMenuBowManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Bow.ToLower());
        parentType = AppConstants.Bow;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Bow);
