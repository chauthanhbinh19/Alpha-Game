...
public class MainMenuBowManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuBowPanelPrefab = UIManager.Instance.GetGameObjectMainMenu1("MainMenuBowPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu1("BowSlotPrefab");
    ...
    public void CreateMainMenuBowManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.BOW);
        parentType = AppConstants.MainMenuSet1.BOW;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet1.BOW);
