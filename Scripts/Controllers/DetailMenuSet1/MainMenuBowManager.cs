...
public class MainMenuBowManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuBowManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_60_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.BOW);
