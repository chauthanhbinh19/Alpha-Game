...
public class MainMenuOmnipresenceManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainMenuOmnipresencePanelPrefab = UIManager.Instance.GetGameObjectMainMenu1("MainMenuOmnipresencePanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu1("OmnipresenceSlotPrefab");
    }
    ...
    public void CreateMainMenuOmnipresenceManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Omnipresence.ToLower());
        parentType = AppConstants.Omnipresence;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Omnipresence);
