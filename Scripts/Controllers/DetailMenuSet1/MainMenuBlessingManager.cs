...
public class MainMenuBlessingManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuBlessingManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_56_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.BLESSING);
