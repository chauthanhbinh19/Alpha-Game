...
public class MainMenuAngelManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAngelManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.ANGEL);
        parentType = AppConstants.MainMenuSet1.ANGEL;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_54_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.ANGEL);
