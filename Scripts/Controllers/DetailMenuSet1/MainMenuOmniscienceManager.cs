...
public class MainMenuOmniscienceManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuOmnisciencePanelPrefab = UIManager.Instance.Get("MainMenuOmnisciencePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OmniscienceSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOmniscienceManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.OMNISCIENCE);
        parentType = AppConstants.MainMenuSet1.OMNISCIENCE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_78_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.OMNISCIENCE);
