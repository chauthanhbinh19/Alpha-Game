...
public class MainMenuOmnivisionManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuOmnivisionPanelPrefab = UIManager.Instance.Get("MainMenuOmnivisionPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OmnivisionSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOmnivisionManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.OMNIVISION);
        parentType = AppConstants.MainMenuSet1.OMNIVISION;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_79_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.OMNIVISION);
