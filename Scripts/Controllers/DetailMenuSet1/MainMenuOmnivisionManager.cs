...
public class MainMenuOmnivisionManager : MonoBehaviour
{
    ...
    public void CreateMainMenuOmnivisionManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Omnivision.ToLower());
        parentType = AppConstants.Omnivision;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Omnivision);
