...
{
    public static MainMenuOmnivoryManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuOmnivoryManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet1.OMNIVORY, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet1.OMNIVORY);
