...
public class MainMenuOmnivoryManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOmnivoryPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuOmnivoryPanelPrefab = UIManager.Instance.Get("MainMenuOmnivoryPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OmnivorySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOmnivoryManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuOmnivoryPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.OMNIVORY);
        parentType = AppConstants.MainMenuSet1.OMNIVORY;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_80_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.OMNIVORY);
