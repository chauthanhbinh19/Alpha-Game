...
public class MainMenuGunManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuGunManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.GUN);
        parentType = AppConstants.MainMenuSet1.GUN;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_65_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.GUN);
