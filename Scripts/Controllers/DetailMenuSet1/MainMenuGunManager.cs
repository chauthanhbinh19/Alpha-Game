...
public class MainMenuGunManager : MonoBehaviour
{
    ...
    public void CreateMainMenuGunManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Gun.ToLower());
        parentType = AppConstants.Gun;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Gun);
