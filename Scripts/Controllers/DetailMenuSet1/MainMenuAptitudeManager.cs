...
public class MainMenuAptitudeManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAptitudeManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.APTITUDE);
        parentType = AppConstants.MainMenuSet1.APTITUDE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_55_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.APTITUDE);
