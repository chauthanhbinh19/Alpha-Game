...
public class MainMenuUpgradeManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuUpgradePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuUpgradePanelPrefab = UIManager.Instance.Get("MainMenuUpgradePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("UpgradeSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuUpgradeManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuUpgradePanelPrefab, MainPanel);
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_86_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.UPGRADE);
