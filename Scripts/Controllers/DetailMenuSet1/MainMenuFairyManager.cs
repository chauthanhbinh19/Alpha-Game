...
public class MainMenuFairyManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuFairyManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.FAIRY);
        parentType = AppConstants.MainMenuSet1.FAIRY;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_64_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.FAIRY);
