...
public class MainMenuFairyManager : MonoBehaviour
{
    ...
    public void CreateMainMenuFairyManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Fairy.ToLower());
        parentType = AppConstants.Fairy;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Fairy);
