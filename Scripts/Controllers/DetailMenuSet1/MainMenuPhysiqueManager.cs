...
public class MainMenuPhysiqueManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuPhysiqueManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.PHYSIQUE);
        parentType = AppConstants.MainMenuSet1.PHYSIQUE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_81_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.PHYSIQUE);
