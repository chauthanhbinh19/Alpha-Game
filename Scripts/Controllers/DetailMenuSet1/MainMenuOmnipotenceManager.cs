...
public class MainMenuOmnipotenceManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuOmnipotencePanelPrefab = UIManager.Instance.Get("MainMenuOmnipotencePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OmnipotenceSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOmnipotenceManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.OMNIPOTENCE);
        parentType = AppConstants.MainMenuSet1.OMNIPOTENCE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_76_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.OMNIPOTENCE);
