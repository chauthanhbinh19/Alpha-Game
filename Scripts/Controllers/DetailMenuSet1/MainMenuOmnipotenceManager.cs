...
public class MainMenuOmnipotenceManager : MonoBehaviour
{
    ...
    public void CreateMainMenuOmnipotenceManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Omnipotence.ToLower());
        parentType = AppConstants.Omnipotence;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Omnipotence);
