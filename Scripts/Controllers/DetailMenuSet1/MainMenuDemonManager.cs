...
public class MainMenuDemonManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDemonPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuDemonPanelPrefab = UIManager.Instance.Get("MainMenuDemonPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("DemonSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuDemonManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuDemonPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.DEMON);
        parentType = AppConstants.MainMenuSet1.DEMON;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_63_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.DEMON);
