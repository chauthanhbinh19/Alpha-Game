...
public class MainMenuShieldManager : MonoBehaviour
{
    ...
    public void CreateMainMenuShieldManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Shield.ToLower());
        parentType = AppConstants.Shield;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Shield);
