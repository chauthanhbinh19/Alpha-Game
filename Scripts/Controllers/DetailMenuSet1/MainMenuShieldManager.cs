...
public class MainMenuShieldManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuShieldPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuShieldPanelPrefab = UIManager.Instance.Get("MainMenuShieldPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ShieldSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuShieldManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuShieldPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet1.SHIELD);
        parentType = AppConstants.MainMenuSet1.SHIELD;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_83_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet1.SHIELD);
