...
public class ArchiveIIIManager : MonoBehaviour
{
    public static ArchiveIIIManager Instance { get; private set; }
    ...
    public async Task CreateArchiveIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetArchiveFeaturesByTypeAsync(AppConstants.Archive.ARCHIVE_III);
    ...
    public async Task CreateMainArchivePanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.Archive.ARCHIVE_III}");
