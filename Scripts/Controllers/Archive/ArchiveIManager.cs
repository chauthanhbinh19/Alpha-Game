...
public class ArchiveIManager : MonoBehaviour
{
    public static ArchiveIManager Instance { get; private set; }
    ...
    public async Task CreateArchiveIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Archive.ARCHIVE_I);
