...
public class ArchiveVIManager : MonoBehaviour
{
    public static ArchiveVIManager Instance { get; private set; }
    ...
    public async Task CreateArchiveVIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetArchiveFeaturesByTypeAsync(AppConstants.Archive.ARCHIVE_VI);
