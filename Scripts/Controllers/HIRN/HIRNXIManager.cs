...
public class HIRNXIManager : MonoBehaviour
{
    public static HIRNXIManager Instance { get; private set; }
    ...
    public async Task CreateHIRNXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIRNFeaturesByTypeAsync(AppConstants.HIRN.HIRN_XI);
    ...
    public async Task CreateMainHIRNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIRN.HIRN_XI}");
