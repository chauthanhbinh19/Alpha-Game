...
public class HIRNXIIIManager : MonoBehaviour
{
    public static HIRNXIIIManager Instance { get; private set; }
    ...
    public async Task CreateHIRNXIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIRNFeaturesByTypeAsync(AppConstants.HIRN.HIRN_XIII);
    ...
    public async Task CreateMainHIRNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIRN.HIRN_XIII}");
