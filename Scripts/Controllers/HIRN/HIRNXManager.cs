...
public class HIRNXManager : MonoBehaviour
{
    ...
    public async Task CreateHIRNXManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.HIRN.HIRN_X);
    ...
    public async Task CreateMainHIRNPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIRN.HIRN_X}");
