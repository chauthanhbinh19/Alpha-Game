...
public class MasterOfPhysicalManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfPhysicalManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MASTER_OF_PHYSICAL);
        parentType = AppConstants.Master.MASTER_OF_PHYSICAL;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_PHYSICAL);
