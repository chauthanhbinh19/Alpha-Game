...
public class MasterOfPhysicalManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfPhysicalManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_PHYSICAL, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_PHYSICAL_BACKGROUND_URL);
