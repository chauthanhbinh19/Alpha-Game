...
public class MasterOfDragonManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfDragonManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_DRAGON, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_DRAGON_BACKGROUND_URL);
