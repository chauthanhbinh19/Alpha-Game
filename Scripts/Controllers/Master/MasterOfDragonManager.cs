...
public class MasterOfDragonManager : MonoBehaviour
{
    ...
    public void CreateMasterOfDragonManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MasterOfDragon);
        parentType = AppConstants.Master.MasterOfDragon;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MasterOfDragon);
