...
public class MasterOfMagicManager : MonoBehaviour
{
    public static MasterOfMagicManager Instance { get; private set; }
    ...
    public async Task CreateMasterOfMagicManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_MAGIC, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_MAGIC_BACKGROUND_URL);
