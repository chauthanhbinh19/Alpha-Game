...
public class MasterOfMagicManager : MonoBehaviour
{
    ...
    private GameObject MasterOfMagicPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MasterOfMagicPanelPrefab = UIManager.Instance.Get("MasterOfMagicPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("MasterOfMagicSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMasterOfMagicManagerAsync(object data)
    {
        currentObject = Instantiate(MasterOfMagicPanelPrefab, MainPanel);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_MAGIC);
