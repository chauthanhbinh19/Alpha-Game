...
public class MasterOfMagicManager : MonoBehaviour
{
    ...
    public void CreateMasterOfMagicManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MasterOfMagic);
        parentType = AppConstants.Master.MasterOfMagic;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MasterOfMagic);
