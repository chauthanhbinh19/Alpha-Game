...
public class MasterOfAtomicManager : MonoBehaviour
{
    public static MasterOfAtomicManager Instance { get; private set; }
    ...
    public async Task CreateMasterOfAtomicManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_ATOMIC, stat);
