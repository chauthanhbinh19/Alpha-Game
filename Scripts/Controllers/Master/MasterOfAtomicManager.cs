...
public class MasterOfAtomicManager : MonoBehaviour
{
    ...
    private GameObject MasterOfAtomicPanelPrefab;
    ...
    public async Task CreateMasterOfAtomicManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MASTER_OF_ATOMIC);
        parentType = AppConstants.Master.MASTER_OF_ATOMIC;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_ATOMIC);
