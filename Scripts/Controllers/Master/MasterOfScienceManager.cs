...
public class MasterOfScienceManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfScienceManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_SCIENCE, stat);
