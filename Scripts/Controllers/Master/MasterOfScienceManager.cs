...
public class MasterOfScienceManager : MonoBehaviour
{
    ...
    public void CreateMasterOfScienceManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MasterOfScience);
        parentType = AppConstants.Master.MasterOfScience;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MasterOfScience);
