...
public class MasterOfBeastManager : MonoBehaviour
{
    ...
    private GameObject MasterOfBeastPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MasterOfBeastPanelPrefab = UIManager.Instance.Get("MasterOfBeastPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("MasterOfBeastSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMasterOfBeastManagerAsync(object data)
    {
        currentObject = Instantiate(MasterOfBeastPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MASTER_OF_BEAST);
        parentType = AppConstants.Master.MASTER_OF_BEAST;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_BEAST);
    ...
    async Task OnButtonClickAsync(GameObject clickedButton, object data, Features subFeature, int requiredLevel)
    {
        ...
        // {
        //     // mainId = cardAdmirals.id;
        //     DetailMasterManager.Instance.CreateEquipmentsEquipments(SlotPrefab, SlotPanel, currentObject, UpLevelButton, UpMaxLevelButton, feature, parentType, equipments);
        //     if (equipments.level >= value)
        //     {
        //         LevelCondition.gameObject.SetActive(false);
        //     }
