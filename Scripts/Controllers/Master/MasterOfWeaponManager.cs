...
public class MasterOfWeaponManager : MonoBehaviour
{
    ...
    private GameObject MasterOfWeaponPanelPrefab;
    ...
    public void CreateMasterOfWeaponManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MasterOfWeapon);
        parentType = AppConstants.Master.MasterOfWeapon;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MasterOfWeapon);
