...
public class MasterOfWeaponManager : MonoBehaviour
{
    public static MasterOfWeaponManager Instance { get; private set; }
    ...
    public async Task CreateMasterOfWeaponManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_WEAPON, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_WEAPON_BACKGROUND_URL);
