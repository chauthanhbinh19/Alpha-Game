...
public class MasterOfMentalManager : MonoBehaviour
{
    public static MasterOfMentalManager Instance { get; private set; }
    ...
    public async Task CreateMasterOfMentalManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_MENTAL, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_MENTAL_BACKGROUND_URL);
