...
public class MasterOfMentalManager : MonoBehaviour
{
    ...
    private GameObject MasterOfMentalPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MasterOfMentalPanelPrefab = UIManager.Instance.GetGameObjectMaster("MasterOfMentalPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMaster("MasterOfMentalSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public void CreateMasterOfMentalManager(object data)
    {
        currentObject = Instantiate(MasterOfMentalPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MASTER_OF_MENTAL);
        parentType = AppConstants.Master.MASTER_OF_MENTAL;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MASTER_OF_MENTAL);
