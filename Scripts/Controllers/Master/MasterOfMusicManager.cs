...
public class MasterOfMusicManager : MonoBehaviour
{
    ...
    public void CreateMasterOfMusicManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MasterOfMusic);
        parentType = AppConstants.Master.MasterOfMusic;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Master.MasterOfMusic);
