...
public class MasterOfMusicManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfMusicManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_MUSIC, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_MUSIC_BACKGROUND_URL);
