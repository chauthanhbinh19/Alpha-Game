...
public class MasterOfSpiritManager : MonoBehaviour
{
    ...
    public async Task CreateMasterOfSpiritManagerAsync(object data)
    {
        currentObject = Instantiate(MasterOfSpiritPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.Master.MASTER_OF_SPIRIT);
        parentType = AppConstants.Master.MASTER_OF_SPIRIT;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_SPIRIT);
