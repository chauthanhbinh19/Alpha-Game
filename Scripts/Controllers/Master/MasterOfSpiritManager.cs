...
public class MasterOfSpiritManager : MonoBehaviour
{
    public static MasterOfSpiritManager Instance { get; private set; }
    ...
    public async Task CreateMasterOfSpiritManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetMasterFeaturesByTypeAsync(AppConstants.Master.MASTER_OF_SPIRIT, stat);
    ...
    public async Task CreateMainMasterPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.Master.MASTER_OF_SPIRIT_BACKGROUND_URL);
