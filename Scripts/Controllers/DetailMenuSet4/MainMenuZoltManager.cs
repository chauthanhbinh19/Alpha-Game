...
public class MainMenuZoltManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuZoltManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.ZOLT);
        parentType = AppConstants.MainMenuSet4.ZOLT;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_155_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.ZOLT);
