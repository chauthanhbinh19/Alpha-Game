...
public class MainMenuZoltManager : MonoBehaviour
{
    ...
    public void CreateMainMenuZoltManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Zolt.ToLower());
        parentType = AppConstants.Zolt;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Zolt);
