...
public class MainMenuBaxxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuBaxxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.BAXX);
        parentType = AppConstants.MainMenuSet4.BAXX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_134_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.BAXX);
