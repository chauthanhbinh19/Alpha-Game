...
public class MainMenuJaxxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuJaxxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.JAXX);
        parentType = AppConstants.MainMenuSet4.JAXX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_139_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.JAXX);
