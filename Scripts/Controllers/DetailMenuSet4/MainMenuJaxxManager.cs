...
public class MainMenuJaxxManager : MonoBehaviour
{
    ...
    public void CreateMainMenuJaxxManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Jaxx.ToLower());
        parentType = AppConstants.Jaxx;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Jaxx);
