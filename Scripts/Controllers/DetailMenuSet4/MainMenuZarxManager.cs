...
public class MainMenuZarxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuZarxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.ZARX);
        parentType = AppConstants.MainMenuSet4.ZARX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_153_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.ZARX);
