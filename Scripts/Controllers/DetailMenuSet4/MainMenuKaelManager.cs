...
public class MainMenuKaelManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuKaelManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.KAEL);
        parentType = AppConstants.MainMenuSet4.KAEL;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_141_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.KAEL);
