...
public class MainMenuHexManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuHexManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.HEX);
        parentType = AppConstants.MainMenuSet4.HEX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_138_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.HEX);
