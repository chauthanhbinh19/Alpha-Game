...
public class MainMenuArosManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuArosManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.AROS);
        parentType = AppConstants.MainMenuSet4.AROS;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_133_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.AROS);
