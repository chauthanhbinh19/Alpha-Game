...
public class MainMenuQuenManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuQuenPanelPrefab = UIManager.Instance.Get("MainMenuQuenPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("QuenSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuQuenManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.QUEN);
        parentType = AppConstants.MainMenuSet4.QUEN;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_146_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.QUEN);
