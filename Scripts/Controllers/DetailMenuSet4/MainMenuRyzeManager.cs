...
public class MainMenuRyzeManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuRyzePanelPrefab = UIManager.Instance.Get("MainMenuRyzePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("RyzeSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuRyzeManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.RYZE);
        parentType = AppConstants.MainMenuSet4.RYZE;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_148_URL);
        ...
        scrollViewBackground.texture = Resources.Load<Texture>(ImageConstants.Background.SCROLLVIEW_BACKGROUND_4_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.RYZE);
    ...
    public void CreateWarningLevelCondition(int requiredLevel)
    {
