...
public class MainMenuRyzeManager : MonoBehaviour
{
    ...
    public void CreateMainMenuRyzeManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Ryze.ToLower());
        parentType = AppConstants.Ryze;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Ryze);
