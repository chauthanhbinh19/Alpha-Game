...
public class MainMenuRaikManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuRaikManagerAsync(object data)
    {
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_147_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.RAIK);
