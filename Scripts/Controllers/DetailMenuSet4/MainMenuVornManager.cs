...
public class MainMenuVornManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuVornManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.VORN);
        parentType = AppConstants.MainMenuSet4.VORN;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_152_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.VORN);
