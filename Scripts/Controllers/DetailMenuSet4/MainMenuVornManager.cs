...
public class MainMenuVornManager : MonoBehaviour
{
    ...
    public void CreateMainMenuVornManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Vorn.ToLower());
        parentType = AppConstants.Vorn;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Vorn);
