...
public class MainMenuLornManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuLornPanelPrefab = UIManager.Instance.Get("MainMenuLornPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("LornSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuLornManagerAsync(object data)
    {
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_143_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.LORN);
