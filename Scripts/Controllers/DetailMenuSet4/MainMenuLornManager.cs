...
public class MainMenuLornManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainMenuLornPanelPrefab = UIManager.Instance.GetGameObjectMainMenu4("MainMenuLornPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu4("LornSlotPrefab");
    }
    ...
    public void CreateMainMenuLornManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Lorn.ToLower());
        parentType = AppConstants.Lorn;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Lorn);
