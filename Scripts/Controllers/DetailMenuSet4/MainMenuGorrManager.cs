...
public class MainMenuGorrManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuGorrManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.GORR);
        parentType = AppConstants.MainMenuSet4.GORR;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_137_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.GORR);
