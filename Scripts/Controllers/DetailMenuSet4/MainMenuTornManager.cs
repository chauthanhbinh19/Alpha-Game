...
{
    public static MainMenuTornManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuTornManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet4.TORN, stat);
