...
public class MainMenuTornManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuTornManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.TORN);
        parentType = AppConstants.MainMenuSet4.TORN;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_150_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.TORN);
