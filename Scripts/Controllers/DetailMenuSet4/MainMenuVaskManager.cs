...
public class MainMenuVaskManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuVaskManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.VASK);
        parentType = AppConstants.MainMenuSet4.VASK;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_151_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.VASK);
