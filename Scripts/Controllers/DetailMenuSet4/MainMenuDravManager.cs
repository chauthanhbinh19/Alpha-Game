...
public class MainMenuDravManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuDravManagerAsync(object data)
    {
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_135_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.DRAV);
