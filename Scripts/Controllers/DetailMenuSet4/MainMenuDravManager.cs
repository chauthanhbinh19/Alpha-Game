...
public class MainMenuDravManager : MonoBehaviour
{
    ...
    public void CreateMainMenuDravManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Drav.ToLower());
        parentType = AppConstants.Drav;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Drav);
