...
public class MainMenuNyxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuNyxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.NYX);
        parentType = AppConstants.MainMenuSet4.NYX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_145_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.NYX);
