...
public class MainMenuZephManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuZephManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.ZEPH);
        parentType = AppConstants.MainMenuSet4.ZEPH;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_154_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.ZEPH);
