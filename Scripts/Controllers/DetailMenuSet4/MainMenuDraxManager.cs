...
public class MainMenuDraxManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuDraxManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.DRAX);
        parentType = AppConstants.MainMenuSet4.DRAX;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_136_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.DRAX);
