...
public class MainMenuKronManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuKronManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.KRON);
        parentType = AppConstants.MainMenuSet4.KRON;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_142_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.KRON);
