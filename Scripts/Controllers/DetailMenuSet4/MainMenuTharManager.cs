...
public class MainMenuTharManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuTharPanelPrefab = UIManager.Instance.Get("MainMenuTharPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("TharSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuTharManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet4.THAR);
        parentType = AppConstants.MainMenuSet4.THAR;
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_149_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet4.THAR);
