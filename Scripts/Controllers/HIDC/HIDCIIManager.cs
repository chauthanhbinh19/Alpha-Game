...
public class HIDCIIManager : MonoBehaviour
{
    public static HIDCIIManager Instance { get; private set; }
    ...
    public async Task CreateHIDCIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIDCFeaturesByTypeAsync(AppConstants.HIDC.HIDC_II);
    ...
    public async Task CreateMainHIDCPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.HIDC.HIDC_II_BACKGROUND_URL);
