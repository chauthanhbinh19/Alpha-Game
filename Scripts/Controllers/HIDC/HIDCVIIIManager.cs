...
public class HIDCVIIIManager : MonoBehaviour
{
    ...
    private GameObject PopupHIDCQuantityPanelPrefab;
    ...
    private List<KeyValuePair<string, FeatureHIDCDTO>> FeatureList;
        ...
        for (int i = start; i < end; i++)
        {
            ...
            if (btn != null)
            {
                ...
                btn.onClick.AddListener(async () =>
                {
                    ...
                    AudioManager.Instance.PlaySFX(AudioConstants.SFX.BUTTON_CLICK_SOUND);
                    await CreateMainHIDCPanelAsync(currentFeatureId, currentSubtype);
                });
            }
        }
    }
    ...
    public async Task CreateMainHIDCPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.HIDC.HIDC_VIII_BACKGROUND_URL);
        ...
        void CreatePopupUpgradePanelAsync()
        {
            GameObject gameObject =
                Instantiate(PopupHIDCQuantityPanelPrefab, MainPanel);
