...
public class MainMenuHelixManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHelixPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuHelixPanelPrefab = UIManager.Instance.Get("MainMenuHelixPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("HelixSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuHelixManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuHelixPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.HELIX);
        parentType = AppConstants.MainMenuSet6.HELIX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.HELIX);
