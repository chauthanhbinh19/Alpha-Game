...
public class MainMenuElysiumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuElysiumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuElysiumPanelPrefab = UIManager.Instance.Get("MainMenuElysiumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ElysiumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuElysiumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuElysiumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.ELYSIUM);
        parentType = AppConstants.MainMenuSet6.ELYSIUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.ELYSIUM);
