...
public class MainMenuObliviumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuObliviumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuObliviumPanelPrefab = UIManager.Instance.Get("MainMenuObliviumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ObliviumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuObliviumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuObliviumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.OBLIVIUM);
        parentType = AppConstants.MainMenuSet6.OBLIVIUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.OBLIVIUM);
