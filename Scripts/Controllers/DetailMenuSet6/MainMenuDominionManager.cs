...
public class MainMenuDominionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuDominionPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuDominionPanelPrefab = UIManager.Instance.Get("MainMenuDominionPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("DominionSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuDominionManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuDominionPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.DOMINION);
        parentType = AppConstants.MainMenuSet6.DOMINION;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.DOMINION);
