...
public class MainMenuEntropyManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuEntropyPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuEntropyPanelPrefab = UIManager.Instance.Get("MainMenuEntropyPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("EntropySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuEntropyManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuEntropyPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.ENTROPY);
        parentType = AppConstants.MainMenuSet6.ENTROPY;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.ENTROPY);
