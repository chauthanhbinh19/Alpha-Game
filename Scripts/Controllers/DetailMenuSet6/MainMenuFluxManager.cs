...
public class MainMenuFluxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuFluxPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuFluxPanelPrefab = UIManager.Instance.Get("MainMenuFluxPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("FluxSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuFluxManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuFluxPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.FLUX);
        parentType = AppConstants.MainMenuSet6.FLUX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.FLUX);
