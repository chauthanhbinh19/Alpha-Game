...
public class MainMenuGenesisManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuGenesisPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuGenesisPanelPrefab = UIManager.Instance.Get("MainMenuGenesisPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("GenesisSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuGenesisManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuGenesisPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.GENESIS);
        parentType = AppConstants.MainMenuSet6.GENESIS;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.GENESIS);
