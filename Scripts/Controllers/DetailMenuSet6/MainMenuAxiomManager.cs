...
public class MainMenuAxiomManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuAxiomPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuAxiomPanelPrefab = UIManager.Instance.Get("MainMenuAxiomPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("AxiomSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuAxiomManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuAxiomPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.AXIOM);
        parentType = AppConstants.MainMenuSet6.AXIOM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.AXIOM);
