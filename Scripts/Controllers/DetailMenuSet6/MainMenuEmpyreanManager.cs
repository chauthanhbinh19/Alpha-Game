...
public class MainMenuEmpyreanManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuEmpyreanPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuEmpyreanPanelPrefab = UIManager.Instance.Get("MainMenuEmpyreanPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("EmpyreanSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuEmpyreanManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuEmpyreanPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.EMPYREAN);
        parentType = AppConstants.MainMenuSet6.EMPYREAN;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.EMPYREAN);
