...
{
    public static MainMenuEmpyreanManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuEmpyreanManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet6.EMPYREAN, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet6.EMPYREAN);
