...
public class MainMenuUmbraManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuUmbraPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuUmbraPanelPrefab = UIManager.Instance.Get("MainMenuUmbraPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("UmbraSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuUmbraManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuUmbraPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.UMBRA);
        parentType = AppConstants.MainMenuSet6.UMBRA;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.UMBRA);
