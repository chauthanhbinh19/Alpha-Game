...
public class MainMenuHyperionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuHyperionPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuHyperionPanelPrefab = UIManager.Instance.Get("MainMenuHyperionPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("HyperionSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuHyperionManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuHyperionPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.HYPERION);
        parentType = AppConstants.MainMenuSet6.HYPERION;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.HYPERION);
