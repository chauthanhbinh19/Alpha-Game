...
public class MainMenuParallaxManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuParallaxPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuParallaxPanelPrefab = UIManager.Instance.Get("MainMenuParallaxPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ParallaxSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuParallaxManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuParallaxPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.PARALLAX);
        parentType = AppConstants.MainMenuSet6.PARALLAX;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.PARALLAX);
