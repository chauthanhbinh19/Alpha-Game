...
{
    public static MainMenuEclipseManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuEclipseManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet6.ECLIPSE, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet6.ECLIPSE);
