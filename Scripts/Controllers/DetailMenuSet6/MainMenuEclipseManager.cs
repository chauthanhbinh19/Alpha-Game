...
public class MainMenuEclipseManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuEclipsePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuEclipsePanelPrefab = UIManager.Instance.Get("MainMenuEclipsePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("EclipseSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuEclipseManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuEclipsePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.ECLIPSE);
        parentType = AppConstants.MainMenuSet6.ECLIPSE;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.ECLIPSE);
