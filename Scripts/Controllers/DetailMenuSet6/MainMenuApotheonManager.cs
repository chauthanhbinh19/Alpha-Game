...
{
    public static MainMenuApotheonManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuApotheonManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet6.APOTHEON, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet6.APOTHEON);
