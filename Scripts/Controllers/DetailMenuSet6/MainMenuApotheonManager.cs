...
public class MainMenuApotheonManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuApotheonPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuApotheonPanelPrefab = UIManager.Instance.Get("MainMenuApotheonPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ApotheonSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuApotheonManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuApotheonPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.APOTHEON);
        parentType = AppConstants.MainMenuSet6.APOTHEON;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.APOTHEON);
