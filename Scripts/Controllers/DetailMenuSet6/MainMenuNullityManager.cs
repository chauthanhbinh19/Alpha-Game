...
public class MainMenuNullityManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNullityPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuNullityPanelPrefab = UIManager.Instance.Get("MainMenuNullityPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("NullitySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuNullityManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNullityPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.NULLITY);
        parentType = AppConstants.MainMenuSet6.NULLITY;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.NULLITY);
