...
public class MainMenuOblivionManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuOblivionPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuOblivionPanelPrefab = UIManager.Instance.Get("MainMenuOblivionPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OblivionSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOblivionManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuOblivionPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.OBLIVION);
        parentType = AppConstants.MainMenuSet6.OBLIVION;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.OBLIVION);
