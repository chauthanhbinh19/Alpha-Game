...
public class MainMenuZenithManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuZenithPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuZenithPanelPrefab = UIManager.Instance.Get("MainMenuZenithPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ZenithSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuZenithManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuZenithPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.ZENITH);
        parentType = AppConstants.MainMenuSet6.ZENITH;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.ZENITH);
