...
public class MainMenuCatalystManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuCatalystPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuCatalystPanelPrefab = UIManager.Instance.Get("MainMenuCatalystPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("CatalystSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuCatalystManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuCatalystPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.CATALYST);
        parentType = AppConstants.MainMenuSet6.CATALYST;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.CATALYST);
