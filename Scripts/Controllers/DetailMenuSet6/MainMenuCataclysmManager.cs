...
public class MainMenuCataclysmManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuCataclysmPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuCataclysmPanelPrefab = UIManager.Instance.Get("MainMenuCataclysmPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("CataclysmSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuCataclysmManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuCataclysmPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.CATACLYSM);
        parentType = AppConstants.MainMenuSet6.CATACLYSM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.CATACLYSM);
