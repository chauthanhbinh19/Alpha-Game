...
public class MainMenuNexusManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNexusPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuNexusPanelPrefab = UIManager.Instance.Get("MainMenuNexusPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("NexusSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuNexusManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNexusPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.NEXUS);
        parentType = AppConstants.MainMenuSet6.NEXUS;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.NEXUS);
