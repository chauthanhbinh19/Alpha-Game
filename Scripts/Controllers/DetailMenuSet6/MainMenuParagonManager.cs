...
public class MainMenuParagonManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuParagonPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuParagonPanelPrefab = UIManager.Instance.Get("MainMenuParagonPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("ParagonSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuParagonManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuParagonPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.PARAGON);
        parentType = AppConstants.MainMenuSet6.PARAGON;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.PARAGON);
