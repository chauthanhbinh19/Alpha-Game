...
public class MainMenuSingularityManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuSingularityManagerAsync(object data)
    {
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_110_URL);
        ...
        scrollViewBackground.texture = Resources.Load<Texture>(ImageConstants.Background.SCROLLVIEW_BACKGROUND_6_URL);
