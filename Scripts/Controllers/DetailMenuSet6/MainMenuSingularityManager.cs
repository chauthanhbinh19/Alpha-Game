...
public class MainMenuSingularityManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuSingularityPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuSingularityPanelPrefab = UIManager.Instance.Get("MainMenuSingularityPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("SingularitySlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuSingularityManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuSingularityPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.SINGULARITY);
        parentType = AppConstants.MainMenuSet6.SINGULARITY;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_110_URL);
        ...
        scrollViewBackground.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.SCROLLVIEW_BACKGROUND_6_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.SINGULARITY);
