...
public class MainMenuInfernumManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuInfernumPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuInfernumPanelPrefab = UIManager.Instance.Get("MainMenuInfernumPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("InfernumSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuInfernumManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuInfernumPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet6.INFERNUM);
        parentType = AppConstants.MainMenuSet6.INFERNUM;
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet6.INFERNUM);
