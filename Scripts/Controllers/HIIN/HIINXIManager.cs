...
public class HIINXIManager : MonoBehaviour
{
    public static HIINXIManager Instance { get; private set; }
    ...
    public async Task CreateHIINXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIINFeaturesByTypeAsync(AppConstants.HIIN.HIIN_XI);
    ...
    public async Task CreateMainHIINPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIIN.HIIN_XI}");
