...
public class HIINIVManager : MonoBehaviour
{
    public static HIINIVManager Instance { get; private set; }
    ...
    public async Task CreateHIINIVManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIINFeaturesByTypeAsync(AppConstants.HIIN.HIIN_IV);
