...
public class HIINXIIManager : MonoBehaviour
{
    public static HIINXIIManager Instance { get; private set; }
    ...
    public async Task CreateHIINXIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIINFeaturesByTypeAsync(AppConstants.HIIN.HIIN_XII);
    ...
    public async Task CreateMainHIINPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIIN.HIIN_XII}");
