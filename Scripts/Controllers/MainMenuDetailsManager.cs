...
public class MainMenuDetailsManager : MonoBehaviour
{
    ...
    public void GetLevel(object obj)
    {
        ...
        if (obj is CardHeroes cardHeroes)
        {
            ...
            items = userItemsService.GetItemForLevel(mainType);
            ...
            up1LevelButton.onClick.AddListener(() =>
            {
                ...
                if (canLevel)
                {
                    ...
                    newCard = UserCardHeroesService.Create().GetNewLevelPower(cardHeroes, increasePerLevel);
                    UserCardHeroesService.Create().UpdateCardHeroesLevel(newCard, currentLevel + 1);
                    UserCardHeroesService.Create().UpdateFactCardHeroes(newCard);
            ...
            upMaxLevelButton.onClick.AddListener(() =>
            {
                ...
                if (canLevel)
                {
                    ...
                    double currentPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    CardHeroes newCard = UserCardHeroesService.Create().GetNewLevelPower(cardHeroes, levelsGained * increasePerLevel);
                    UserCardHeroesService.Create().UpdateCardHeroesLevel(newCard, currentLevel);
                    UserCardHeroesService.Create().UpdateFactCardHeroes(newCard);
                    double newPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    FindObjectOfType<Power>().ShowPower(currentPower, newPower - currentPower, 1);
        ...
        else if (obj is CardMilitary cardMilitary)
        {
            ...
            upMaxLevelButton.onClick.AddListener(() =>
            {
                CardMilitary currentCard = UserCardMilitaryService.Create().GetUserCardMilitaryById(User.CurrentUserId, cardMilitary.id);
                int totalExperiment = currentCard.experiment;
                int currentLevel = currentCard.level;
                int originalLevel = currentLevel;
                int experimentCondition = currentLevel == 0 ? 100 : currentLevel * 100;
        ...
        else if (obj is MagicFormationCircle magicFormationCircle)
        {
            ...
            upMaxLevelButton.onClick.AddListener(() =>
            {
                ...
                if (canLevel)
                {
                    ...
                    double currentPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    MagicFormationCircle newCard = UserMagicFormationCircleService.Create().GetNewLevelPower(magicFormationCircle, levelsGained * increasePerLevel);
        ...
        else if (obj is Puppet puppet)
        {
            ...
            upMaxLevelButton.onClick.AddListener(() =>
            {
                ...
                if (canLevel)
                {
                    ...
                    double currentPower = teamsService.GetTeamsPower(User.CurrentUserId);
                    Puppet newCard = UserPuppetService.Create().GetNewLevelPower(puppet, levelsGained * increasePerLevel);
    ...
    public void GetUpgrade(object obj)
    {
        ...
        if (obj is CardHeroes cardHeroes)
        {
            ...
            List<Items> items = new List<Items>();
            items = UserItemsService.Create().GetItemForBreakthourgh(mainType);
        ...
        else if (obj is Books book)
        {
            ...
            Items item = new Items();
            List<Items> items = new List<Items>();
            items = userItemsService.GetItemForBreakthourgh(mainType);
            string fileNameWithoutExtension = "";
            foreach (Items items1 in items)
            {
                GameObject itemObject = Instantiate(ElementDetails2Prefab, UpgradeMaterialContent);
