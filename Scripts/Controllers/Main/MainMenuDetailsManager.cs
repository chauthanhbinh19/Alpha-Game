...
public class MainMenuDetailsManager : MonoBehaviour
{
    ...
    public void PopupDetails(object data, Transform panel)
    {
        ...
        if (data is CardHeroes cardHeroes)
        {
            ...
            mainType = "CardHeroes";
            titleText.text = LocalizationManager.Get(AppConstants.CardHero);
            ...
            CloseButton.onClick.AddListener(() =>
            {
                ...
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardHero);
            });
        }
        else if (data is Books book)
        {
            ...
            mainType = "Books";
            titleText.text = LocalizationManager.Get(AppConstants.Book);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Book);
            });
        }
        else if (data is CardCaptains cardCaptains)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardCaptain);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardCaptain);
            });
        }
        else if (data is Pets pet)
        {
            // Xử lý đối tượng Pet
            mainType = "Pets";
            titleText.text = LocalizationManager.Get(AppConstants.Pet);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Pet);
            });
        }
        else if (data is CollaborationEquipment collaborationEquipmentsequipment)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CollaborationEquipment);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CollaborationEquipment);
            });
        }
        else if (data is CardMilitary cardMilitary)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardMilitary);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardMilitary);
            });
        }
        else if (data is CardSpell cardSpell)
        {
            ...
            mainType = "CardSpell";
            titleText.text = LocalizationManager.Get(AppConstants.CardSpell);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardSpell);
            });
        }
        else if (data is Collaboration collaboration)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.Collaboration);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Collaboration);
            });
        }
        else if (data is CardMonsters cardMonsters)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardMonster);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardMonster);
            });
        }
        else if (data is Equipments equipment)
        {
            ...
            mainType = "Equipments";
            titleText.text = LocalizationManager.Get(AppConstants.Equipment);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Equipment);
            });
        }
        else if (data is Medals medal)
        {
            ...
            mainType = "Medals";
            titleText.text = LocalizationManager.Get(AppConstants.Medal);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Medal);
            });
        }
        else if (data is Skills skill)
        {
            ...
            mainType = "Skills";
            titleText.text = LocalizationManager.Get(AppConstants.Skill);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Skill);
            });
        }
        else if (data is Symbols symbol)
        {
            ...
            mainType = "Symbols";
            titleText.text = LocalizationManager.Get(AppConstants.Symbol);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Symbol);
            });
        }
        else if (data is Titles title)
        {
            ...
            mainType = "Titles";
            titleText.text = LocalizationManager.Get(AppConstants.Title);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Title);
            });
        }
        else if (data is MagicFormationCircle magicFormationCircle)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.MagicFormationCircle);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.MagicFormationCircle);
            });
        }
        else if (data is Relics relics)
        {
            // Xử lý đối tượng Title
            mainType = "Relics";
            titleText.text = LocalizationManager.Get(AppConstants.Relic);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Relic);
            });
        }
        else if (data is CardColonels cardColonels)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardColonel);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardColonel);
            });
        }
        else if (data is CardGenerals cardGenerals)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardGeneral);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardGeneral);
            });
        }
        else if (data is CardAdmirals cardAdmirals)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.CardAdmiral);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardAdmiral);
            });
        }
        ...
        else if (data is Achievements achievements)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.Alchievement);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Alchievement);
            });
        }
        else if (data is Talisman talisman)
        {
            // Xử lý đối tượng achievements
            mainType = "Talisman";
            titleText.text = LocalizationManager.Get(AppConstants.Talisman);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Talisman);
            });
        }
        else if (data is Puppet puppet)
        {
            // Xử lý đối tượng achievements
            mainType = "Puppet";
            titleText.text = LocalizationManager.Get(AppConstants.Puppet);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Puppet);
            });
        }
        else if (data is Alchemy alchemy)
        {
            // Xử lý đối tượng achievements
            mainType = "Alchemy";
            titleText.text = LocalizationManager.Get(AppConstants.Alchemy);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Alchemy);
            });
        }
        else if (data is Forge forge)
        {
            // Xử lý đối tượng achievements
            mainType = "Forge";
            titleText.text = LocalizationManager.Get(AppConstants.Forge);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Forge);
            });
        }
        else if (data is CardLife cardLife)
        {
            // Xử lý đối tượng achievements
            mainType = "CardLife";
            titleText.text = LocalizationManager.Get(AppConstants.CardLife);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.CardLife);
            });
        }
        else if (data is Artwork artwork)
        {
            // Xử lý đối tượng achievements
            mainType = "Artwork";
            titleText.text = LocalizationManager.Get(AppConstants.Artwork);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.Artwork);
            });
        }
        else if (data is SpiritBeast spiritBeast)
        {
            ...
            titleText.text = LocalizationManager.Get(AppConstants.SpiritBeast);
            ...
            {
                ButtonEvent.Instance.Close(MainPanel);
                FindAnyObjectByType<MainMenuManager>().GetType(AppConstants.SpiritBeast);
            });
        }
        else
        {
