...
public class HomeManager : MonoBehaviour
{
    ...
    public async Task CreateHomePanelAsync()
    {
        ...
        Transform alchemyTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/AlchemyPanel");
        ...
        Transform architectureTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/ArchitecturePanel");
        ...
        Transform artworkTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/ArtworkPanel");
        ...
        Transform avatarTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/AvatarPanel");
        ...
        Transform badgeTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/BadgePanel");
        ...
        Transform beverageTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/BeveragePanel");
        ...
        Transform bookTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/BookPanel");
        ...
        Transform borderTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/BorderPanel");
        ...
        Transform buildingTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/BuildingPanel");
        ...
        Transform cardAdmiralTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardAdmiralPanel");
        ...
        Transform cardCaptainTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardCaptainPanel");
        ...
        Transform cardColonelTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardColonelPanel");
        ...
        Transform cardGeneralTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardGeneralPanel");
        ...
        Transform cardHeroTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardHeroPanel");
        ...
        Transform cardLifeTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardLifePanel");
        ...
        Transform cardMilitaryTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardMilitaryPanel");
        ...
        Transform cardMonsterTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardMonsterPanel");
        ...
        Transform cardSpellTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardSpellPanel");
        ...
        Transform cardTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CardPanel");
        ...
        Transform collaborationEquipmentTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CollaborationEquipmentPanel");
        ...
        Transform collaborationTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CollaborationPanel");
        ...
        Transform coreTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/CorePanel");
        ...
        Transform equipmentTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/EquipmentPanel");
        ...
        Transform fashionTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/FashionPanel");
        ...
        Transform foodTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/FoodPanel");
        ...
        Transform magicFormationCircleTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/MagicFormationCirclePanel");
        ...
        Transform mechaBeastTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/MechaBeastPanel");
        ...
        Transform medalTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/MedalPanel");
        ...
        Transform petTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/PetPanel");
        ...
        Transform plantTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/PlantPanel");
        ...
        Transform puppetTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/PuppetPanel");
        ...
        Transform relicTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/RelicPanel");
        ...
        Transform robotTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/RobotPanel");
        ...
        Transform runeTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/RunePanel");
        ...
        Transform skillTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/SkillPanel");
        ...
        Transform spiritBeastTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/SpiritBeastPanel");
        ...
        Transform spiritCardTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/SpiritCardPanel");
        ...
        Transform symbolTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/SymbolPanel");
        ...
        Transform talismanTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/TalismanPanel");
        ...
        Transform technologyTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/TechnologyPanel");
        ...
        Transform titleTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/TitlePanel");
        ...
        Transform weaponTransform = currentObject.transform.Find("Scroll View/Viewport/Content/StatisticsPart/WeaponPanel");
