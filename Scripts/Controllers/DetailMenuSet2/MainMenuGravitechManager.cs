...
public class MainMenuGravitechManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainMenuGravitechPanelPrefab = UIManager.Instance.GetGameObjectMainMenu2("MainMenuGravitechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu2("GravitechSlotPrefab");
    }
    ...
    public void CreateMainMenuGravitechManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.Gravitech);
        parentType = AppConstants.MainMenuSet2.Gravitech;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet2.Gravitech);
