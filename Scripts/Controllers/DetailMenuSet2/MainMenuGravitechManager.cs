...
public class MainMenuGravitechManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuGravitechManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_94_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.GRAVITECH);
