...
public class MainMenuGravitechManager : MonoBehaviour
{
    ...
    public void CreateMainMenuGravitechManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Gravitech.ToLower());
        parentType = AppConstants.Gravitech;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Gravitech);
