...
public class MainMenuCryotechManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuCryotechManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_90_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.CRYOTECH);
