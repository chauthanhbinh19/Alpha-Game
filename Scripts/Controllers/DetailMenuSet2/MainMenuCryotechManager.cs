...
public class MainMenuCryotechManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainMenuCryotechPanelPrefab = UIManager.Instance.GetGameObjectMainMenu2("MainMenuCryotechPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu2("CryotechSlotPrefab");
    ...
    public void CreateMainMenuCryotechManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.Cryotech);
        parentType = AppConstants.MainMenuSet2.Cryotech;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet2.Cryotech);
