...
public class MainMenuCryotechManager : MonoBehaviour
{
    ...
    public void CreateMainMenuCryotechManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Cryotech.ToLower());
        parentType = AppConstants.Cryotech;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Cryotech);
