...
public class MainMenuNeurotechManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuNeurotechPanelPrefab;
    ...
    public async Task CreateMainMenuNeurotechManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuNeurotechPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.NEUROTECH);
        parentType = AppConstants.MainMenuSet2.NEUROTECH;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_100_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.NEUROTECH);
