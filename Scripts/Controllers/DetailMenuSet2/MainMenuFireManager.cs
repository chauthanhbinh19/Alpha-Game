...
public class MainMenuFireManager : MonoBehaviour
{
    ...
    public void CreateMainMenuFireManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Fire.ToLower());
        parentType = AppConstants.Fire;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Fire);
