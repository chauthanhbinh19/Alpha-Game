...
public class MainMenuAntimatterManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAntimatterManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.ANIMATTER);
        parentType = AppConstants.MainMenuSet2.ANTIMATTER;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_88_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.ANTIMATTER);
