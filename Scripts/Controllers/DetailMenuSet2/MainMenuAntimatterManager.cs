...
{
    public static MainMenuAntimatterManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuAntimatterManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet2.ANTIMATTER, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet2.ANTIMATTER);
