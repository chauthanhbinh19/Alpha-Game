...
public class MainMenuIceManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuIceManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.ICE);
        parentType = AppConstants.MainMenuSet2.ICE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_96_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.ICE);
