...
public class MainMenuThunderManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuThunderManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.THUNDER);
        parentType = AppConstants.MainMenuSet2.THUNDER;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_108_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.THUNDER);
