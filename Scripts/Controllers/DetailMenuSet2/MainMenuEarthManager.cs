...
public class MainMenuEarthManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuEarthPanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuEarthPanelPrefab = UIManager.Instance.Get("MainMenuEarthPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("EarthSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuEarthManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuEarthPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.EARTH);
        parentType = AppConstants.MainMenuSet2.EARTH;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_92_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.EARTH);
