...
public class MainMenuLightManager : MonoBehaviour
{
    ...
    private GameObject MainMenuLightPanelPrefab;
    ...
    {
        currentObject = Instantiate(MainMenuLightPanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.LIGHT);
        parentType = AppConstants.MainMenuSet2.LIGHT;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_98_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.LIGHT);
