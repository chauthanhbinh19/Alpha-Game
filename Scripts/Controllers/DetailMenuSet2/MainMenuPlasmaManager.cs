...
public class MainMenuPlasmaManager : MonoBehaviour
{
    ...
    public void CreateMainMenuPlasmaManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Plasma.ToLower());
        parentType = AppConstants.Plasma;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Plasma);
