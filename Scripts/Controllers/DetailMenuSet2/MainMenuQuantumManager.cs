...
public class MainMenuQuantumManager : MonoBehaviour
{
    ...
    public void CreateMainMenuQuantumManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Quantum.ToLower());
        parentType = AppConstants.Quantum;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Quantum);
