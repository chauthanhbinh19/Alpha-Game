...
{
    public static MainMenuQuantumManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuQuantumManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet2.QUANTUM, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet2.QUANTUM);
