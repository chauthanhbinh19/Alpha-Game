...
public class MainMenuOrbitalisManager : MonoBehaviour
{
    ...
    public void CreateMainMenuOrbitalisManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Orbitalis.ToLower());
        parentType = AppConstants.Orbitalis;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Orbitalis);
