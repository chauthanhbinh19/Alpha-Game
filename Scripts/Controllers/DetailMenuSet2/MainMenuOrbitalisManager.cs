...
public class MainMenuOrbitalisManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuOrbitalisPanelPrefab = UIManager.Instance.Get("MainMenuOrbitalisPanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("OrbitalisSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuOrbitalisManagerAsync(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.ORBITALIS);
        parentType = AppConstants.MainMenuSet2.ORBITALIS;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_101_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.ORBITALIS);
