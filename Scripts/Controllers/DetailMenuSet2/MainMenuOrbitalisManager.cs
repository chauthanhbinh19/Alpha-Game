...
{
    public static MainMenuOrbitalisManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuOrbitalisManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet2.ORBITALIS, stat);
