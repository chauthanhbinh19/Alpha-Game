...
public class MainMenuAethernetManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuAethernetManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_87_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.AETHERNET);
