...
public class MainMenuAethernetManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        MainMenuAethernetPanelPrefab = UIManager.Instance.GetGameObjectMainMenu2("MainMenuAethernetPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu2("AethernetSlotPrefab");
    ...
    public void CreateMainMenuAethernetManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.Aethernet);
        parentType = AppConstants.MainMenuSet2.AETHERNET;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet2.AETHERNET);
