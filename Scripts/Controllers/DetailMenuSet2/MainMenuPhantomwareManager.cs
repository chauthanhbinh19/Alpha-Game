...
public class MainMenuPhantomwareManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuPhantomwarePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuPhantomwarePanelPrefab = UIManager.Instance.Get("MainMenuPhantomwarePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("PhantomwareSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuPhantomwareManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuPhantomwarePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.PHANTOMWARE);
        parentType = AppConstants.MainMenuSet2.PAHNTOMWARE;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_102_URL);
        ...
        scrollViewBackground.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.SCROLLVIEW_BACKGROUND_2_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.PAHNTOMWARE);
