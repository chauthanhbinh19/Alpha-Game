...
public class MainMenuPhantomwareManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuPhantomwareManagerAsync(object data)
    {
        ...
        background.texture = Resources.Load<Texture>(ImageConstants.Background.BACKGROUND_102_URL);
        ...
        scrollViewBackground.texture = Resources.Load<Texture>(ImageConstants.Background.SCROLLVIEW_BACKGROUND_2_URL);
