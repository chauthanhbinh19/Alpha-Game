...
public class MainMenuHolographyManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainMenuHolographyPanelPrefab = UIManager.Instance.GetGameObjectMainMenu2("MainMenuHolographyPanelPrefab");
        buttonPrefab = UIManager.Instance.GetGameObject("TabButton");
        SlotPrefab = UIManager.Instance.GetGameObjectMainMenu2("HolographySlotPrefab");
    ...
    public void CreateMainMenuHolographyManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.Holography);
        parentType = AppConstants.MainMenuSet2.Holography;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.MainMenuSet2.Holography);
