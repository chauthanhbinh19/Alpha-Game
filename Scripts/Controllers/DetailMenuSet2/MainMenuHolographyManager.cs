...
public class MainMenuHolographyManager : MonoBehaviour
{
    ...
    public async Task CreateMainMenuHolographyManagerAsync(object data)
    {
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_95_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.HOLOGRAPHY);
