...
{
    public static MainMenuHolographyManager Instance { get; private set; }
    ...
    public async Task CreateMainMenuHolographyManagerAsync(IStats stat)
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetRankFeaturesByTypeAsync(AppConstants.MainMenuSet2.HOLOGRAPHY, stat);
    ...
    public async Task CreateMainRankPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.MainMenuSet2.HOLOGRAPHY);
