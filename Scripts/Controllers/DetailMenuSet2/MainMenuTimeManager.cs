...
public class MainMenuTimeManager : MonoBehaviour
{
    ...
    public void CreateMainMenuTimeManager(object data)
    {
        ...
        titleText.text = LocalizationManager.Get(AppConstants.Time.ToLower());
        parentType = AppConstants.Time;
        ...
        uniqueTypes = FeaturesService.Create().GetFeaturesByType(AppConstants.Time);
