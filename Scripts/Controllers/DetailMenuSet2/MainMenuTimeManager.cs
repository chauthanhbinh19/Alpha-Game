...
public class MainMenuTimeManager : MonoBehaviour
{
    private Transform MainPanel;
    private Transform TabButtonPanel;
    private Transform SlotPanel;
    private GameObject MainMenuTimePanelPrefab;
    ...
    public void Initialize()
    {
        ...
        MainMenuTimePanelPrefab = UIManager.Instance.Get("MainMenuTimePanelPrefab");
        TypeButtonPrefab = UIManager.Instance.Get("TypeButtonPrefab");
        SlotPrefab = UIManager.Instance.Get("TimeSlotPrefab");
        EuroStyleNormalFont = UIManager.Instance.GetTMPFontAsset("EuroStyleNormalFont");
    }
    public async Task CreateMainMenuTimeManagerAsync(object data)
    {
        currentObject = Instantiate(MainMenuTimePanelPrefab, MainPanel);
        ...
        titleText.text = LocalizationManager.Get(AppDisplayConstants.MainMenuSet2.TIME);
        parentType = AppConstants.MainMenuSet2.TIME;
        ...
        background.texture = TextureHelper.LoadTextureCached(ImageConstants.Background.BACKGROUND_109_URL);
        ...
        uniqueTypes = await FeaturesService.Create().GetFeaturesByTypeAsync(AppConstants.MainMenuSet2.TIME);
