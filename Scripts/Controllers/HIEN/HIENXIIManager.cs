...
public class HIENXIIManager : MonoBehaviour
{
    public static HIENXIIManager Instance { get; private set; }
    ...
    public async Task CreateHIENXIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIENFeaturesByTypeAsync(AppConstants.HIEN.HIEN_XII);
    ...
    public async Task CreateMainHIENPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIEN.HIEN_XII}");
