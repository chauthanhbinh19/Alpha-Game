...
public class HIENXIManager : MonoBehaviour
{
    public static HIENXIManager Instance { get; private set; }
    ...
    public async Task CreateHIENXIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIENFeaturesByTypeAsync(AppConstants.HIEN.HIEN_XI);
    ...
    public async Task CreateMainHIENPanelAsync(string featureId, string featureName)
    {
        ...
        Texture rankTexture = Resources.Load<Texture2D>($"UI/Rank_Research/{AppConstants.HIEN.HIEN_XI}");
