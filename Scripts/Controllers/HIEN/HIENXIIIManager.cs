...
public class HIENXIIIManager : MonoBehaviour
{
    public static HIENXIIIManager Instance { get; private set; }
    ...
    public async Task CreateHIENXIIIManagerAsync()
    {
        ...
        uniqueTypes = await FeaturesService.Create().GetHIENFeaturesByTypeAsync(AppConstants.HIEN.HIEN_XIII);
