...
public class HIENVIIManager : MonoBehaviour
{
    public static HIENVIIManager Instance { get; private set; }
    ...
    public async Task CreateHIENVIIManagerAsync()
    {
    ...
    public async Task CreateMainHIENPanelAsync(string featureId, string featureName)
    {
        ...
        background.texture = TextureHelper.LoadTexture2DCached(ImageConstants.HIEN.HIEN_VII_BACKGROUND_URL);
