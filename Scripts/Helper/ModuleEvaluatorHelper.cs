...
public static class ModuleEvaluatorHelper
{
    public static List<T> GetModulePower<T>(List<T> list) where T : IStats
    {
        foreach (var item in list)
        {
            double multiplier = 1 + item.UserModules.CurrentMultiplier/100;
    ...
    public static T GetModulePower<T>(T item) where T : IStats
    {
