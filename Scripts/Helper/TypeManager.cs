...
public static class TypeManager
{
    ...
    new Dictionary<string, Func<Task<List<string>>>>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { AppConstants.MainType.WEAPON, async () => await WeaponsService.Create().GetUniqueWeaponsTypesAsync() },
        ...
        { AppConstants.MainType.OUTFIT, async () => await OutfitsService.Create().GetUniqueOutfitsTypesAsync() },
        { AppConstants.MainType.CARD_SOLDIER, async () => await CardSoldiersService.Create().GetUniqueCardSoldiersTypesAsync() },

        // SUMMON
        { AppConstants.MainType.SUMMON_CARD_HERO, async () => await CardHeroesService.Create().GetUniqueCardHeroesTypesAsync() },
        { AppConstants.MainType.SUMMON_BOOK, async () => await BooksService.Create().GetUniqueBooksTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_CAPTAIN, async () => await CardCaptainsService.Create().GetUniqueCardCaptainsTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_MILITARY, async () => await CardMilitariesService.Create().GetUniqueCardMilitariesTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_SPELL, async () => await CardSpellsService.Create().GetUniqueCardSpellsTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_MONSTER, async () => await CardMonstersService.Create().GetUniqueCardMonstersTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_COLONEL, async () => await CardColonelsService.Create().GetUniqueCardColonelsTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_GENERAL, async () => await CardGeneralsService.Create().GetUniqueCardGeneralsTypesAsync() },
        { AppConstants.MainType.SUMMON_CARD_ADMIRAL, async () => await CardAdmiralsService.Create().GetUniqueCardAdmiralsTypesAsync() },
