...
public class CardMonsters
{
    ...
    public List<CardMonsters> GetQualityPower(List<CardMonsters> list)
    {
    ...
    public List<CardMonsters> GetAllAnimeStatsPower(int user_id, List<CardMonsters> CardMonstersList)
    {
    ...
    public List<CardMonsters> GetUserCardMonsters(int user_id, string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardMonstersList = GetAllAnimeStatsPower(user_id, CardMonstersList);
                CardMonstersList = GetQualityPower(CardMonstersList);
            }
            catch (MySqlException ex)
            {
    ...
    public List<CardMonsters> GetUserCardMonstersTeam(int user_id, int teamId, string position)
    {
        List<CardMonsters> CardMonstersList = new List<CardMonsters>();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
    ...
    public int GetUserCardMonstersTeamsPositionCount(int user_id, int team_id, string position){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
