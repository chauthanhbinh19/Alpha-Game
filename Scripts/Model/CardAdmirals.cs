...
public class CardAdmirals
{
    ...
    public List<CardAdmirals> GetQualityPower(List<CardAdmirals> list)
    {
    ...
    public List<CardAdmirals> GetFinalPower(int user_id, List<CardAdmirals> CardAdmiralsList)
    {
        ...
        foreach (var c in CardAdmiralsList)
        {
            ...
            card = card.GetUserCardAdmiralsById(user_id, c.id);
    ...
    public List<CardAdmirals> GetAllEquipmentPower(int user_id, List<CardAdmirals> CardAdmiralsList)
    {
        Equipments equipments = new Equipments();
        foreach (var c in CardAdmiralsList)
        {
            equipments = equipments.GetAllEquipmentsByCardAdmiralsId(user_id, c.id);
    ...
    public List<CardAdmirals> GetAllRankPower(int user_id, List<CardAdmirals> CardAdmiralsList)
    {
        Rank rank = new Rank();
        foreach (var c in CardAdmiralsList)
        {
            CardAdmirals card = new CardAdmirals();
            card = card.GetUserCardAdmiralsById(user_id, c.id);
            rank = rank.GetSumCardAdmiralsRank(user_id, c.id);
    ...
    public List<CardAdmirals> GetAllAnimeStatsPower(int user_id, List<CardAdmirals> cardAdmirals)
    {
        AnimeStats animeStats = new AnimeStats();
        foreach (var c in cardAdmirals)
        {
            CardAdmirals books = new CardAdmirals();
            books = books.GetUserCardAdmiralsById(user_id, c.id);
    ...
    public CardAdmirals GetNewLevelPower(CardAdmirals c, double coefficient)
    {
        ...
        cardAdmirals.power = PowerManager.CalculatePower(
            cardAdmirals.health,
    ...
    public List<CardAdmirals> GetCardAdmirals(string type,int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardAdmiralsList = GetQualityPower(CardAdmiralsList);
            }
    ...
    public List<CardAdmirals> GetUserCardAdmirals(int user_id, string type,int pageSize, int offset)
    {
        List<CardAdmirals> CardAdmiralsList = new List<CardAdmirals>();
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardAdmiralsList = GetFinalPower(user_id, CardAdmiralsList);
                CardAdmiralsList = GetAllEquipmentPower(user_id, CardAdmiralsList);
                CardAdmiralsList = GetAllRankPower(user_id, CardAdmiralsList);
                CardAdmiralsList = GetAllAnimeStatsPower(user_id, CardAdmiralsList);
                CardAdmiralsList = GetQualityPower(CardAdmiralsList);
            }
            catch (MySqlException ex)
            {
    ...
    public List<CardAdmirals> GetUserCardAdmiralsTeam(int user_id, int teamId, string position)
    {
        List<CardAdmirals> CardAdmiralsList = new List<CardAdmirals>();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
    ...
    public int GetUserCardAdmiralsCount(int user_id, string type){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
    ...
    public int GetUserCardAdmiralsTeamsPositionCount(int user_id, int team_id, string position){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_card_admirals (
                    user_id, card_admiral_id, level, experiment, star, quality, block, quantity, power, health, physical_attack, 
                    ...
                    command.Parameters.AddWithValue("@quality", PowerManager.CheckQuality(CardAdmirals.rare));
    ...
    public CardAdmirals GetUserCardAdmiralsById(int user_id, int Id)
    {
        CardAdmirals card = new CardAdmirals();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
