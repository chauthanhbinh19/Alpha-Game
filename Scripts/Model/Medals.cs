...
public class Medals
{
    ...
    public List<Medals> GetQualityPower(List<Medals> list)
    {
    ...
    public Medals GetNewLevelPower(Medals c, double coefficient)
    {
        ...
        medals.power = PowerManager.CalculatePower(
            medals.health,
            ...
            medals.speed,
            medals.critical_damage_rate, medals.critical_rate,
            medals.penetration_rate, medals.evasion_rate,
            medals.damage_absorption_rate, medals.vitality_regeneration_rate,
            medals.accuracy_rate, medals.lifesteal_rate,
            medals.shield_strength, medals.tenacity, medals.resistance_rate,
            medals.combo_rate, medals.reflection_rate,
    ...
    public List<Medals> GetMedals(int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                medalsList = GetQualityPower(medalsList);
            }
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_medals (
                    user_id, medal_id, level, experiment, star, quality, block, quantity, power, health, physical_attack, 
                    ...
                    command.Parameters.AddWithValue("@quality", PowerManager.CheckQuality(medals.rare));
