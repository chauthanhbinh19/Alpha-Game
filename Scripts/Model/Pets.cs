...
public class Pets
{
    ...
    public List<Pets> GetQualityPower(List<Pets> list)
    {
    ...
    public List<Pets> GetAllAnimeStatsPower(int user_id, List<Pets> PetsList)
    {
    ...
    public List<Pets> GetUserPets(int user_id, string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                petsList = GetAllAnimeStatsPower(user_id, petsList);
                petsList = GetQualityPower(petsList);
            }
            catch (MySqlException ex)
            {
    ...
    public bool InsertUserPets(Pets pets)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                Debug.Log(PowerManager.CheckQuality(pets.rare));
                MySqlCommand command = new MySqlCommand(query, connection);
