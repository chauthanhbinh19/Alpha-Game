...
public class CardHeroes
{
    ...
    public List<CardHeroes> GetQualityPower(List<CardHeroes> list)
    {
    ...
    public List<CardHeroes> GetFinalPower(int user_id, List<CardHeroes> CardHeroesList)
    {
        ...
        foreach (var c in CardHeroesList)
        {
            ...
            card = card.GetUserCardHeroesById(user_id, c.id);
    ...
    public List<CardHeroes> GetAllEquipmentPower(int user_id, List<CardHeroes> CardHeroesList)
    {
        Equipments equipments = new Equipments();
        foreach (var c in CardHeroesList)
        {
            equipments = equipments.GetAllEquipmentsByCardHeoresId(user_id, c.id);
    ...
    public List<CardHeroes> GetAllRankPower(int user_id, List<CardHeroes> CardHeroesList)
    {
        Rank rank = new Rank();
        foreach (var c in CardHeroesList)
        {
            CardHeroes card = new CardHeroes();
            card = card.GetUserCardHeroesById(user_id, c.id);
            rank = rank.GetSumCardHeroesRank(user_id, c.id);
    ...
    public List<CardHeroes> GetAllAnimeStatsPower(int user_id, List<CardHeroes> CardHeroesList)
    {
    ...
    public CardHeroes GetNewLevelPower(CardHeroes c, double coefficient)
    {
        ...
        cardHeroes.power = PowerManager.CalculatePower(
            cardHeroes.health,
    ...
    public List<CardHeroes> GetCardHeroes(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardHeroesList = GetQualityPower(CardHeroesList);
            }
    ...
    public List<CardHeroes> GetUserCardHeroes(int user_id, string type, int pageSize, int offset)
    {
        List<CardHeroes> CardHeroesList = new List<CardHeroes>();
        // int user_id = User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardHeroesList = GetFinalPower(user_id, CardHeroesList);
                CardHeroesList = GetAllEquipmentPower(user_id, CardHeroesList);
                CardHeroesList = GetAllRankPower(user_id, CardHeroesList);
                CardHeroesList = GetAllAnimeStatsPower(user_id, CardHeroesList);
                CardHeroesList = GetQualityPower(CardHeroesList);
            }
            catch (MySqlException ex)
            {
    ...
    public List<CardHeroes> GetUserCardHeroesTeam(int user_id, int teamId, string position)
    {
        List<CardHeroes> CardHeroesList = new List<CardHeroes>();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                LEFT JOIN card_heroes c ON uc.card_hero_id = c.id 
                LEFT JOIN fact_card_heroes fch ON fch.user_id = uc.user_id AND fch.user_card_hero_id = uc.card_hero_id
                WHERE uc.user_id = @userId and fch.team_id=@team_id and fch.position like @position
                ORDER BY c.name REGEXP '[0-9]+$', CAST(REGEXP_SUBSTR(c.name, '[0-9]+$') AS UNSIGNED), c.name;
                ";
                MySqlCommand command = new MySqlCommand(query, connection);
                command.Parameters.AddWithValue("@userId", user_id);
    ...
    public int GetUserCardHeroesCount(int user_id, string type)
    {
        int count = 0;
        // int user_id = User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public int GetUserCardHeroesTeamsPositionCount(int user_id, int team_id, string position){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_card_heroes (
                    ...
                    command.Parameters.AddWithValue("@quality", PowerManager.CheckQuality(CardHeroes.rare));
    ...
    public CardHeroes GetUserCardHeroesById(int user_id, int Id)
    {
        CardHeroes card = new CardHeroes();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
