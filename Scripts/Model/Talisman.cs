...
public class Talisman
{
    ...
    public List<Talisman> GetQualityPower(List<Talisman> list)
    {
    ...
    public List<Talisman> GetTalisman(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                talismanList = GetQualityPower(talismanList);
            }
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                if (count == 0)
                {
                    ...
                    user_id, talisman_id, level, experiment, star, quality, block, quantity, power, health, physical_attack, 
                    ...
                    command.Parameters.AddWithValue("@quality", PowerManager.CheckQuality(Talisman.rare));
    ...
    public List<Talisman> GetTalismanWithPrice(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                Talismans = GetQualityPower(Talismans);
            }
            catch (MySqlException ex)
            {
                Debug.LogError("Error: " + ex.Message);
