...
public class CardColonels
{
    ...
    public List<CardColonels> GetQualityPower(List<CardColonels> list)
    {
    ...
    public List<CardColonels> GetFinalPower(int user_id, List<CardColonels> CardColonelsList)
    {
        ...
        foreach (var c in CardColonelsList)
        {
            ...
            card = card.GetUserCardColonelsById(user_id, c.id);
    ...
    public List<CardColonels> GetAllEquipmentPower(int user_id, List<CardColonels> CardColonelsList)
    {
        Equipments equipments = new Equipments();
        foreach (var c in CardColonelsList)
        {
            equipments = equipments.GetAllEquipmentsByCardColonelsId(user_id, c.id);
    ...
    public List<CardColonels> GetAllRankPower(int user_id, List<CardColonels> CardColonelsList)
    {
        Rank rank = new Rank();
        foreach (var c in CardColonelsList)
        {
            CardColonels card = new CardColonels();
            card = card.GetUserCardColonelsById(user_id, c.id);
            rank = rank.GetSumCardColonelsRank(user_id, c.id);
    ...
    public List<CardColonels> GetAllAnimeStatsPower(int user_id, List<CardColonels> CardColonelsList)
    {
    ...
    public CardColonels GetNewLevelPower(CardColonels c, double coefficient)
    {
        ...
        cardColonels.power = PowerManager.CalculatePower(
            cardColonels.health,
            cardColonels.physical_attack, cardColonels.physical_defense,
            cardColonels.magical_attack, cardColonels.magical_defense,
            cardColonels.chemical_attack, cardColonels.chemical_defense,
            cardColonels.atomic_attack, cardColonels.atomic_defense,
            cardColonels.mental_attack, cardColonels.mental_defense,
            cardColonels.speed,
            cardColonels.critical_damage_rate, cardColonels.critical_rate,
            cardColonels.penetration_rate, cardColonels.evasion_rate,
            cardColonels.damage_absorption_rate, cardColonels.vitality_regeneration_rate,
            cardColonels.accuracy_rate, cardColonels.lifesteal_rate,
            cardColonels.shield_strength, cardColonels.tenacity, cardColonels.resistance_rate,
            cardColonels.combo_rate, cardColonels.reflection_rate,
            cardColonels.mana, cardColonels.mana_regeneration_rate,
            cardColonels.damage_to_different_faction_rate, cardColonels.resistance_to_different_faction_rate,
            cardColonels.damage_to_same_faction_rate, cardColonels.resistance_to_same_faction_rate
        );
        return cardColonels;
    }
    ...
    public List<CardColonels> GetCardColonels(string type,int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardColonelsList = GetQualityPower(CardColonelsList);
            }
    ...
    public List<CardColonels> GetUserCardColonels(int user_id, string type,int pageSize, int offset)
    {
        List<CardColonels> CardColonelsList = new List<CardColonels>();
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                CardColonelsList = GetFinalPower(user_id, CardColonelsList);
                CardColonelsList = GetAllEquipmentPower(user_id, CardColonelsList);
                CardColonelsList = GetAllRankPower(user_id, CardColonelsList);
                CardColonelsList = GetAllAnimeStatsPower(user_id, CardColonelsList);
                CardColonelsList = GetQualityPower(CardColonelsList);
            }
            catch (MySqlException ex)
            {
    ...
    public List<CardColonels> GetUserCardColonelsTeam(int user_id, int teamId, string position)
    {
        List<CardColonels> CardColonelsList = new List<CardColonels>();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
    ...
    public int GetUserCardColonelsCount(int user_id, string type){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
    ...
    public int GetUserCardColonelsTeamsPositionCount(int user_id, int team_id, string position){
        int count =0;
        // int user_id=User.CurrentUserId;
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_card_colonels (
                    user_id, card_colonel_id, level, experiment, star, quality, block, quantity, power, health, physical_attack, 
                    ...
                    command.Parameters.AddWithValue("@quality", PowerManager.CheckQuality(CardColonels.rare));
    ...
    public CardColonels GetUserCardColonelsById(int user_id, int Id)
    {
        CardColonels card = new CardColonels();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
