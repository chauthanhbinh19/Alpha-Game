...
public class ArtworkRepository : IArtworkRepository
{
    public List<string> GetUniqueArtworkTypes()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct type from Artwork";
    ...
    public List<string> GetUniqueArtworkId()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct id from Artwork";
            MySqlCommand command = new MySqlCommand(query, connection);
            MySqlDataReader reader = command.ExecuteReader();
            while (reader.Read())
            {
    ...
    public List<Artworks> GetArtworkWithPrice(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Artwork m, Artwork_trade mt, currency cu
                where m.id=mt.Artwork_id and mt.currency_id = cu.id and m.type =@type
                ...
                while (reader.Read())
                {
                    ...
                    Artwork.Currency = new Currencies
                    {
    ...
    public Artworks SumPowerArtworkPercent()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Artwork a, user_Artwork ua
                where a.id=ua.Artwork_id and ua.user_id=@user_id;";
                MySqlCommand command = new MySqlCommand(query, connection);
