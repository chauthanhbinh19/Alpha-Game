                ...
                using (MySqlCommand checkCmd = new MySqlCommand(checkQuery, connection))
                {
                    ...
                    if (count > 0)
                    {
                        ...
                        using (MySqlCommand updateCmd = new MySqlCommand(updateQuery, connection))
                        {
                            ...
                            updateCmd.Parameters.AddWithValue("@physical_attack", scienceFiction.PhysicalAttack);
                            updateCmd.Parameters.AddWithValue("@physical_defense", scienceFiction.PhysicalDefense);
                            updateCmd.Parameters.AddWithValue("@magical_attack", scienceFiction.MagicalAttack);
                            updateCmd.Parameters.AddWithValue("@magical_defense", scienceFiction.MagicalDefense);
                            updateCmd.Parameters.AddWithValue("@chemical_attack", scienceFiction.ChemicalAttack);
                            updateCmd.Parameters.AddWithValue("@chemical_defense", scienceFiction.ChemicalDefense);
                            updateCmd.Parameters.AddWithValue("@atomic_attack", scienceFiction.AtomicAttack);
                            updateCmd.Parameters.AddWithValue("@atomic_defense", scienceFiction.AtomicDefense);
                            updateCmd.Parameters.AddWithValue("@mental_attack", scienceFiction.MentalAttack);
                            updateCmd.Parameters.AddWithValue("@mental_defense", scienceFiction.MentalDefense);
                            updateCmd.Parameters.AddWithValue("@speed", scienceFiction.Speed);
                            updateCmd.Parameters.AddWithValue("@critical_damage_rate", scienceFiction.CriticalDamageRate);
                            updateCmd.Parameters.AddWithValue("@critical_rate", scienceFiction.CriticalRate);
                            updateCmd.Parameters.AddWithValue("@critical_resistance_rate", scienceFiction.CriticalResistanceRate);
                            updateCmd.Parameters.AddWithValue("@ignore_critical_rate", scienceFiction.IgnoreCriticalRate);
                            updateCmd.Parameters.AddWithValue("@penetration_rate", scienceFiction.PenetrationRate);
                            updateCmd.Parameters.AddWithValue("@penetration_resistance_rate", scienceFiction.PenetrationResistanceRate);
                            updateCmd.Parameters.AddWithValue("@evasion_rate", scienceFiction.EvasionRate);
                            updateCmd.Parameters.AddWithValue("@damage_absorption_rate", scienceFiction.DamageAbsorptionRate);
                            updateCmd.Parameters.AddWithValue("@ignore_damage_absorption_rate", scienceFiction.IgnoreDamageAbsorptionRate);
                            updateCmd.Parameters.AddWithValue("@absorbed_damage_rate", scienceFiction.AbsorbedDamageRate);
                            updateCmd.Parameters.AddWithValue("@vitality_regeneration_rate", scienceFiction.VitalityRegenerationRate);
                            updateCmd.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", scienceFiction.VitalityRegenerationResistanceRate);
                            updateCmd.Parameters.AddWithValue("@accuracy_rate", scienceFiction.AccuracyRate);
                            updateCmd.Parameters.AddWithValue("@lifesteal_rate", scienceFiction.LifestealRate);
                            updateCmd.Parameters.AddWithValue("@shield_strength", scienceFiction.ShieldStrength);
                            updateCmd.Parameters.AddWithValue("@tenacity", scienceFiction.Tenacity);
                            updateCmd.Parameters.AddWithValue("@resistance_rate", scienceFiction.ResistanceRate);
                            updateCmd.Parameters.AddWithValue("@combo_rate", scienceFiction.ComboRate);
                            updateCmd.Parameters.AddWithValue("@ignore_combo_rate", scienceFiction.IgnoreComboRate);
                            updateCmd.Parameters.AddWithValue("@combo_damage_rate", scienceFiction.ComboDamageRate);
                            updateCmd.Parameters.AddWithValue("@combo_resistance_rate", scienceFiction.ComboResistanceRate);
                            updateCmd.Parameters.AddWithValue("@stun_rate", scienceFiction.StunRate);
                            updateCmd.Parameters.AddWithValue("@ignore_stun_rate", scienceFiction.IgnoreStunRate);
                            updateCmd.Parameters.AddWithValue("@reflection_rate", scienceFiction.ReflectionRate);
                            updateCmd.Parameters.AddWithValue("@ignore_reflection_rate", scienceFiction.IgnoreReflectionRate);
                            updateCmd.Parameters.AddWithValue("@reflection_damage_rate", scienceFiction.ReflectionDamageRate);
                            updateCmd.Parameters.AddWithValue("@reflection_resistance_rate", scienceFiction.ReflectionResistanceRate);
                            updateCmd.Parameters.AddWithValue("@mana", scienceFiction.Mana);
                            updateCmd.Parameters.AddWithValue("@mana_regeneration_rate", scienceFiction.ManaRegenerationRate);
                            updateCmd.Parameters.AddWithValue("@damage_to_different_faction_rate", scienceFiction.DamageToDifferentFactionRate);
                            updateCmd.Parameters.AddWithValue("@resistance_to_different_faction_rate", scienceFiction.ResistanceToDifferentFactionRate);
                            updateCmd.Parameters.AddWithValue("@damage_to_same_faction_rate", scienceFiction.DamageToSameFactionRate);
                            updateCmd.Parameters.AddWithValue("@resistance_to_same_faction_rate", scienceFiction.ResistanceToSameFactionRate);
                            updateCmd.Parameters.AddWithValue("@normal_damage_rate", scienceFiction.NormalDamageRate);
                            updateCmd.Parameters.AddWithValue("@normal_resistance_rate", scienceFiction.NormalResistanceRate);
                            updateCmd.Parameters.AddWithValue("@skill_damage_rate", scienceFiction.SkillDamageRate);
                            updateCmd.Parameters.AddWithValue("@skill_resistance_rate", scienceFiction.SkillResistanceRate);
                            updateCmd.Parameters.AddWithValue("@percent_all_health", scienceFiction.PercentAllHealth);
                            updateCmd.Parameters.AddWithValue("@percent_all_physical_attack", scienceFiction.PercentAllPhysicalAttack);
                            updateCmd.Parameters.AddWithValue("@percent_all_physical_defense", scienceFiction.PercentAllPhysicalDefense);
                            updateCmd.Parameters.AddWithValue("@percent_all_magical_attack", scienceFiction.PercentAllMagicalAttack);
                            updateCmd.Parameters.AddWithValue("@percent_all_magical_defense", scienceFiction.PercentAllMagicalDefense);
                            updateCmd.Parameters.AddWithValue("@percent_all_chemical_attack", scienceFiction.PercentAllChemicalAttack);
                            updateCmd.Parameters.AddWithValue("@percent_all_chemical_defense", scienceFiction.PercentAllChemicalDefense);
                            updateCmd.Parameters.AddWithValue("@percent_all_atomic_attack", scienceFiction.PercentAllAtomicAttack);
                            updateCmd.Parameters.AddWithValue("@percent_all_atomic_defense", scienceFiction.PercentAllAtomicDefense);
                            updateCmd.Parameters.AddWithValue("@percent_all_mental_attack", scienceFiction.PercentAllMentalAttack);
                            updateCmd.Parameters.AddWithValue("@percent_all_mental_defense", scienceFiction.PercentAllMentalDefense);
                    ...
                    else
                    {
                        ...
                        using (MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection))
                        {
                            ...
                            insertCmd.Parameters.AddWithValue("@physical_attack", scienceFiction.PhysicalAttack);
                            insertCmd.Parameters.AddWithValue("@physical_defense", scienceFiction.PhysicalDefense);
                            insertCmd.Parameters.AddWithValue("@magical_attack", scienceFiction.MagicalAttack);
                            insertCmd.Parameters.AddWithValue("@magical_defense", scienceFiction.MagicalDefense);
                            insertCmd.Parameters.AddWithValue("@chemical_attack", scienceFiction.ChemicalAttack);
                            insertCmd.Parameters.AddWithValue("@chemical_defense", scienceFiction.ChemicalDefense);
                            insertCmd.Parameters.AddWithValue("@atomic_attack", scienceFiction.AtomicAttack);
                            insertCmd.Parameters.AddWithValue("@atomic_defense", scienceFiction.AtomicDefense);
                            insertCmd.Parameters.AddWithValue("@mental_attack", scienceFiction.MentalAttack);
                            insertCmd.Parameters.AddWithValue("@mental_defense", scienceFiction.MentalDefense);
                            insertCmd.Parameters.AddWithValue("@speed", scienceFiction.Speed);
                            insertCmd.Parameters.AddWithValue("@critical_damage_rate", scienceFiction.CriticalDamageRate);
                            insertCmd.Parameters.AddWithValue("@critical_rate", scienceFiction.CriticalRate);
                            insertCmd.Parameters.AddWithValue("@critical_resistance_rate", scienceFiction.CriticalResistanceRate);
                            insertCmd.Parameters.AddWithValue("@ignore_critical_rate", scienceFiction.IgnoreCriticalRate);
                            insertCmd.Parameters.AddWithValue("@penetration_rate", scienceFiction.PenetrationRate);
                            insertCmd.Parameters.AddWithValue("@penetration_resistance_rate", scienceFiction.PenetrationResistanceRate);
                            insertCmd.Parameters.AddWithValue("@evasion_rate", scienceFiction.EvasionRate);
                            insertCmd.Parameters.AddWithValue("@damage_absorption_rate", scienceFiction.DamageAbsorptionRate);
                            insertCmd.Parameters.AddWithValue("@ignore_damage_absorption_rate", scienceFiction.IgnoreDamageAbsorptionRate);
                            insertCmd.Parameters.AddWithValue("@absorbed_damage_rate", scienceFiction.AbsorbedDamageRate);
                            insertCmd.Parameters.AddWithValue("@vitality_regeneration_rate", scienceFiction.VitalityRegenerationRate);
                            insertCmd.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", scienceFiction.VitalityRegenerationResistanceRate);
                            insertCmd.Parameters.AddWithValue("@accuracy_rate", scienceFiction.AccuracyRate);
                            insertCmd.Parameters.AddWithValue("@lifesteal_rate", scienceFiction.LifestealRate);
                            insertCmd.Parameters.AddWithValue("@shield_strength", scienceFiction.ShieldStrength);
                            insertCmd.Parameters.AddWithValue("@tenacity", scienceFiction.Tenacity);
                            insertCmd.Parameters.AddWithValue("@resistance_rate", scienceFiction.ResistanceRate);
                            insertCmd.Parameters.AddWithValue("@combo_rate", scienceFiction.ComboRate);
                            insertCmd.Parameters.AddWithValue("@ignore_combo_rate", scienceFiction.IgnoreComboRate);
                            insertCmd.Parameters.AddWithValue("@combo_damage_rate", scienceFiction.ComboDamageRate);
                            insertCmd.Parameters.AddWithValue("@combo_resistance_rate", scienceFiction.ComboResistanceRate);
                            insertCmd.Parameters.AddWithValue("@stun_rate", scienceFiction.StunRate);
                            insertCmd.Parameters.AddWithValue("@ignore_stun_rate", scienceFiction.IgnoreStunRate);
                            insertCmd.Parameters.AddWithValue("@reflection_rate", scienceFiction.ReflectionRate);
                            insertCmd.Parameters.AddWithValue("@ignore_reflection_rate", scienceFiction.IgnoreReflectionRate);
                            insertCmd.Parameters.AddWithValue("@reflection_damage_rate", scienceFiction.ReflectionDamageRate);
                            insertCmd.Parameters.AddWithValue("@reflection_resistance_rate", scienceFiction.ReflectionResistanceRate);
                            insertCmd.Parameters.AddWithValue("@mana", scienceFiction.Mana);
                            insertCmd.Parameters.AddWithValue("@mana_regeneration_rate", scienceFiction.ManaRegenerationRate);
                            insertCmd.Parameters.AddWithValue("@damage_to_different_faction_rate", scienceFiction.DamageToDifferentFactionRate);
                            insertCmd.Parameters.AddWithValue("@resistance_to_different_faction_rate", scienceFiction.ResistanceToDifferentFactionRate);
                            insertCmd.Parameters.AddWithValue("@damage_to_same_faction_rate", scienceFiction.DamageToSameFactionRate);
                            insertCmd.Parameters.AddWithValue("@resistance_to_same_faction_rate", scienceFiction.ResistanceToSameFactionRate);
                            insertCmd.Parameters.AddWithValue("@normal_damage_rate", scienceFiction.NormalDamageRate);
                            insertCmd.Parameters.AddWithValue("@normal_resistance_rate", scienceFiction.NormalResistanceRate);
                            insertCmd.Parameters.AddWithValue("@skill_damage_rate", scienceFiction.SkillDamageRate);
                            insertCmd.Parameters.AddWithValue("@skill_resistance_rate", scienceFiction.SkillResistanceRate);
                            insertCmd.Parameters.AddWithValue("@percent_all_health", scienceFiction.PercentAllHealth);
                            insertCmd.Parameters.AddWithValue("@percent_all_physical_attack", scienceFiction.PercentAllPhysicalAttack);
                            insertCmd.Parameters.AddWithValue("@percent_all_physical_defense", scienceFiction.PercentAllPhysicalDefense);
                            insertCmd.Parameters.AddWithValue("@percent_all_magical_attack", scienceFiction.PercentAllMagicalAttack);
                            insertCmd.Parameters.AddWithValue("@percent_all_magical_defense", scienceFiction.PercentAllMagicalDefense);
                            insertCmd.Parameters.AddWithValue("@percent_all_chemical_attack", scienceFiction.PercentAllChemicalAttack);
                            insertCmd.Parameters.AddWithValue("@percent_all_chemical_defense", scienceFiction.PercentAllChemicalDefense);
                            insertCmd.Parameters.AddWithValue("@percent_all_atomic_attack", scienceFiction.PercentAllAtomicAttack);
                            insertCmd.Parameters.AddWithValue("@percent_all_atomic_defense", scienceFiction.PercentAllAtomicDefense);
                            insertCmd.Parameters.AddWithValue("@percent_all_mental_attack", scienceFiction.PercentAllMentalAttack);
                            insertCmd.Parameters.AddWithValue("@percent_all_mental_defense", scienceFiction.PercentAllMentalDefense);
