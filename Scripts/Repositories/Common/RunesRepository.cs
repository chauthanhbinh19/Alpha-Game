...
{ 
    public List<string> GetUniqueRuneId()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct id from Runes";
    ...
    public List<Runes> GetRunes(int pageSize, int offset, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = @"Select * from Runes WHERE (@rare = 'All' or rare = @rare)
                ORDER BY Runes.name REGEXP '[0-9]+$',CAST(REGEXP_SUBSTR(Runes.name, '[0-9]+$') AS UNSIGNED), Runes.name limit @limit offset @offset";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public List<Runes> GetRunesWithPrice(int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Runes t, Rune_trade tt, currency cu
                where t.id=tt.Rune_id and tt.currency_id = cu.id
    ...
    public Runes GetRunesById(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = "Select * from Runes where id=@id";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public Runes SumPowerRunesPercent()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Runes a, user_Runes ua
                where a.id=ua.Rune_id and ua.user_id=@user_id;";
                MySqlCommand command = new MySqlCommand(query, connection);
