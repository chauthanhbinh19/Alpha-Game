...
public class FoodsRepository : IFoodsRepository
{
    public async Task<List<string>> GetUniqueFoodsIdAsync()
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT DISTINCT id FROM Foods";
    ...
    public async Task<int> GetFoodsCountAsync(string search, string rare)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Foods WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<Foods>> InsertFoodAsync(Foods entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO foods (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Foods>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Foods>.Failure($"Failed When Insert Food: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Foods>> UpdateFoodAsync(Foods entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE foods SET
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Foods>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Foods>.Failure($"Failed When Update Food: {ex.Message}");
        }
    }
    public async Task<bool> IsFoodDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM foods WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking food status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Foods entity)
    {
    ...
    public async Task<Foods> GetFoodByIdAsync(string id)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Foods WHERE id = @id";
    ...
    public async Task<Foods> SumPowerFoodsPercentAsync(string userId)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Foods a
                JOIN user_foods ua ON a.id = ua.food_id
            ...
            ";
                ...
                await using (var selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    await using (var reader = await selectCommand.ExecuteReaderAsync())
                    {
                        if (await reader.ReadAsync())
                        {
                            sumFoods.PercentAllHealth = reader.IsDBNull(reader.GetOrdinal("total_percent_all_health")) ? 0 : reader.GetDoubleSafe("total_percent_all_health");
                            sumFoods.PercentAllPhysicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_attack");
                            sumFoods.PercentAllPhysicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_defense");
                            sumFoods.PercentAllMagicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_attack");
                            sumFoods.PercentAllMagicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_defense");
                            sumFoods.PercentAllChemicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_attack");
                            sumFoods.PercentAllChemicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_defense");
                            sumFoods.PercentAllAtomicAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_attack");
                            sumFoods.PercentAllAtomicDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_defense");
                            sumFoods.PercentAllMentalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_attack");
                            sumFoods.PercentAllMentalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_defense");
                        }
                    }
                }
            }
