...
public class FashionsRepository : IFashionsRepository
{
    public async Task<List<string>> GetUniqueFashionsTypesAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM Fashions";
    ...
    public async Task<List<string>> GetUniqueFashionsIdAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT id FROM Fashions";
            using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
            using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
            {
                while (await reader.ReadAsync())
    ...
    public async Task<List<Fashions>> GetFashionsAsync(string search, string type, string rare, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM Fashions WHERE 1=1";
    ...
    public async Task<List<Fashions>> GetFashionsWithoutLimitAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM fashions";
    ...
    public async Task<int> GetFashionsCountAsync(string search, string type, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Fashions WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<Fashions>> InsertFashionAsync(Fashions entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO fashions (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Fashions>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Fashions>.Failure($"Failed When Insert Fashion: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Fashions>> UpdateFashionAsync(Fashions entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE fashions SET
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Fashions>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Fashions>.Failure($"Failed When Update Fashion: {ex.Message}");
        }
    }
    public async Task<bool> IsFashionDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM fashions WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking fashion status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Fashions entity)
    {
    ...
    public async Task<List<Fashions>> GetFashionsWithPriceAsync(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Fashions s
                JOIN fashion_trade st ON s.id = st.fashion_id
    ...
    public async Task<Fashions> GetFashionByIdAsync(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Fashions WHERE id=@id";
                using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
    ...
    public async Task<Fashions> SumPowerFashionsPercentAsync(string userId)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Fashions a
                JOIN user_Fashions ua ON a.id = ua.fashion_id
