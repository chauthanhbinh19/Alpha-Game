...
public class CardSpellsRepository : ICardSpellsRepository
{
    public async Task<List<string>> GetUniqueCardSpellsTypesAsync()
    {
        ...
        try
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM card_spells";
    ...
    public async Task<List<string>> GetUniqueCardSpellsIdAsync()
    {
        ...
        try
        {
            ...
            string selectSQL = "SELECT DISTINCT id FROM card_spells";
            await using var selectCommand = new MySqlCommand(selectSQL, connection);
    ...
    public async Task<List<CardSpells>> GetCardSpellsWithoutLimitAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM card_spells";
    ...
    public async Task<int> GetCardSpellsCountAsync(string search, string type, string rare)
    {
        ...
        try
        {
            ...
            string selectSQL = @"SELECT COUNT(*) FROM card_spells WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<CardSpells>> InsertCardSpellAsync(CardSpells entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO card_spells (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<CardSpells>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<CardSpells>.Failure($"Failed When Insert Card Spell: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<CardSpells>> UpdateCardSpellAsync(CardSpells entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE card_spells SET
            name = @name,
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<CardSpells>.Updated(entity);
                }
    ...
    public async Task<List<CardSpells>> GetCardSpellsRandomAsync(string type, int pageSize)
    {
        ...
        try
        {
            ...
            string selectSQL = "SELECT * FROM card_spells WHERE type = @type ORDER BY RAND() LIMIT @limit";
            await using var selectCommand = new MySqlCommand(selectSQL, connection);
            selectCommand.Parameters.AddWithValue("@type", type);
            selectCommand.Parameters.AddWithValue("@limit", pageSize);
    ...
    public async Task<List<CardSpells>> GetAllCardSpellsAsync(string type)
    {
        ...
        try
        {
            ...
            string selectSQL = "SELECT * FROM card_spells WHERE type = @type";
            await using var selectCommand = new MySqlCommand(selectSQL, connection);
            selectCommand.Parameters.AddWithValue("@type", type);
    ...
    public async Task<CardSpells> GetCardSpellByIdAsync(string Id)
    {
        ...
        try
        {
            ...
            string selectSQL = "SELECT * FROM card_spells WHERE id = @id";
            await using var selectCommand = new MySqlCommand(selectSQL, connection);
