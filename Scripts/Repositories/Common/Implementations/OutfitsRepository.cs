...
public class OutfitsRepository : IOutfitsRepository
{
    public async Task<List<string>> GetUniqueOutfitsTypesAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM outfits";
    ...
    public async Task<List<string>> GetUniqueOutfitsIdAsync()
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT DISTINCT id FROM Outfits";
    ...
    public async Task<List<Outfits>> GetOutfitsAsync(string search, string type, string rare, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM outfits WHERE 1=1";
    ...
    public async Task<List<Outfits>> GetOutfitsWithoutLimitAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM outfits";
    ...
    public async Task<int> GetOutfitsCountAsync(string search, string type, string rare)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Outfits where 1=1";
    ...
    public async Task<InsertOrUpdateResult<Outfits>> InsertOutfitAsync(Outfits entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO outfits (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Outfits>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Outfits>.Failure($"Failed When Insert Outfit: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Outfits>> UpdateOutfitAsync(Outfits entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE outfits SET
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Outfits>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Outfits>.Failure($"Failed When Update Outfit: {ex.Message}");
        }
    }
    public async Task<bool> IsOutfitDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM outfits WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking outfit status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Outfits entity)
    {
    ...
    public async Task<List<Outfits>> GetOutfitsWithPriceAsync(string type, int pageSize, int offset)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Outfits t
                JOIN outfit_trade tt ON t.id = tt.outfit_id
    ...
    public async Task<Outfits> GetOutfitByIdAsync(string id)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Outfits WHERE id = @id";
    ...
    public async Task<Outfits> SumPowerOutfitsPercentAsync(string userId)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Outfits a
                JOIN user_Outfits ua ON a.id = ua.outfit_id
            ...
            ";
                ...
                await using (var selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    await using (var reader = await selectCommand.ExecuteReaderAsync())
                    {
                        if (await reader.ReadAsync())
                        {
                            sumOutfits.PercentAllHealth = reader.IsDBNull(reader.GetOrdinal("total_percent_all_health")) ? 0 : reader.GetDoubleSafe("total_percent_all_health");
                            sumOutfits.PercentAllPhysicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_attack");
                            sumOutfits.PercentAllPhysicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_defense");
                            sumOutfits.PercentAllMagicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_attack");
                            sumOutfits.PercentAllMagicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_defense");
                            sumOutfits.PercentAllChemicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_attack");
                            sumOutfits.PercentAllChemicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_defense");
                            sumOutfits.PercentAllAtomicAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_attack");
                            sumOutfits.PercentAllAtomicDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_defense");
                            sumOutfits.PercentAllMentalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_attack");
                            sumOutfits.PercentAllMentalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_defense");
                        }
                    }
                }
            }
