...
public class WeaponsRepository : IWeaponsRepository
{
    public async Task<List<string>> GetUniqueWeaponsTypesAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM weapons";
    ...
    public async Task<List<string>> GetUniqueWeaponsIdAsync()
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT DISTINCT id FROM Weapons";
    ...
    public async Task<List<Weapons>> GetWeaponsAsync(string search, string type, string rare, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM weapons WHERE 1=1";
    ...
    public async Task<int> GetWeaponsCountAsync(string search, string type, string rare)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Weapons where 1=1";
    ...
    public async Task<InsertOrUpdateResult<Weapons>> InsertWeaponAsync(Weapons entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO weapons (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Weapons>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Weapons>.Failure($"Failed When Insert Weapon: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Weapons>> UpdateWeaponAsync(Weapons entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE weapons SET
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Weapons>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Weapons>.Failure($"Failed When Update Weapon: {ex.Message}");
        }
    }
    public async Task<bool> IsWeaponDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM weapons WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking weapon status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Weapons entity)
    {
    ...
    public async Task<List<Weapons>> GetWeaponsWithPriceAsync(string type, int pageSize, int offset)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Weapons t
                JOIN weapon_trade tt ON t.id = tt.weapon_id
    ...
    public async Task<Weapons> GetWeaponByIdAsync(string id)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Weapons WHERE id = @id";
    ...
    public async Task<Weapons> SumPowerWeaponsPercentAsync(string userId)
    {
        ...
        await using (var connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Weapons a
                JOIN user_Weapons ua ON a.id = ua.weapon_id
            ...
            ";
                ...
                await using (var selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    await using (var reader = await selectCommand.ExecuteReaderAsync())
                    {
                        if (await reader.ReadAsync())
                        {
                            sumWeapons.PercentAllHealth = reader.IsDBNull(reader.GetOrdinal("total_percent_all_health")) ? 0 : reader.GetDoubleSafe("total_percent_all_health");
                            sumWeapons.PercentAllPhysicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_attack");
                            sumWeapons.PercentAllPhysicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_defense");
                            sumWeapons.PercentAllMagicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_attack");
                            sumWeapons.PercentAllMagicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_defense");
                            sumWeapons.PercentAllChemicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_attack");
                            sumWeapons.PercentAllChemicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_defense");
                            sumWeapons.PercentAllAtomicAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_attack");
                            sumWeapons.PercentAllAtomicDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_defense");
                            sumWeapons.PercentAllMentalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_attack");
                            sumWeapons.PercentAllMentalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_defense");
                        }
                    }
                }
            }
