...
public class CardAdmiralsRepository : ICardAdmiralsRepository
{
    public async Task<List<string>> GetUniqueCardAdmiralsTypesAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT DISTINCT type FROM card_admirals";
    ...
    public async Task<List<string>> GetUniqueCardAdmiralsIdAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT DISTINCT id FROM card_admirals";
                await using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                await using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
                {
                    while (await reader.ReadAsync())
    ...
    public async Task<int> GetCardAdmiralsCountAsync(string search, string type, string rare)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM card_admirals WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<CardAdmirals>> InsertCardAdmiralAsync(CardAdmirals entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        INSERT INTO card_admirals (
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<CardAdmirals>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<CardAdmirals>.Failure($"Failed When Insert Card Admiral: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<CardAdmirals>> UpdateCardAdmiralAsync(CardAdmirals entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE card_admirals SET
            name = @name,
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<CardAdmirals>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<CardAdmirals>.Failure($"Failed When Update Card Admiral: {ex.Message}");
        }
    }
    public async Task<bool> IsCardAdmiralDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM card_admirals WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking card admiral status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, CardAdmirals entity)
    {
            ...
            try
            {
                ...
                string selectSQL = @"
                    ...
                    (
                        ...
                        WHERE che.card_admiral_id = ch.id
                    ) AS emblems_json,
                    (
                        SELECT JSON_ARRAYAGG(
                            JSON_OBJECT(
                        ...
                        WHERE chc.card_admiral_id = ch.id
                    ) AS classes_json
    ...
    public async Task<List<CardAdmirals>> GetCardAdmiralsRandomAsync(string type, int pageSize)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM card_admirals WHERE type = @type ORDER BY RAND() LIMIT @limit";
    ...
    public async Task<List<CardAdmirals>> GetAllCardAdmiralsAsync(string type)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM card_admirals WHERE type = @type";
    ...
    public async Task<CardAdmirals> GetCardAdmiralByIdAsync(string Id)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM card_admirals WHERE id = @id";
