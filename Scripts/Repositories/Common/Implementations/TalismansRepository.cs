...
public class TalismansRepository : ITalismansRepository
{
    public async Task<List<string>> GetUniqueTalismansTypesAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM Talismans";
    ...
    public async Task<List<string>> GetUniqueTalismansIdAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT id FROM Talismans";
            using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
            using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
            {
                while (await reader.ReadAsync())
    ...
    public async Task<List<Talismans>> GetTalismansAsync(string search, string type, string rare, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM Talismans WHERE 1=1";
    ...
    public async Task<int> GetTalismansCountAsync(string search, string type, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Talismans WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<Talismans>> InsertTalismanAsync(Talismans entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Talismans>.Inserted(entity);
                }

                return InsertOrUpdateResult<Talismans>.Failure();
            }
        }
        catch (Exception ex)
        {
            return InsertOrUpdateResult<Talismans>.Failure($"Failed When Insert Talisman: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Talismans>> UpdateTalismanAsync(Talismans entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        UPDATE talismans SET
            name = @name,
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Talismans>.Updated(entity);
                }
    ...
    public async Task<List<Talismans>> GetTalismansWithPriceAsync(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Talismans s
                JOIN talisman_trade st ON s.id = st.talisman_id
    ...
    public async Task<Talismans> GetTalismanByIdAsync(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Talismans WHERE id=@id";
                using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
    ...
    public async Task<Talismans> SumPowerTalismansPercentAsync(string userId)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Talismans a
                JOIN user_talismans ua ON a.id = ua.talisman_id
