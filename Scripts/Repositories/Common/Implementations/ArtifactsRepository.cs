...
public class ArtifactsRepository : IArtifactsRepository
{
    ...
    public async Task<InsertOrUpdateResult<Artifacts>> InsertArtifactAsync(Artifacts entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Artifacts>.Inserted(entity);
                }

                return InsertOrUpdateResult<Artifacts>.Failure();
            }
        }
        catch (Exception ex)
        {
            return InsertOrUpdateResult<Artifacts>.Failure($"Failed When Insert Artifact: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Artifacts>> UpdateArtifactAsync(Artifacts entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Artifacts>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Artifacts>.Failure($"Failed When Update Artifact: {ex.Message}");
        }
    }
    public async Task<bool> IsArtifactDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM artifacts WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking artifact status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Artifacts entity)
    {
    ...
    public async Task<List<Artifacts>> GetArtifactsWithPriceAsync(int pageSize, int offset)
    {
        ...
        try
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                artifact.Currency = new Currencies
                {
    ...
    public async Task<Artifacts> SumPowerArtifactsPercentAsync(string userId)
    {
        ...
        try
        {
            ...
            FROM artifacts a
            INNER JOIN user_artifacts ua ON a.id = ua.artifact_id
        ...
        ";
            ...
            if (await reader.ReadAsync())
            {
                ...
                sumArtifacts.PercentAllPhysicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_attack");
                sumArtifacts.PercentAllPhysicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_physical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_physical_defense");
                sumArtifacts.PercentAllMagicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_attack");
                sumArtifacts.PercentAllMagicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_magical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_magical_defense");
                sumArtifacts.PercentAllChemicalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_attack");
                sumArtifacts.PercentAllChemicalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_chemical_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_chemical_defense");
                sumArtifacts.PercentAllAtomicAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_attack");
                sumArtifacts.PercentAllAtomicDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_atomic_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_atomic_defense");
                sumArtifacts.PercentAllMentalAttack = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_attack")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_attack");
                sumArtifacts.PercentAllMentalDefense = reader.IsDBNull(reader.GetOrdinal("total_percent_all_mental_defense")) ? 0 : reader.GetDoubleSafe("total_percent_all_mental_defense");
            }
        }
        catch (MySqlException ex)
        {
