...
public class BuildingsRepository : IBuildingsRepository
{
    public async Task<List<string>> GetUniqueBuildingsTypesAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT type FROM Buildings";
    ...
    public async Task<List<string>> GetUniqueBuildingsIdAsync()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string selectSQL = "SELECT DISTINCT id FROM Buildings";
            using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
            using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
            {
                while (await reader.ReadAsync())
    ...
    public async Task<List<Buildings>> GetBuildingsAsync(string search, string type, string rare, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM Buildings WHERE 1=1";
                ...
                using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            Buildings symbol = new Buildings
                            {
    ...
    public async Task<List<Buildings>> GetBuildingsWithoutLimitAsync()
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT * FROM buildings";
    ...
    public async Task<int> GetBuildingsCountAsync(string search, string type, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = @"SELECT COUNT(*) FROM Buildings WHERE 1=1";
    ...
    public async Task<InsertOrUpdateResult<Buildings>> InsertBuildingAsync(Buildings entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Buildings>.Inserted(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Buildings>.Failure($"Failed When Insert Building: {ex.Message}");
        }
    }
    public async Task<InsertOrUpdateResult<Buildings>> UpdateBuildingAsync(Buildings entity)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = @"
        ...
        try
        {
            ...
            using (var cmd = new MySqlCommand(sql, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    return InsertOrUpdateResult<Buildings>.Updated(entity);
                }
        ...
        {
            return InsertOrUpdateResult<Buildings>.Failure($"Failed When Update Building: {ex.Message}");
        }
    }
    public async Task<bool> IsBuildingDeletedOrInactiveAsync(string id)
    {
        if (string.IsNullOrEmpty(id)) return true;

        string connectionString = DatabaseConfig.ConnectionString;
        const string sql = "SELECT 1 FROM buildings WHERE id = @id AND (is_deleted = TRUE OR is_active = FALSE) LIMIT 1;";
        ...
        {
            Debug.LogError($"Error checking building status: {ex.Message}");
            return true;
        }
    }
    private void AddParameters(MySqlCommand command, Buildings entity)
    {
    ...
    public async Task<List<Buildings>> GetBuildingsWithPriceAsync(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Buildings s
                JOIN Building_trade st ON s.id = st.building_id
    ...
    public async Task<Buildings> GetBuildingByIdAsync(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                string selectSQL = "SELECT * FROM Buildings WHERE id=@id";
                using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
    ...
    public async Task<Buildings> SumPowerBuildingsPercentAsync(string userId)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                FROM Buildings a
                JOIN user_buildings ua ON a.id = ua.building_id
