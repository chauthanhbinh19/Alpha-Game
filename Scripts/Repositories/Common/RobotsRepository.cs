...
{ 
    public List<string> GetUniqueRobotId()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct id from Robots";
    ...
    public List<Robots> GetRobots(int pageSize, int offset, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = @"Select * from Robots WHERE (@rare = 'All' or rare = @rare)
                ORDER BY Robots.name REGEXP '[0-9]+$',CAST(REGEXP_SUBSTR(Robots.name, '[0-9]+$') AS UNSIGNED), Robots.name limit @limit offset @offset";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public List<Robots> GetRobotsWithPrice(int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Robots t, Robot_trade tt, currency cu
                where t.id=tt.Robot_id and tt.currency_id = cu.id
    ...
    public Robots GetRobotsById(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = "Select * from Robots where id=@id";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public Robots SumPowerRobotsPercent()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from Robots a, user_Robots ua
                where a.id=ua.Robot_id and ua.user_id=@user_id;";
                MySqlCommand command = new MySqlCommand(query, connection);
