...
public class HITNsRepository : IHITNsRepository
{
    ...
    public async Task InsertOrUpdateHITNsAsync(string user_id, HITNs HITNs, string id)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    private void AddAllParameters(MySqlCommand cmd, HITNs a, string user_id, string type)
    {
