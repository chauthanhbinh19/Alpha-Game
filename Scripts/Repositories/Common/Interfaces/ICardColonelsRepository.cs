...
public interface ICardColonelsRepository
{
    ...
    Task<InsertOrUpdateResult<CardColonels>> InsertCardColonelAsync(CardColonels entity);
    Task<InsertOrUpdateResult<CardColonels>> UpdateCardColonelAsync(CardColonels entity);
