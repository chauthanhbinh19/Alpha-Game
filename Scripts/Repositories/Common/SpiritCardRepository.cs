...
public class SpiritCardRepository : ISpiritCardRepository
{ 
    public List<string> GetUniqueSpiritCardTypes()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct type from spirit_card";
    ...
    public List<string> GetUniqueSpiritCardId()
    {
        List<string> typeList = new List<string>();
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            string query = "Select distinct id from spirit_card";
            MySqlCommand command = new MySqlCommand(query, connection);
            MySqlDataReader reader = command.ExecuteReader();
            while (reader.Read())
            {
    ...
    public List<SpiritCards> GetSpiritCard(string type, int pageSize, int offset, string rare)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = @"Select * from spirit_card WHERE type= @type AND (@rare = 'All' or rare = @rare)
                ORDER BY spirit_card.name REGEXP '[0-9]+$',CAST(REGEXP_SUBSTR(spirit_card.name, '[0-9]+$') AS UNSIGNED), spirit_card.name limit @limit offset @offset";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public List<SpiritCards> GetSpiritCardWithPrice(string type, int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from spirit_card t, spirit_card_trade tt, currency cu
    ...
    public SpiritCards GetSpiritCardById(string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = "Select * from spirit_card where id=@id";
                MySqlCommand command = new MySqlCommand(query, connection);
    ...
    public SpiritCards SumPowerSpiritCardPercent()
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from spirit_card a, user_spirit_card ua
                where a.id=ua.spirit_card_id and ua.user_id=@user_id;";
                MySqlCommand command = new MySqlCommand(query, connection);
