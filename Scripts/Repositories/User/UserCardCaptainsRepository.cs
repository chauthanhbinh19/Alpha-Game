...
public class UserCardCaptainsRepository : IUserCardCaptainsRepository
{
    public async Task<List<CardCaptains>> GetUserCardCaptainsAsync(string user_id, string search, string type, int pageSize, int offset, string rare)
    {
        ...
        ";
            ...
            query += " GROUP BY uc.card_captain_id, c.id, t.team_number";
    ...
    public async Task<bool> InsertUserCardCaptainAsync(CardCaptains cardCaptain)
    {
        ...
        ";
            ...
            ";
                ...
                insertCommand.Parameters.AddWithValue("@rare", cardCaptain.Rare);
    ...
    public async Task<bool> UpdateCardCaptainLevelAsync(CardCaptains cardCaptain, int cardLevel)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task<List<CardCaptains>> GetAllUserCardCaptainsInTeamAsync(string user_id)
    {
        ...
        try
        {
            ...
            while (await reader.ReadAsync())
            {
                CardCaptains cardAdmiral = new CardCaptains
                {
                    Id = reader.GetStringSafe("card_captain_id"),
                    Name = reader.GetStringSafe("name"),
                    Image = reader.GetStringSafe("image"),
