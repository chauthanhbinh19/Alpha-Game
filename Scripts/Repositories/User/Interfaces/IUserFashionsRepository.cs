...
public interface IUserFashionsRepository
{
    ...
    Task<bool> UpdateUserFashionLevelAsync(Fashions fashion);
    Task<bool> UpdateUserFashionStarAsync(Fashions fashion);
    Task<bool> UpdateUserFashionBreakthroughAsync(Fashions fashion, int star, double quantity);
