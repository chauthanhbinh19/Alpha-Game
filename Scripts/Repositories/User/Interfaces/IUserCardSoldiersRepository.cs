...
public interface IUserCardSoldiersRepository
{
    ...
    Task<List<CardSoldiers>> GetUserCardSoldiersInTeamAsync(string userId);
    Task<List<CardSoldiers>> GetUserCardSoldiersInTeamSimpleAsync(string userId, string teamId);
