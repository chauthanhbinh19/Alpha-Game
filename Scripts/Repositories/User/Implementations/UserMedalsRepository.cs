                ...
                await using (MySqlCommand checkCommand = new MySqlCommand(checkSQL, connection))
                {
                    ...
                    if (count == 0)
                    {
                        ...
                        await using (MySqlCommand insertCommand = new MySqlCommand(insertSQL, connection))
                        {
                            ...
                            insertCommand.Parameters.AddWithValue("@rare", medal.Rarity);
                            insertCommand.Parameters.AddWithValue("@level", 0);
                            insertCommand.Parameters.AddWithValue("@experience", 0);
                            insertCommand.Parameters.AddWithValue("@star", 0);
                            insertCommand.Parameters.AddWithValue("@quality", QualityEvaluatorHelper.CheckQuality(medal.Rarity));
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                await using (MySqlCommand updateCommand = new MySqlCommand(updateSQL, connection))
                {
                    ...
                    updateCommand.Parameters.AddWithValue("@mental_attack", medal.MentalAttack);
                    updateCommand.Parameters.AddWithValue("@mental_defense", medal.MentalDefense);
