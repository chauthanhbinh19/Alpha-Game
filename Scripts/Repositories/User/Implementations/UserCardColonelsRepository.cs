...
public class UserCardColonelsRepository : IUserCardColonelsRepository
{
    ...
    string userId, List<CardColonels> cardColonels)
    {
        ...
        try
        {
            ...
            // 1. Query lấy TOÀN BỘ card_colonel_id hiện có của User (Cực nhanh nhờ Index user_id)
            ...
            // 2. Phân loại CardColonels giữ NGUYÊN VẸN OBJECT thuộc tính trong RAM C#
            ...
            {
                var batch = cardColonels.Skip(i).Take(batchSize).ToList();
            ...
            INSERT INTO user_card_colonels (
                ...
                for (int j = 0; j < batch.Count; j++)
                {
                    ...
                    stringBuilder.Append($@"
                (@user_id, @card_colonel_id_{j}, @rare_{j}, 0, 0, 0, @quality_{j}, 0, @quantity_{j},
                ...
                @skill_damage_rate_{j}, @skill_resistance_rate_{j}
                    ...
                    {
                    new MySqlParameter($"@card_colonel_id_{j}", c.Id),
