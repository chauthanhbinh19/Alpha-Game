    ...
    public async Task<Emojis> SumPowerUserEmojisAsync(string userId)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            ";
                ...
                if (await reader.ReadAsync())
                {
                    sumEmojis.Health = reader.GetDoubleSafe("health");
                    sumEmojis.PhysicalAttack = reader.GetDoubleSafe("physical_attack");
                    sumEmojis.PhysicalDefense = reader.GetDoubleSafe("physical_defense");
                    sumEmojis.MagicalAttack = reader.GetDoubleSafe("magical_attack");
                    sumEmojis.MagicalDefense = reader.GetDoubleSafe("magical_defense");
                    sumEmojis.ChemicalAttack = reader.GetDoubleSafe("chemical_attack");
                    sumEmojis.ChemicalDefense = reader.GetDoubleSafe("chemical_defense");
                    sumEmojis.AtomicAttack = reader.GetDoubleSafe("atomic_attack");
                    sumEmojis.AtomicDefense = reader.GetDoubleSafe("atomic_defense");
                    sumEmojis.MentalAttack = reader.GetDoubleSafe("mental_attack");
                    sumEmojis.MentalDefense = reader.GetDoubleSafe("mental_defense");
                    sumEmojis.Speed = reader.GetDoubleSafe("speed");
                    sumEmojis.CriticalDamageRate = reader.GetDoubleSafe("critical_damage_rate");
                    sumEmojis.CriticalRate = reader.GetDoubleSafe("critical_rate");
                    sumEmojis.CriticalResistanceRate = reader.GetDoubleSafe("critical_resistance_rate");
                    sumEmojis.IgnoreCriticalRate = reader.GetDoubleSafe("ignore_critical_rate");
                    sumEmojis.PenetrationRate = reader.GetDoubleSafe("penetration_rate");
                    sumEmojis.PenetrationResistanceRate = reader.GetDoubleSafe("penetration_resistance_rate");
                    sumEmojis.EvasionRate = reader.GetDoubleSafe("evasion_rate");
                    sumEmojis.DamageAbsorptionRate = reader.GetDoubleSafe("damage_absorption_rate");
                    sumEmojis.IgnoreDamageAbsorptionRate = reader.GetDoubleSafe("ignore_damage_absorption_rate");
                    sumEmojis.AbsorbedDamageRate = reader.GetDoubleSafe("absorbed_damage_rate");
                    sumEmojis.VitalityRegenerationRate = reader.GetDoubleSafe("vitality_regeneration_rate");
                    sumEmojis.VitalityRegenerationResistanceRate = reader.GetDoubleSafe("vitality_regeneration_resistance_rate");
                    sumEmojis.AccuracyRate = reader.GetDoubleSafe("accuracy_rate");
                    sumEmojis.LifestealRate = reader.GetDoubleSafe("lifesteal_rate");
                    sumEmojis.ShieldStrength = reader.GetDoubleSafe("shield_strength");
                    sumEmojis.Tenacity = reader.GetDoubleSafe("tenacity");
                    sumEmojis.ResistanceRate = reader.GetDoubleSafe("resistance_rate");
                    sumEmojis.ComboRate = reader.GetDoubleSafe("combo_rate");
                    sumEmojis.IgnoreComboRate = reader.GetDoubleSafe("ignore_combo_rate");
                    sumEmojis.ComboDamageRate = reader.GetDoubleSafe("combo_damage_rate");
                    sumEmojis.ComboResistanceRate = reader.GetDoubleSafe("combo_resistance_rate");
                    sumEmojis.StunRate = reader.GetDoubleSafe("stun_rate");
                    sumEmojis.IgnoreStunRate = reader.GetDoubleSafe("ignore_stun_rate");
                    sumEmojis.ReflectionRate = reader.GetDoubleSafe("reflection_rate");
                    sumEmojis.IgnoreReflectionRate = reader.GetDoubleSafe("ignore_reflection_rate");
                    sumEmojis.ReflectionDamageRate = reader.GetDoubleSafe("reflection_damage_rate");
                    sumEmojis.ReflectionResistanceRate = reader.GetDoubleSafe("reflection_resistance_rate");
                    sumEmojis.Mana = reader.GetDoubleSafe("mana");
                    sumEmojis.ManaRegenerationRate = reader.GetDoubleSafe("mana_regeneration_rate");
                    sumEmojis.DamageToDifferentFactionRate = reader.GetDoubleSafe("damage_to_different_faction_rate");
                    sumEmojis.ResistanceToDifferentFactionRate = reader.GetDoubleSafe("resistance_to_different_faction_rate");
                    sumEmojis.DamageToSameFactionRate = reader.GetDoubleSafe("damage_to_same_faction_rate");
                    sumEmojis.ResistanceToSameFactionRate = reader.GetDoubleSafe("resistance_to_same_faction_rate");
                    sumEmojis.NormalDamageRate = reader.GetDoubleSafe("normal_damage_rate");
                    sumEmojis.NormalResistanceRate = reader.GetDoubleSafe("normal_resistance_rate");
                    sumEmojis.SkillDamageRate = reader.GetDoubleSafe("skill_damage_rate");
                    sumEmojis.SkillResistanceRate = reader.GetDoubleSafe("skill_resistance_rate");
                }
            }
            catch (MySqlException ex)
            {
