...
public class UserCardHeroesRepository : IUserCardHeroesRepository
{
    ...
    public async Task<bool> UpdateTeamCardHeroAsync(string teamId, string position, string cardId)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task<List<CardHeroes>> GetAllUserCardHeroesInTeamAsync(string userId)
    {
        List<CardHeroes> cardHeroes = new List<CardHeroes>();
        string connectionString = DatabaseConfig.ConnectionString;
