...
public class UserCardGeneralsRepository : IUserCardGeneralsRepository
{
    ...
    public async Task<bool> UpdateTeamCardGeneralAsync(string teamId, string position, string cardId)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task<List<CardGenerals>> GetAllUserCardGeneralsInTeamAsync(string userId)
    {
        List<CardGenerals> cardGenerals = new List<CardGenerals>();
        string connectionString = DatabaseConfig.ConnectionString;
