...
public class UserCardGeneralsRepository : IUserCardGeneralsRepository
{
    ...
    string userId, List<CardGenerals> cardGenerals)
    {
        ...
        try
        {
            ...
            // 1. Query lấy TOÀN BỘ card_general_id hiện có của User (Cực nhanh nhờ Index user_id)
            ...
            // 2. Phân loại CardGenerals giữ NGUYÊN VẸN OBJECT thuộc tính trong RAM C#
            ...
            {
                var batch = cardGenerals.Skip(i).Take(batchSize).ToList();
            ...
            INSERT INTO user_card_generals (
                ...
                for (int j = 0; j < batch.Count; j++)
                {
                    ...
                    stringBuilder.Append($@"
                (@user_id, @card_general_id_{j}, @rare_{j}, 0, 0, 0, @quality_{j}, 0, @quantity_{j},
