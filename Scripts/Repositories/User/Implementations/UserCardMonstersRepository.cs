...
public class UserCardMonstersRepository : IUserCardMonstersRepository
{
    ...
    public async Task<bool> UpdateTeamCardMonsterAsync(string teamId, string position, string cardId)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task<bool> InsertUserCardMonsterAsync(CardMonsters cardMonster)
    {
        ...
        ";
            ...
            ";
                ...
                insertCommand.Parameters.AddWithValue("@rare", cardMonster.Rarity);
                insertCommand.Parameters.AddWithValue("@level", 0);
                insertCommand.Parameters.AddWithValue("@experience", 0);
                insertCommand.Parameters.AddWithValue("@star", 0);
                insertCommand.Parameters.AddWithValue("@quality", QualityEvaluatorHelper.CheckQuality(cardMonster.Rarity));
    ...
    public async Task<bool> InsertOrUpdateUserCardMonstersBatchAsync(List<CardMonsters> cardMonsters)
    {
        ...
        try
        {
            ...
            {
                var batch = cardMonsters.Skip(i).Take(batchSize).ToList();
                ...
                for (int j = 0; j < batch.Count; j++)
                {
                    ...
                    stringBuilder.Append($@"
                    (@user_id, @card_monster_id_{j}, @rare_{j}, 0, 0, 0, @quality_{j}, 0, @quantity_{j},
                    ...
                    {
                        new MySqlParameter($"@card_monster_id_{j}", c.Id),
    ...
    public async Task<List<CardMonsters>> GetAllUserCardMonstersInTeamAsync(string userId)
    {
        List<CardMonsters> cardMonsters = new List<CardMonsters>();
        string connectionString = DatabaseConfig.ConnectionString;
