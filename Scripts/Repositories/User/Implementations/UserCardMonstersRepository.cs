    ...
    public async Task<bool> InsertUserCardMonsterAsync(CardMonsters cardMonster)
    {
        ...
        ";
            ...
            ";
                ...
                insertCommand.Parameters.AddWithValue("@quality", QualityEvaluatorHelper.CheckQuality(cardMonster.Rare));
        ...
        try
        {
            ...
            for (int i = 0; i < cardMonsters.Count; i += batchSize)
            {
                ...
                ON DUPLICATE KEY UPDATE
                    quantity = user_card_monsters.quantity + VALUES(quantity);
                ");
