...
public class UserScienceFictionsRepository : IUserScienceFictionsRepository
{
    ...
    private void AddAllParameters(MySqlCommand command, UserScienceFictions a, string user_id, string type)
    {
        command.Parameters.AddWithValue("@user_id", user_id);
        command.Parameters.AddWithValue("@science_fiction_id", type);

        command.Parameters.AddWithValue("@science_fiction_level", a.Level == 0 ? 1 : a.Level);
