...
{
    public async Task<Master> GetCardGeneralMasterAsync(string id, string cardId)
    {
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                WHERE user_id = @user_id AND master_id = @id AND user_card_general_id = @card_id;
            ";
    ...
    public async Task InsertOrUpdateCardGeneralMasterAsync(string userId, UserMasters userMaster, string cardId)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                SELECT COUNT(*) 
                FROM user_card_generals_master 
                WHERE user_id = @user_id AND user_card_general_id = @card_id AND master_id = @master_id;
            ";
                ...
                await using (MySqlCommand checkCommand = new MySqlCommand(checkSQL, connection))
                {
                    ...
                    else
                    {
                        ...
                        (
                            user_id, user_card_general_id, master_id, master_level, 
    ...
    public async Task<Master> GetSumCardGeneralsMasterAsync(string userId, string cardId)
    {
        Master master = new Master();
        string connectionString = DatabaseConfig.ConnectionString;
