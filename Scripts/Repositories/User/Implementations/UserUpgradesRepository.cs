...
public class UserUpgradesRepository : IUserUpgradesRepository
{
    ...
    {
        UserUpgrades universe = new UserUpgrades();
            ...
            ";
                ...
                using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
                    {
                        ...
                        {
                            universe.Id = reader.GetStringSafe("Upgrade_id");
                            universe.Level = reader.GetIntSafe("Upgrade_level");
    ...
    public async Task InsertOrUpdateUserUpgradesAsync(string user_id, UserUpgrades Upgrades, string id)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        ...
        try
        {
            ...
            await using (var checkCommand = new MySqlCommand(checkSQL, connection))
            {
                ...
                checkCommand.Parameters.AddWithValue("@Upgrade_id", id);
                ...
                if (count > 0)
                {
                    ...
                    SET
                        Upgrade_level = @Upgrade_level, power = @power, health = @health, mana = @mana, speed = @speed,
                ...
                ";
                    ...
                    AddAllParameters(updateCommand, Upgrades, user_id, id);
                ...
                else
                {
                    ...
                    user_id, Upgrade_id, Upgrade_level, power, health, mana, speed,
                ...
                ";
                    ...
                    AddAllParameters(insertCommand, Upgrades, user_id, id);
    ...
    {
        UserUpgrades universes = new UserUpgrades();
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    private void AddAllParameters(MySqlCommand cmd, UserUpgrades a, string user_id, string type)
    {
        cmd.Parameters.AddWithValue("@user_id", user_id);
        cmd.Parameters.AddWithValue("@Upgrade_id", type);

        cmd.Parameters.AddWithValue("@Upgrade_level", a.Level == 0 ? 1 : a.Level);
