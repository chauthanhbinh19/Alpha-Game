...
public class UserCollaborationEquipmentsRepository : IUserCollaborationEquipmentsRepository
{
                ...
                await using (MySqlCommand checkCommand = new MySqlCommand(checkSQL, connection))
                {
                    ...
                    ";
                        ...
                        using (MySqlCommand insertCommand = new MySqlCommand(insertSQL, connection))
                        {
                            ...
                            insertCommand.Parameters.AddWithValue("@rare", collaborationEquipment.Rarity);
                            insertCommand.Parameters.AddWithValue("@level", 0);
                            insertCommand.Parameters.AddWithValue("@experience", 0);
                            insertCommand.Parameters.AddWithValue("@star", 0);
                            insertCommand.Parameters.AddWithValue("@quality", QualityEvaluatorHelper.CheckQuality(collaborationEquipment.Rarity));
    ...
    public async Task<bool> InsertOrUpdateUserCollaborationEquipmentsBatchAsync(string userId, List<CollaborationEquipments> collaborationEquipments)
    {
        ...
        try
        {
            ...
            {
                var batch = collaborationEquipments.Skip(i).Take(batchSize).ToList();
                ...
                for (int j = 0; j < batch.Count; j++)
                {
                    ...
                    stringBuilder.Append($@"
                    (@user_id, @collaboration_equipment_id_{j}, @rare_{j}, 0, 0, 0, @quality_{j}, 0, @quantity_{j},
                    ...
                    {
                        new MySqlParameter($"@collaboration_equipment_id_{j}", c.Id),
                ...
                ON DUPLICATE KEY UPDATE
                    quantity = COALESCE(user_collaboration_equipments.quantity, 0) + VALUES(quantity);
                ");
        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            ";
                ...
                await using (MySqlCommand updateCommand = new MySqlCommand(updateSQL, connection))
                {
                    updateCommand.Parameters.AddWithValue("@user_id", userId);
                    updateCommand.Parameters.AddWithValue("@collaboration_equipment_id", collaborationEquipment.Id);
                    updateCommand.Parameters.AddWithValue("@level", collaborationEquipment.Level);
                    updateCommand.Parameters.AddWithValue("@experience", collaborationEquipment.Experience);
            ...
            try
            {
                ...
                await using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    await using (var reader = await selectCommand.ExecuteReaderAsync())
                    {
                        if (await reader.ReadAsync())
                        {
                            sumCollaborationEquipments.Health = reader.GetDoubleSafe("health");
                            sumCollaborationEquipments.PhysicalAttack = reader.GetDoubleSafe("physical_attack");
                            sumCollaborationEquipments.PhysicalDefense = reader.GetDoubleSafe("physical_defense");
                            sumCollaborationEquipments.MagicalAttack = reader.GetDoubleSafe("magical_attack");
                            sumCollaborationEquipments.MagicalDefense = reader.GetDoubleSafe("magical_defense");
                            sumCollaborationEquipments.ChemicalAttack = reader.GetDoubleSafe("chemical_attack");
                            sumCollaborationEquipments.ChemicalDefense = reader.GetDoubleSafe("chemical_defense");
                            sumCollaborationEquipments.AtomicAttack = reader.GetDoubleSafe("atomic_attack");
                            sumCollaborationEquipments.AtomicDefense = reader.GetDoubleSafe("atomic_defense");
                            sumCollaborationEquipments.MentalAttack = reader.GetDoubleSafe("mental_attack");
                            sumCollaborationEquipments.MentalDefense = reader.GetDoubleSafe("mental_defense");
                            sumCollaborationEquipments.Speed = reader.GetDoubleSafe("speed");
                            sumCollaborationEquipments.CriticalDamageRate = reader.GetDoubleSafe("critical_damage_rate");
                            sumCollaborationEquipments.CriticalRate = reader.GetDoubleSafe("critical_rate");
                            sumCollaborationEquipments.CriticalResistanceRate = reader.GetDoubleSafe("critical_resistance_rate");
                            sumCollaborationEquipments.IgnoreCriticalRate = reader.GetDoubleSafe("ignore_critical_rate");
                            sumCollaborationEquipments.PenetrationRate = reader.GetDoubleSafe("penetration_rate");
                            sumCollaborationEquipments.PenetrationResistanceRate = reader.GetDoubleSafe("penetration_resistance_rate");
                            sumCollaborationEquipments.EvasionRate = reader.GetDoubleSafe("evasion_rate");
                            sumCollaborationEquipments.DamageAbsorptionRate = reader.GetDoubleSafe("damage_absorption_rate");
                            sumCollaborationEquipments.IgnoreDamageAbsorptionRate = reader.GetDoubleSafe("ignore_damage_absorption_rate");
                            sumCollaborationEquipments.AbsorbedDamageRate = reader.GetDoubleSafe("absorbed_damage_rate");
                            sumCollaborationEquipments.VitalityRegenerationRate = reader.GetDoubleSafe("vitality_regeneration_rate");
                            sumCollaborationEquipments.VitalityRegenerationResistanceRate = reader.GetDoubleSafe("vitality_regeneration_resistance_rate");
                            sumCollaborationEquipments.AccuracyRate = reader.GetDoubleSafe("accuracy_rate");
                            sumCollaborationEquipments.LifestealRate = reader.GetDoubleSafe("lifesteal_rate");
                            sumCollaborationEquipments.ShieldStrength = reader.GetDoubleSafe("shield_strength");
                            sumCollaborationEquipments.Tenacity = reader.GetDoubleSafe("tenacity");
                            sumCollaborationEquipments.ResistanceRate = reader.GetDoubleSafe("resistance_rate");
                            sumCollaborationEquipments.ComboRate = reader.GetDoubleSafe("combo_rate");
                            sumCollaborationEquipments.IgnoreComboRate = reader.GetDoubleSafe("ignore_combo_rate");
                            sumCollaborationEquipments.ComboDamageRate = reader.GetDoubleSafe("combo_damage_rate");
                            sumCollaborationEquipments.ComboResistanceRate = reader.GetDoubleSafe("combo_resistance_rate");
                            sumCollaborationEquipments.StunRate = reader.GetDoubleSafe("stun_rate");
                            sumCollaborationEquipments.IgnoreStunRate = reader.GetDoubleSafe("ignore_stun_rate");
                            sumCollaborationEquipments.ReflectionRate = reader.GetDoubleSafe("reflection_rate");
                            sumCollaborationEquipments.IgnoreReflectionRate = reader.GetDoubleSafe("ignore_reflection_rate");
                            sumCollaborationEquipments.ReflectionDamageRate = reader.GetDoubleSafe("reflection_damage_rate");
                            sumCollaborationEquipments.ReflectionResistanceRate = reader.GetDoubleSafe("reflection_resistance_rate");
                            sumCollaborationEquipments.Mana = reader.GetDoubleSafe("mana");
                            sumCollaborationEquipments.ManaRegenerationRate = reader.GetDoubleSafe("mana_regeneration_rate");
                            sumCollaborationEquipments.DamageToDifferentFactionRate = reader.GetDoubleSafe("damage_to_different_faction_rate");
                            sumCollaborationEquipments.ResistanceToDifferentFactionRate = reader.GetDoubleSafe("resistance_to_different_faction_rate");
                            sumCollaborationEquipments.DamageToSameFactionRate = reader.GetDoubleSafe("damage_to_same_faction_rate");
                            sumCollaborationEquipments.ResistanceToSameFactionRate = reader.GetDoubleSafe("resistance_to_same_faction_rate");
                            sumCollaborationEquipments.NormalDamageRate = reader.GetDoubleSafe("normal_damage_rate");
                            sumCollaborationEquipments.NormalResistanceRate = reader.GetDoubleSafe("normal_resistance_rate");
                            sumCollaborationEquipments.SkillDamageRate = reader.GetDoubleSafe("skill_damage_rate");
                            sumCollaborationEquipments.SkillResistanceRate = reader.GetDoubleSafe("skill_resistance_rate");
                        }
                    }
                }
            }
