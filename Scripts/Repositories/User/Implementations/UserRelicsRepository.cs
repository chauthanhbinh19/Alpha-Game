...
public class UserRelicsRepository : IUserRelicsRepository
{
                ...
                await using (MySqlCommand checkCommand = new MySqlCommand(checkSQL, connection))
                {
                    ...
                    ";
                        ...
                        await using (MySqlCommand insertCommand = new MySqlCommand(insertSQL, connection))
                        {
                            ...
                            insertCommand.Parameters.AddWithValue("@quality", QualityEvaluatorHelper.CheckQuality(relic.Rare));
    ...
    public async Task<bool> UpdateRelicLevelAsync(Relics relic, int level)
    {
        string connectionString = DatabaseConfig.ConnectionString;
