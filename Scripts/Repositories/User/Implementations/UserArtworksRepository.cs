...
public class UserArtworksRepository : IUserArtworksRepository
{
    ...
    public async Task<InsertOrUpdateResult<Artworks>> InsertOrUpdateUserArtworkAsync(string userId, Artworks artwork)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        await using MySqlConnection connection = new MySqlConnection(connectionString);
        ...
        try
        {
            ...
            // Query thực hiện Insert hoặc Update nếu đã tồn tại Composite Primary Key (user_id, artwork_id)
            string upsertSQL = @"
            INSERT INTO user_artworks (
                ...
                @user_id, @artwork_id, @rare, 0, 0, 0, @quality, false, @quantity,
                @power, @health, @physical_attack, @physical_defense, @magical_attack, @magical_defense,
                @chemical_attack, @chemical_defense, @atomic_attack, @atomic_defense, @mental_attack, @mental_defense,
                @speed, @critical_damage_rate, @critical_rate, @critical_resistance_rate, @ignore_critical_rate,
                @penetration_rate, @penetration_resistance_rate,
    ...
    string userId, List<Artworks> artworks)
    {
        ...
        {
            return new InsertOrUpdateResult<BatchOperationResultDTO<Artworks>>
            {
                Data = new BatchOperationResultDTO<Artworks>(),
        ...
        try
        {
            ...
            // 1. Query lấy TOÀN BỘ artwork_id hiện có của User (Cực nhanh nhờ Index user_id)
            var existingIds = new HashSet<string>();
            string checkSql = "SELECT artwork_id FROM user_artworks WHERE user_id = @user_id;";
            ...
            // 2. Phân loại Artworks giữ NGUYÊN VẸN OBJECT thuộc tính trong RAM C#
            var batchResult = new BatchOperationResultDTO<Artworks>();
            foreach (var card in artworks)
            {
            ...
            INSERT INTO user_artworks (
                ...
                stringBuilder.Append(@"
            ON DUPLICATE KEY UPDATE
                quantity = COALESCE(user_artworks.quantity, 0) + VALUES(quantity);
            ");
        ...
        catch (Exception ex)
        {
            ...
            return InsertOrUpdateResult<BatchOperationResultDTO<Artworks>>.Failure(ex.Message);
        }
    }
    public async Task<InsertOrUpdateResult<bool>> UpdateUserArtworkLevelAsync(string userId, Artworks artwork)
    {
        ...
        {
            Debug.LogError("Error UpdateUserArtworkLevel: " + ex.Message);
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateUserArtworkStarAsync(string userId, Artworks artwork)
    {
        ...
        {
            Debug.LogError("Error UpdateUserArtworkStar: " + ex.Message);
            return InsertOrUpdateResult<bool>.Failure(ex.Message);
        }
    }
            ...
            ";
                ...
                await using (MySqlCommand selectCommand = new MySqlCommand(selectSQL, connection))
                {
                    ...
                    await using (MySqlDataReader reader = await selectCommand.ExecuteReaderAsync())
                    {
                        if (await reader.ReadAsync())
                        {
                            sumArtworks.Health = reader.GetDoubleSafe("health");
                            sumArtworks.PhysicalAttack = reader.GetDoubleSafe("physical_attack");
                            sumArtworks.PhysicalDefense = reader.GetDoubleSafe("physical_defense");
                            sumArtworks.MagicalAttack = reader.GetDoubleSafe("magical_attack");
                            sumArtworks.MagicalDefense = reader.GetDoubleSafe("magical_defense");
                            sumArtworks.ChemicalAttack = reader.GetDoubleSafe("chemical_attack");
                            sumArtworks.ChemicalDefense = reader.GetDoubleSafe("chemical_defense");
                            sumArtworks.AtomicAttack = reader.GetDoubleSafe("atomic_attack");
                            sumArtworks.AtomicDefense = reader.GetDoubleSafe("atomic_defense");
                            sumArtworks.MentalAttack = reader.GetDoubleSafe("mental_attack");
                            sumArtworks.MentalDefense = reader.GetDoubleSafe("mental_defense");
                            sumArtworks.Speed = reader.GetDoubleSafe("speed");
                            sumArtworks.CriticalDamageRate = reader.GetDoubleSafe("critical_damage_rate");
                            sumArtworks.CriticalRate = reader.GetDoubleSafe("critical_rate");
                            sumArtworks.CriticalResistanceRate = reader.GetDoubleSafe("critical_resistance_rate");
                            sumArtworks.IgnoreCriticalRate = reader.GetDoubleSafe("ignore_critical_rate");
                            sumArtworks.PenetrationRate = reader.GetDoubleSafe("penetration_rate");
                            sumArtworks.PenetrationResistanceRate = reader.GetDoubleSafe("penetration_resistance_rate");
                            sumArtworks.EvasionRate = reader.GetDoubleSafe("evasion_rate");
                            sumArtworks.DamageAbsorptionRate = reader.GetDoubleSafe("damage_absorption_rate");
                            sumArtworks.IgnoreDamageAbsorptionRate = reader.GetDoubleSafe("ignore_damage_absorption_rate");
                            sumArtworks.AbsorbedDamageRate = reader.GetDoubleSafe("absorbed_damage_rate");
                            sumArtworks.VitalityRegenerationRate = reader.GetDoubleSafe("vitality_regeneration_rate");
                            sumArtworks.VitalityRegenerationResistanceRate = reader.GetDoubleSafe("vitality_regeneration_resistance_rate");
                            sumArtworks.AccuracyRate = reader.GetDoubleSafe("accuracy_rate");
                            sumArtworks.LifestealRate = reader.GetDoubleSafe("lifesteal_rate");
                            sumArtworks.ShieldStrength = reader.GetDoubleSafe("shield_strength");
                            sumArtworks.Tenacity = reader.GetDoubleSafe("tenacity");
                            sumArtworks.ResistanceRate = reader.GetDoubleSafe("resistance_rate");
                            sumArtworks.ComboRate = reader.GetDoubleSafe("combo_rate");
                            sumArtworks.IgnoreComboRate = reader.GetDoubleSafe("ignore_combo_rate");
                            sumArtworks.ComboDamageRate = reader.GetDoubleSafe("combo_damage_rate");
                            sumArtworks.ComboResistanceRate = reader.GetDoubleSafe("combo_resistance_rate");
                            sumArtworks.StunRate = reader.GetDoubleSafe("stun_rate");
                            sumArtworks.IgnoreStunRate = reader.GetDoubleSafe("ignore_stun_rate");
                            sumArtworks.ReflectionRate = reader.GetDoubleSafe("reflection_rate");
                            sumArtworks.IgnoreReflectionRate = reader.GetDoubleSafe("ignore_reflection_rate");
                            sumArtworks.ReflectionDamageRate = reader.GetDoubleSafe("reflection_damage_rate");
                            sumArtworks.ReflectionResistanceRate = reader.GetDoubleSafe("reflection_resistance_rate");
                            sumArtworks.Mana = reader.GetDoubleSafe("mana");
                            sumArtworks.ManaRegenerationRate = reader.GetDoubleSafe("mana_regeneration_rate");
                            sumArtworks.DamageToDifferentFactionRate = reader.GetDoubleSafe("damage_to_different_faction_rate");
                            sumArtworks.ResistanceToDifferentFactionRate = reader.GetDoubleSafe("resistance_to_different_faction_rate");
                            sumArtworks.DamageToSameFactionRate = reader.GetDoubleSafe("damage_to_same_faction_rate");
                            sumArtworks.ResistanceToSameFactionRate = reader.GetDoubleSafe("resistance_to_same_faction_rate");
                            sumArtworks.NormalDamageRate = reader.GetDoubleSafe("normal_damage_rate");
                            sumArtworks.NormalResistanceRate = reader.GetDoubleSafe("normal_resistance_rate");
                            sumArtworks.SkillDamageRate = reader.GetDoubleSafe("skill_damage_rate");
                            sumArtworks.SkillResistanceRate = reader.GetDoubleSafe("skill_resistance_rate");
                        }
                    }
                }
            }
