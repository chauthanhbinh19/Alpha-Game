...
public class UserCardColonelsRepository : IUserCardColonelsRepository
{
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_card_colonels (
                    user_id, card_colonel_id, level, experiment, star, quality, block, quantity,
                    ...
                    command.Parameters.AddWithValue("@critical_damage_rate", CardColonels.critical_damage_rate);
                    command.Parameters.AddWithValue("@critical_rate", CardColonels.critical_rate);
                    command.Parameters.AddWithValue("@critical_resistance_rate", CardColonels.critical_resistance_rate);
                    command.Parameters.AddWithValue("@ignore_critical_rate", CardColonels.ignore_critical_rate);
                    command.Parameters.AddWithValue("@penetration_rate", CardColonels.penetration_rate);
                    command.Parameters.AddWithValue("@penetration_resistance_rate", CardColonels.penetration_resistance_rate);
                    command.Parameters.AddWithValue("@evasion_rate", CardColonels.evasion_rate);
                    command.Parameters.AddWithValue("@damage_absorption_rate", CardColonels.damage_absorption_rate);
                    command.Parameters.AddWithValue("@ignore_damage_absorption_rate", CardColonels.ignore_damage_absorption_rate);
                    command.Parameters.AddWithValue("@absorbed_damage_rate", CardColonels.absorbed_damage_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_rate", CardColonels.vitality_regeneration_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", CardColonels.vitality_regeneration_resistance_rate);
                    command.Parameters.AddWithValue("@accuracy_rate", CardColonels.accuracy_rate);
                    command.Parameters.AddWithValue("@lifesteal_rate", CardColonels.lifesteal_rate);
                    command.Parameters.AddWithValue("@shield_strength", CardColonels.shield_strength);
                    command.Parameters.AddWithValue("@tenacity", CardColonels.tenacity);
                    command.Parameters.AddWithValue("@resistance_rate", CardColonels.resistance_rate);
                    command.Parameters.AddWithValue("@combo_rate", CardColonels.combo_rate);
                    command.Parameters.AddWithValue("@ignore_combo_rate", CardColonels.ignore_combo_rate);
                    command.Parameters.AddWithValue("@combo_damage_rate", CardColonels.combo_damage_rate);
                    command.Parameters.AddWithValue("@combo_resistance_rate", CardColonels.combo_resistance_rate);
                    command.Parameters.AddWithValue("@stun_rate", CardColonels.stun_rate);
                    command.Parameters.AddWithValue("@ignore_stun_rate", CardColonels.ignore_stun_rate);
                    command.Parameters.AddWithValue("@reflection_rate", CardColonels.reflection_rate);
                    command.Parameters.AddWithValue("@ignore_reflection_rate", CardColonels.ignore_reflection_rate);
                    command.Parameters.AddWithValue("@reflection_damage_rate", CardColonels.reflection_damage_rate);
                    command.Parameters.AddWithValue("@reflection_resistance_rate", CardColonels.reflection_resistance_rate);
                    command.Parameters.AddWithValue("@mana", CardColonels.mana);
                    command.Parameters.AddWithValue("@mana_regeneration_rate", CardColonels.mana_regeneration_rate);
                    command.Parameters.AddWithValue("@damage_to_different_faction_rate", CardColonels.damage_to_different_faction_rate);
                    command.Parameters.AddWithValue("@resistance_to_different_faction_rate", CardColonels.resistance_to_different_faction_rate);
                    command.Parameters.AddWithValue("@damage_to_same_faction_rate", CardColonels.damage_to_same_faction_rate);
                    command.Parameters.AddWithValue("@resistance_to_same_faction_rate", CardColonels.resistance_to_same_faction_rate);
                    command.Parameters.AddWithValue("@normal_damage_rate", CardColonels.normal_damage_rate);
                    command.Parameters.AddWithValue("@normal_resistance_rate", CardColonels.normal_resistance_rate);
                    command.Parameters.AddWithValue("@skill_damage_rate", CardColonels.skill_damage_rate);
                    command.Parameters.AddWithValue("@skill_resistance_rate", CardColonels.skill_resistance_rate);
                    MySqlDataReader reader = command.ExecuteReader();
    ...
    public bool InsertFactCardColonels(CardColonels cardColonels)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                user_id, user_card_colonel_id, team_id, position, role, 
                ...
                command.Parameters.AddWithValue("@all_critical_damage_rate", cardColonels.critical_damage_rate);
                command.Parameters.AddWithValue("@all_critical_rate", cardColonels.critical_rate);
                command.Parameters.AddWithValue("@all_critical_resistance_rate", cardColonels.critical_resistance_rate);
                command.Parameters.AddWithValue("@all_ignore_critical_rate", cardColonels.ignore_critical_rate);
                command.Parameters.AddWithValue("@all_penetration_rate", cardColonels.penetration_rate);
                command.Parameters.AddWithValue("@all_penetration_resistance_rate", cardColonels.penetration_resistance_rate);
                command.Parameters.AddWithValue("@all_evasion_rate", cardColonels.evasion_rate);
                command.Parameters.AddWithValue("@all_damage_absorption_rate", cardColonels.damage_absorption_rate);
                command.Parameters.AddWithValue("@all_ignore_damage_absorption_rate", cardColonels.ignore_damage_absorption_rate);
                command.Parameters.AddWithValue("@all_absorbed_damage_rate", cardColonels.absorbed_damage_rate);
                command.Parameters.AddWithValue("@all_vitality_regeneration_rate", cardColonels.vitality_regeneration_rate);
                command.Parameters.AddWithValue("@all_vitality_regeneration_resistance_rate", cardColonels.vitality_regeneration_resistance_rate);
                command.Parameters.AddWithValue("@all_accuracy_rate", cardColonels.accuracy_rate);
                command.Parameters.AddWithValue("@all_lifesteal_rate", cardColonels.lifesteal_rate);
                command.Parameters.AddWithValue("@all_shield_strength", cardColonels.shield_strength);
                command.Parameters.AddWithValue("@all_tenacity", cardColonels.tenacity);
                command.Parameters.AddWithValue("@all_resistance_rate", cardColonels.resistance_rate);
                command.Parameters.AddWithValue("@all_combo_rate", cardColonels.combo_rate);
                command.Parameters.AddWithValue("@all_ignore_combo_rate", cardColonels.ignore_combo_rate);
                command.Parameters.AddWithValue("@all_combo_damage_rate", cardColonels.combo_damage_rate);
                command.Parameters.AddWithValue("@all_combo_resistance_rate", cardColonels.combo_resistance_rate);
                command.Parameters.AddWithValue("@all_stun_rate", cardColonels.stun_rate);
                command.Parameters.AddWithValue("@all_ignore_stun_rate", cardColonels.ignore_stun_rate);
                command.Parameters.AddWithValue("@all_reflection_rate", cardColonels.reflection_rate);
                command.Parameters.AddWithValue("@all_ignore_reflection_rate", cardColonels.ignore_reflection_rate);
                command.Parameters.AddWithValue("@all_reflection_damage_rate", cardColonels.reflection_damage_rate);
                command.Parameters.AddWithValue("@all_reflection_resistance_rate", cardColonels.reflection_resistance_rate);
                command.Parameters.AddWithValue("@all_mana", cardColonels.mana);
                command.Parameters.AddWithValue("@all_mana_regeneration_rate", cardColonels.mana_regeneration_rate);
                command.Parameters.AddWithValue("@all_damage_to_different_faction_rate", cardColonels.damage_to_different_faction_rate);
                command.Parameters.AddWithValue("@all_resistance_to_different_faction_rate", cardColonels.resistance_to_different_faction_rate);
                command.Parameters.AddWithValue("@all_damage_to_same_faction_rate", cardColonels.damage_to_same_faction_rate);
                command.Parameters.AddWithValue("@all_resistance_to_same_faction_rate", cardColonels.resistance_to_same_faction_rate);
                command.Parameters.AddWithValue("@all_normal_damage_rate", cardColonels.normal_damage_rate);
                command.Parameters.AddWithValue("@all_normal_resistance_rate", cardColonels.normal_resistance_rate);
                command.Parameters.AddWithValue("@all_skill_damage_rate", cardColonels.skill_damage_rate);
                command.Parameters.AddWithValue("@all_skill_resistance_rate", cardColonels.skill_resistance_rate);
                command.ExecuteNonQuery();
    ...
    public bool UpdateTeamFactCardColonels(string team_id, string position, string card_id)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
    ...
    public CardColonels GetUserCardColonelsById(string user_id, string Id)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                from user_card_colonels uc, fact_card_colonels fc, card_colonels c
                where uc.card_colonel_id=@id 
                and fc.user_card_colonel_id = uc.card_colonel_id
