        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                INSERT INTO user_card_military (
                    user_id, card_military_id, level, experiment, star, quality, block, quantity,
                    ...
                    command.Parameters.AddWithValue("@critical_resistance_rate", CardMilitary.critical_resistance_rate);
                    command.Parameters.AddWithValue("@ignore_critical_rate", CardMilitary.ignore_critical_rate);
                    command.Parameters.AddWithValue("@penetration_rate", CardMilitary.penetration_rate);
                    command.Parameters.AddWithValue("@penetration_resistance_rate", CardMilitary.penetration_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@ignore_damage_absorption_rate", CardMilitary.ignore_damage_absorption_rate);
                    command.Parameters.AddWithValue("@absorbed_damage_rate", CardMilitary.absorbed_damage_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_rate", CardMilitary.vitality_regeneration_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", CardMilitary.vitality_regeneration_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@ignore_combo_rate", CardMilitary.ignore_combo_rate);
                    command.Parameters.AddWithValue("@combo_damage_rate", CardMilitary.combo_damage_rate);
                    command.Parameters.AddWithValue("@combo_resistance_rate", CardMilitary.combo_resistance_rate);
                    command.Parameters.AddWithValue("@stun_rate", CardMilitary.stun_rate);
                    command.Parameters.AddWithValue("@ignore_stun_rate", CardMilitary.ignore_stun_rate);
                    command.Parameters.AddWithValue("@reflection_rate", CardMilitary.reflection_rate);
                    command.Parameters.AddWithValue("@ignore_reflection_rate", CardMilitary.ignore_reflection_rate);
                    command.Parameters.AddWithValue("@reflection_damage_rate", CardMilitary.reflection_damage_rate);
                    command.Parameters.AddWithValue("@reflection_resistance_rate", CardMilitary.reflection_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@normal_damage_rate", CardMilitary.normal_damage_rate);
                    command.Parameters.AddWithValue("@normal_resistance_rate", CardMilitary.normal_resistance_rate);
