...
{
    Task<List<Buildings>> GetUserBuildingsAsync(string user_id, string type, int pageSize, int offset, string rare);
    Task<int> GetUserBuildingsCountAsync(string user_id, string type, string rare);
