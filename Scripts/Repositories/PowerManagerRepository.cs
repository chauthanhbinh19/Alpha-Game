    ...
    public void InsertUserStats(string user_id, PowerManager powerManager)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                command.Parameters.AddWithValue("@allPower", powerManager.power);
                command.Parameters.AddWithValue("@allHealth", powerManager.health);
                command.Parameters.AddWithValue("@allPhysicalAttack", powerManager.physical_attack);
                command.Parameters.AddWithValue("@allPhysicalDefense", powerManager.physical_defense);
                command.Parameters.AddWithValue("@allMagicalAttack", powerManager.magical_attack);
                command.Parameters.AddWithValue("@allMagicalDefense", powerManager.magical_defense);
                command.Parameters.AddWithValue("@allChemicalAttack", powerManager.chemical_attack);
                command.Parameters.AddWithValue("@allChemicalDefense", powerManager.chemical_defense);
                command.Parameters.AddWithValue("@allAtomicAttack", powerManager.atomic_attack);
                command.Parameters.AddWithValue("@allAtomicDefense", powerManager.atomic_defense);
                command.Parameters.AddWithValue("@allMentalAttack", powerManager.mental_attack);
                command.Parameters.AddWithValue("@allMentalDefense", powerManager.mental_defense);
