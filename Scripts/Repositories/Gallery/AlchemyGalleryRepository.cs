...
public class AlchemyGalleryRepository : IAlchemyGalleryRepository
{
    ...
    public void InsertAlchemyGallery(string Id, Alchemy AlchemyFromDB)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                if (recordCount == 0)
                {
                    ...
                    command.Parameters.AddWithValue("@critical_resistance_rate", AlchemyFromDB.critical_resistance_rate);
                    command.Parameters.AddWithValue("@ignore_critical_rate", AlchemyFromDB.ignore_critical_rate);
                    command.Parameters.AddWithValue("@penetration_rate", AlchemyFromDB.penetration_rate);
                    command.Parameters.AddWithValue("@penetration_resistance_rate", AlchemyFromDB.penetration_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@ignore_damage_absorption_rate", AlchemyFromDB.ignore_damage_absorption_rate);
                    command.Parameters.AddWithValue("@absorbed_damage_rate", AlchemyFromDB.absorbed_damage_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_rate", AlchemyFromDB.vitality_regeneration_rate);
                    command.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", AlchemyFromDB.vitality_regeneration_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@ignore_combo_rate", AlchemyFromDB.ignore_combo_rate);
                    command.Parameters.AddWithValue("@combo_damage_rate", AlchemyFromDB.combo_damage_rate);
                    command.Parameters.AddWithValue("@combo_resistance_rate", AlchemyFromDB.combo_resistance_rate);
                    command.Parameters.AddWithValue("@stun_rate", AlchemyFromDB.stun_rate);
                    command.Parameters.AddWithValue("@ignore_stun_rate", AlchemyFromDB.ignore_stun_rate);
                    command.Parameters.AddWithValue("@reflection_rate", AlchemyFromDB.reflection_rate);
                    command.Parameters.AddWithValue("@ignore_reflection_rate", AlchemyFromDB.ignore_reflection_rate);
                    command.Parameters.AddWithValue("@reflection_damage_rate", AlchemyFromDB.reflection_damage_rate);
                    command.Parameters.AddWithValue("@reflection_resistance_rate", AlchemyFromDB.reflection_resistance_rate);
                    ...
                    command.Parameters.AddWithValue("@normal_damage_rate", AlchemyFromDB.normal_damage_rate);
                    command.Parameters.AddWithValue("@normal_resistance_rate", AlchemyFromDB.normal_resistance_rate);
                    command.Parameters.AddWithValue("@skill_damage_rate", AlchemyFromDB.skill_damage_rate);
                    command.Parameters.AddWithValue("@skill_resistance_rate", AlchemyFromDB.skill_resistance_rate);
    ...
    public void UpdateAlchemyGalleryPower(string Id, Alchemy AlchemyFromDB)
    {
        string connectionString = DatabaseConfig.ConnectionString;
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
