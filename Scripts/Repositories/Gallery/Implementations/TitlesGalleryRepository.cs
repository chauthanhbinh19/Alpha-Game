...
public class TitlesGalleryRepository : ITitlesGalleryRepository
{
    ...
    public async Task<InsertOrUpdateResult<double>> UpdateTempStarTitleGalleryAsync(string userId, string titleId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task<Titles> GetTitleCollectionByIdAsync(string userId, string objectId)
    {
        ...
        try
        {
            ...
            string selectSQL = @"
            SELECT cg.* 
            FROM titles_gallery cg, titles c 
            WHERE cg.user_id = @userId 
                AND cg.title_id = @objectId 
                AND cg.status = 'available'
                AND cg.title_id = c.id
    ...
    public async Task<InsertOrUpdateResult<bool>> UpdateTitleGalleryPowerAsync(string userId, string id, Titles title)
    {
        string connectionString = DatabaseConfig.ConnectionString;
