...
public class CardAdmiralsGalleryRepository : ICardAdmiralsGalleryRepository
{
    ...
    public async Task InsertCardAdmiralGalleryAsync(string userId, string id, CardAdmirals cardAdmiral)
    {
    ...
    public async Task UpdateStarCardAdmiralGalleryAsync(string userId, string cardAdmiralId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
