...
public class MechaBeastsGalleryRepository : IMechaBeastsGalleryRepository
{
    ...
    public async Task InsertMechaBeastGalleryAsync(string userId, string Id, MechaBeasts mechaBeast)
    {
        int percent = 20;
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task UpdateStarMechaBeastGalleryAsync(string userId, string mechaBeastId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
