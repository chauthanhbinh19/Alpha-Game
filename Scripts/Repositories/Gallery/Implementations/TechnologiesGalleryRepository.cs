...
public class TechnologiesGalleryRepository : ITechnologiesGalleryRepository
{
    ...
    public async Task InsertTechnologyGalleryAsync(string userId, string Id, Technologies technology)
    {
        int percent = 20;
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task UpdateStarTechnologyGalleryAsync(string userId, string technologyId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
