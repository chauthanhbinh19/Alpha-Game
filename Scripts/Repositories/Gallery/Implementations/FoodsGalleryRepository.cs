...
public class FoodsGalleryRepository : IFoodsGalleryRepository
{
    ...
    public async Task InsertFoodGalleryAsync(string userId, string Id, Foods food)
    {
        int percent = 20;
        string connectionString = DatabaseConfig.ConnectionString;
    ...
    public async Task UpdateStarFoodGalleryAsync(string userId, string foodId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
