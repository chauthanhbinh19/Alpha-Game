...
public class CardCaptainsGalleryRepository : ICardCaptainsGalleryRepository
{
    ...
    public async Task InsertCardCaptainGalleryAsync(string userId, string id, CardCaptains cardCaptain)
    {
    ...
    public async Task UpdateStarCardCaptainGalleryAsync(string userId, string cardCaptainId, double star)
    {
        string connectionString = DatabaseConfig.ConnectionString;
