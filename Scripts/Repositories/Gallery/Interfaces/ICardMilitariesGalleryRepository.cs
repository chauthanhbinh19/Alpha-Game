...
public interface ICardMilitariesGalleryRepository
{
    ...
    Task<InsertOrUpdateResult<double>> UpdateTempStarCardMilitaryGalleryAsync(string userId, string Id, double star);
    ...
    Task<InsertOrUpdateResult<bool>> UpdateCardMilitaryGalleryPowerAsync(string userId, string Id, CardMilitaries CardMilitaryFromDB);
