...
public interface ICardAdmiralsGalleryRepository
{
    ...
    Task<InsertOrUpdateResult<double>> UpdateTempStarCardAdmiralGalleryAsync(string userId, string Id, double star);
    ...
    Task<InsertOrUpdateResult<bool>> UpdateCardAdmiralGalleryPowerAsync(string userId, string Id, CardAdmirals CardAdmiralFromDB);
