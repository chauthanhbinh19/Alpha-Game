...
public interface ICollaborationEquipmentsGalleryRepository
{
    ...
    Task<InsertOrUpdateResult<double>> UpdateTempStarCollaborationEquipmentGalleryAsync(string userId, string Id, double star);
    ...
    Task<InsertOrUpdateResult<bool>> UpdateCollaborationEquipmentGalleryPowerAsync(string userId, string Id, CollaborationEquipments CollaborationEquipmentFromDB);
