...
public interface ICardCaptainsGalleryRepository
{
    ...
    Task<InsertOrUpdateResult<double>> UpdateTempStarCardCaptainGalleryAsync(string userId, string Id, double star);
    ...
    Task<InsertOrUpdateResult<bool>> UpdateCardCaptainGalleryPowerAsync(string userId, string Id, CardCaptains CardCaptainFromDB);
