        ...
        await using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                VALUES (
                    ...
                    command.Parameters.AddWithValue("@health", FashionFromDB.Health);
                    command.Parameters.AddWithValue("@physical_attack", FashionFromDB.PhysicalAttack);
                    command.Parameters.AddWithValue("@physical_defense", FashionFromDB.PhysicalDefense);
                    command.Parameters.AddWithValue("@magical_attack", FashionFromDB.MagicalAttack);
                    command.Parameters.AddWithValue("@magical_defense", FashionFromDB.MagicalDefense);
                    command.Parameters.AddWithValue("@chemical_attack", FashionFromDB.ChemicalAttack);
                    command.Parameters.AddWithValue("@chemical_defense", FashionFromDB.ChemicalDefense);
                    command.Parameters.AddWithValue("@atomic_attack", FashionFromDB.AtomicAttack);
                    command.Parameters.AddWithValue("@atomic_defense", FashionFromDB.AtomicDefense);
                    command.Parameters.AddWithValue("@mental_attack", FashionFromDB.MentalAttack);
                    command.Parameters.AddWithValue("@mental_defense", FashionFromDB.MentalDefense);
                    command.Parameters.AddWithValue("@speed", FashionFromDB.Speed);
                    command.Parameters.AddWithValue("@critical_damage_rate", FashionFromDB.CriticalDamageRate);
                    command.Parameters.AddWithValue("@critical_rate", FashionFromDB.CriticalRate);
                    command.Parameters.AddWithValue("@critical_resistance_rate", FashionFromDB.CriticalResistanceRate);
                    command.Parameters.AddWithValue("@ignore_critical_rate", FashionFromDB.IgnoreCriticalRate);
                    command.Parameters.AddWithValue("@penetration_rate", FashionFromDB.PenetrationRate);
                    command.Parameters.AddWithValue("@penetration_resistance_rate", FashionFromDB.PenetrationResistanceRate);
                    command.Parameters.AddWithValue("@evasion_rate", FashionFromDB.EvasionRate);
                    command.Parameters.AddWithValue("@damage_absorption_rate", FashionFromDB.DamageAbsorptionRate);
                    command.Parameters.AddWithValue("@ignore_damage_absorption_rate", FashionFromDB.IgnoreDamageAbsorptionRate);
                    command.Parameters.AddWithValue("@absorbed_damage_rate", FashionFromDB.AbsorbedDamageRate);
                    command.Parameters.AddWithValue("@vitality_regeneration_rate", FashionFromDB.VitalityRegenerationRate);
                    command.Parameters.AddWithValue("@vitality_regeneration_resistance_rate", FashionFromDB.VitalityRegenerationResistanceRate);
                    command.Parameters.AddWithValue("@accuracy_rate", FashionFromDB.AccuracyRate);
                    command.Parameters.AddWithValue("@lifesteal_rate", FashionFromDB.LifestealRate);
                    command.Parameters.AddWithValue("@shield_strength", FashionFromDB.ShieldStrength);
                    command.Parameters.AddWithValue("@tenacity", FashionFromDB.Tenacity);
                    command.Parameters.AddWithValue("@resistance_rate", FashionFromDB.ResistanceRate);
                    command.Parameters.AddWithValue("@combo_rate", FashionFromDB.ComboRate);
                    command.Parameters.AddWithValue("@ignore_combo_rate", FashionFromDB.IgnoreComboRate);
                    command.Parameters.AddWithValue("@combo_damage_rate", FashionFromDB.ComboDamageRate);
                    command.Parameters.AddWithValue("@combo_resistance_rate", FashionFromDB.ComboResistanceRate);
                    command.Parameters.AddWithValue("@stun_rate", FashionFromDB.StunRate);
                    command.Parameters.AddWithValue("@ignore_stun_rate", FashionFromDB.IgnoreStunRate);
                    command.Parameters.AddWithValue("@reflection_rate", FashionFromDB.ReflectionRate);
                    command.Parameters.AddWithValue("@ignore_reflection_rate", FashionFromDB.IgnoreReflectionRate);
                    command.Parameters.AddWithValue("@reflection_damage_rate", FashionFromDB.ReflectionDamageRate);
                    command.Parameters.AddWithValue("@reflection_resistance_rate", FashionFromDB.ReflectionResistanceRate);
                    command.Parameters.AddWithValue("@mana", FashionFromDB.Mana);
                    command.Parameters.AddWithValue("@mana_regeneration_rate", FashionFromDB.ManaRegenerationRate);
                    command.Parameters.AddWithValue("@damage_to_different_faction_rate", FashionFromDB.DamageToDifferentFactionRate);
                    command.Parameters.AddWithValue("@resistance_to_different_faction_rate", FashionFromDB.ResistanceToDifferentFactionRate);
                    command.Parameters.AddWithValue("@damage_to_same_faction_rate", FashionFromDB.DamageToSameFactionRate);
                    command.Parameters.AddWithValue("@resistance_to_same_faction_rate", FashionFromDB.ResistanceToSameFactionRate);
                    command.Parameters.AddWithValue("@normal_damage_rate", FashionFromDB.NormalDamageRate);
                    command.Parameters.AddWithValue("@normal_resistance_rate", FashionFromDB.NormalResistanceRate);
                    command.Parameters.AddWithValue("@skill_damage_rate", FashionFromDB.SkillDamageRate);
                    command.Parameters.AddWithValue("@skill_resistance_rate", FashionFromDB.SkillResistanceRate);
